...
- Large structured defaults such as `platform_settings` rendered inline in Default columns and made browse/detail pages unreadable. Defaults are now summarized inline and expandable as formatted JSON on demand.
