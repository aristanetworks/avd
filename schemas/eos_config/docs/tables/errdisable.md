...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.acl.enabled") | Boolean |  |  |  | Enable recovery for ACL errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.arp_inspection.enabled") | Boolean |  |  |  | Enable recovery for ARP inspection errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.bpduguard.enabled") | Boolean |  |  |  | Enable recovery for BPDU guard errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.dot1x.enabled") | Boolean |  |  |  | Enable recovery for 802.1X errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.dot1x_coa.enabled") | Boolean |  |  |  | Enable recovery for 802.1X Change of Authorization errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.dot1x_phone_classification.enabled") | Boolean |  |  |  | Enable recovery for 802.1X phone classification errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.dot1x_session_replace.enabled") | Boolean |  |  |  | Enable recovery for 802.1X session replace errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.hitless_reload_down.enabled") | Boolean |  |  |  | Enable recovery for hitless reload down errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.interface_speed.enabled") | Boolean |  |  |  | Enable recovery for interface speed errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.internal_error.enabled") | Boolean |  |  |  | Enable recovery for internal errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.lacp_rate_limit.enabled") | Boolean |  |  |  | Enable recovery for LACP rate limit errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.link_flap.enabled") | Boolean |  |  |  | Enable recovery for link flap errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.no_internal_vlan.enabled") | Boolean |  |  |  | Enable recovery for no internal VLAN errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.port_breakout.enabled") | Boolean |  |  |  | Enable recovery for port breakout errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.portchannelguard.enabled") | Boolean |  |  |  | Enable recovery for port-channel guard errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.portsec.enabled") | Boolean |  |  |  | Enable recovery for port security errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.speed_misconfigured.enabled") | Boolean |  |  |  | Enable recovery for speed misconfigured errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.storm_control.enabled") | Boolean |  |  |  | Enable recovery for storm control errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.stuck_queue.enabled") | Boolean |  |  |  | Enable recovery for stuck queue errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.switchcard_unreachable.enabled") | Boolean |  |  |  | Enable recovery for switchcard unreachable errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.tap_port_init.enabled") | Boolean |  |  |  | Enable recovery for tap port init errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.uplink_failure_detection.enabled") | Boolean |  |  |  | Enable recovery for uplink failure detection errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.xcvr_misconfigured.enabled") | Boolean |  |  |  | Enable recovery for transceiver misconfiguration errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.xcvr_overheat.enabled") | Boolean |  |  |  | Enable recovery for transceiver overheat errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.xcvr_power_unsupported.enabled") | Boolean |  |  |  | Enable recovery for unsupported transceiver power errors. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "errdisable.recovery_cause.xcvr_unsupported.enabled") | Boolean |  |  |  | Enable recovery for unsupported transceiver errors. |
