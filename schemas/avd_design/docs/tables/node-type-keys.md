...
=== "YAML"
    ...
    custom_node_type_keys:
      - key: <str; required; unique>
        ...
        # For ring topologies, define each ring link as an uplink in both directions; downstream links are not considered.
        # To propagate VLANs across a non-hierarchical L2 topology, such as a ring or lateral L2 link, configure the link as an uplink on both neighboring switches.
        uplink_type: <str; "p2p" | "port-channel" | "p2p-vrfs" | "lan" | "l2-ethernet"; default="p2p">
