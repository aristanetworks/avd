...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- |
| Port-Channel1 | DC1-SVC3B_Po5 | 1500 | switched | trunk | 2-4092 | - | 1 | - | - |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | DC1-SVC3A_Ethernet6 | *1500 | *switched | *trunk | *2-4092 | - | - | - | 1 | active |
| Ethernet2 | DC1-SVC3B_Ethernet6 | *1500 | *switched | *trunk | *2-4092 | - | - | - | 1 | active |
