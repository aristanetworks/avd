...
| Loopback101 | Tenant_A_OPZone_VTEP_DIAGNOSTICS | Tenant_A_OPZone | 10.1.255.9/32 |
| Loopback201 | Tenant_B_OPZone_VTEP_DIAGNOSTICS | Tenant_B_OPZone | 10.2.255.9/32 |
| Loopback301 | Tenant_C_OPZone_VTEP_DIAGNOSTICS | Tenant_C_OPZone | 10.3.255.9/32 |
...
| Vlan3000 | MLAG_PEER_L3_iBGP: vrf Tenant_A_OPZone | Tenant_A_OPZone  | 10.255.251.11/31 | - | - | - |
| Vlan3020 | MLAG_PEER_L3_iBGP: vrf Tenant_B_OPZone | Tenant_B_OPZone  | 10.255.251.11/31 | - | - | - |
| Vlan3040 | MLAG_PEER_L3_iBGP: vrf Tenant_C_OPZone | Tenant_C_OPZone  | 10.255.251.11/31 | - | - | - |
...
| -------------- | --------------------- |
| Tenant_A_OPZone | 10.1.255.9 |
| Tenant_B_OPZone | 10.2.255.9 |
| Tenant_C_OPZone | 10.3.255.9 |

### Virtual Source NAT Device Configuration

```eos
ip address virtual source-nat vrf Tenant_A_OPZone address 10.1.255.9
ip address virtual source-nat vrf Tenant_B_OPZone address 10.2.255.9
ip address virtual source-nat vrf Tenant_C_OPZone address 10.3.255.9
!
```
...
| ----------------- | ------------------- | ------------ | ------------ | ----- |
| Tenant_A_OPZone | 192.168.255.9:10101 | both 10101:10101 | learned | 110-111 |
| Tenant_B_OPZone | 192.168.255.9:10201 | both 10201:10201 | learned | 210-211 |
| Tenant_C_OPZone | 192.168.255.9:10301 | both 10301:10301 | learned | 310-311 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Route Target | Redistribute |
| --- | ------------------- | ------------ | ------------ |
| Tenant_A_OPZone | 192.168.255.9:50101 | import 50101:50101<br> export 50101:50101 | connected |
| Tenant_B_OPZone | 192.168.255.9:50201 | import 50201:50201<br> export 50201:50201 | connected |
| Tenant_C_OPZone | 192.168.255.9:50301 | import 50301:50301<br> export 50301:50301 | connected |
