...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ethernet_structured_config</samp>](## "uplinks.[].subinterfaces.[].ethernet_structured_config") | Dictionary |  |  |  | Custom structured config applied to `uplink_interfaces` and `uplink_switch_interfaces` for uplink_type == "p2p". |
