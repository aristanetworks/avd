...
variables, making some of the confiiguration change sometimes during minor releases. This behavior is well documented and described in the `eos_designs` how-to on
...
Starting AVD 5.6, `eos_designs` role emits deprecation warning identifying the native `eos_cli_config_gen` keys being used.
