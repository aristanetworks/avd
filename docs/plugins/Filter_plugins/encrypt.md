...
| <samp>salt</samp> | integer | optional | None | Max value: <code>15</code> | Salt used for simple type-7 obfuscation. Required when `passwd_type` is `radius` or `tacacs`. |
