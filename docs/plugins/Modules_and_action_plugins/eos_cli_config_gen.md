...
| <samp>directory_mode</samp> | str | optional | 0o775 |  | Directory permissions mode (octal string) to be applied to all directories created by the module. |
| <samp>file_mode</samp> | str | optional | 0o664 |  | File permissions mode (octal string) to be applied to all files generated by the module. |
