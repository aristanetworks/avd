...
| <samp>&nbsp;&nbsp;&nbsp;&nbsp;root_policy</samp> | str | optional | selective | Valid values:<br>- <code>strict</code><br>- <code>loose</code><br>- <code>selective</code> | Controls how the Studio root container list is managed during deployment.<br>- `strict`: Replace the root list entirely with what is declared.<br>- `selective`: Only undeclared AVD-managed roots are removed. Declared roots are placed first, manual roots after.<br>- `loose`: Only new roots are added. Existing roots keep their position. Nothing is removed. |
