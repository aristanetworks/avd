...
| <samp>&nbsp;&nbsp;&nbsp;&nbsp;configlet_policy</samp> | str | optional | managed | Valid values:<br>- <code>managed</code><br>- <code>additive</code> | Policy for managing configlets in the Configlet Library.<br><br>- **managed** (default): Delete manifest-managed configlets not declared in this manifest and not assigned to any container.<br>  Configlets not managed by the manifest are preserved.<br>- **additive**: Only create or update declared configlets. All existing configlets are preserved. |
