...
| <samp>static_config_manifest</samp> | dict | optional | None |  | PREVIEW - Deploy a manifest of containers and configlets to CloudVision using the Static Configuration Studio. |
