...
| <samp>&nbsp;&nbsp;&nbsp;&nbsp;root_policy</samp> | str | optional | controlled | Valid values:<br>- <code>controlled</code><br>- <code>flexible</code> | Policy for managing root containers in the Studio.<br><br>- **controlled** (default): Remove undeclared AVD-managed root containers.<br>  Declared root containers first, manual root containers preserved at the end.<br>- **flexible**: Don&#39;t remove any root containers. Only add new root containers at the top. |
