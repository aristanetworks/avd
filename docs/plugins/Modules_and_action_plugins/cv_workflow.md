...
| <samp>&nbsp;&nbsp;&nbsp;&nbsp;configlet_policy</samp> | str | optional | controlled | Valid values:<br>- <code>controlled</code><br>- <code>flexible</code> | Policy for managing configlets in the Configlet Library.<br><br>- **controlled** (default): Delete AVD-managed configlets not declared in this manifest push. Manual configlets are preserved.<br>- **flexible**: Don&#39;t delete any configlets. Only create or update declared configlets. |
