...
| <samp>&nbsp;&nbsp;&nbsp;&nbsp;preserve_existing_containers</samp> | bool | optional | False | - | Preserve existing manifest-managed root containers in the Static Configuration Studio root list when they are not declared in the current manifest.<br>This enables partial manifests managing separate root-level branches. |
