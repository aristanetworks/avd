...
As an example, copy the templates to a directory `custom_templates` (make sure it is available in the search paths when the Ansible playbook is executing as [documented here](https://docs.ansible.com/ansible/latest/playbook_guide/playbook_pathing.html)) and update your input variables as follow:
