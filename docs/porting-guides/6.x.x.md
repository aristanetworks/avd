...
In AVD 5.x, the value of `ip_dhcp_snooping.enabled` was implicitly required as true to configure 'ip dhcp snooping information option circuit-id type xx format xx' command.
