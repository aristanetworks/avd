...
#### `<custom_connected_endpoints_keys.key>[].adapters[].speed` requires value assignment from valid values pool

In AVD 5.0.0, any string value could be assigned to <custom_connected_endpoints_keys.key>[].adapters[].speed.

As of AVD 6.0.0, <custom_connected_endpoints_keys.key>[].adapters[].speed must be assigned a value from the predefined pool of valid values.

#### `<network_services_keys.name>[].vrfs[].l3_port_channels[].member_interfaces[].speed` requires value assignment from valid values pool

In AVD 5.0.0, any string value could be assigned to <network_services_keys.name>[].vrfs[].l3_port_channels[].member_interfaces[].speed.

As of AVD 6.0.0, <network_services_keys.name>[].vrfs[].l3_port_channels[].member_interfaces[].speed must be assigned a value from the predefined pool of valid values.

#### `node_type.uplink_interface_speed`, `node_type.uplink_switch_interface_speed`, `node_type.mlag_interfaces_speed`, `node_type.l3_interfaces[].speed` and `node_type.l3_port_channels[].member_interfaces[].speed` requires value assignment from valid values pool

In AVD 5.0.0, any string value could be assigned to node_type.uplink_interface_speed, node_type.uplink_switch_interface_speed, node_type.mlag_interfaces_speed, node_type.l3_interfaces[].speed and node_type.l3_port_channels[].member_interfaces[].speed.

As of AVD 6.0.0, node_type.uplink_interface_speed, node_type.uplink_switch_interface_speed, node_type.mlag_interfaces_speed, node_type.l3_interfaces[].speed and node_type.l3_port_channels[].member_interfaces[].speed must be assigned a value from the predefined pool of valid values.
