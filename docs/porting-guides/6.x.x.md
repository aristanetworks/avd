...
### SNMP IPv4 and IPv6 ACLs are now only configured when the VRF is enabled

In AVD 5.x, SNMP IPv4 and IPv6 ACLs were rendered even if the VRF was not enabled.
