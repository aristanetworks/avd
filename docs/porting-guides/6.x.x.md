...
first this is not managing well inband management scenarii and secondly this is not compliant with RFC 3411 format.

Starting with AVD 6.0.0, the default value has been changed to `rfc3411`. This now generates a RFC 3411 compliant engine ID and handles the inband management IP cases gracefully.
