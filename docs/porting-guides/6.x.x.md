...
| `<network_services_key>[].vrfs[].l3_interfaces[].static_routes[].destination_address_prefix` | `<network_services_key>[].vrfs[].l3_interfaces[].static_routes[].prefix` |
| `<network_services_key>[].vrfs[].l3_interfaces[].static_routes[].gateway` | `<network_services_key>[].vrfs[]..l3_interfaces[].static_routes[].next_hop` |
| `<network_services_key>[].vrfs[].l3_port_channels[].static_routes[].destination_address_prefix` | `<network_services_key>[].vrfs[].l3_port_channels[].static_routes[].prefix` |
| `<network_services_key>[].vrfs[].l3_port_channels[].static_routes[].gateway` | `<network_services_key>[].vrfs[]..l3_port_channels[].static_routes[].next_hop` |
| `<network_services_key>[].vrfs[].svis[].static_routes[].destination_address_prefix` | `<network_services_key>[].vrfs[].svis[].static_routes[].prefix` |
| `<network_services_key>[].vrfs[].svis[].static_routes[].gateway` | `<network_services_key>[].vrfs[]..svis[].static_routes[].next_hop` |
