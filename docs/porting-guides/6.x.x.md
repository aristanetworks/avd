...
```diff
+ underlay_ospf_process_id: 101 # this should not have the same value as vrfs[].ospf.process_id
  tenants:
    - name: Tenant-A
      vrfs:
        - name: ospf-vrf
          ...
          ospf:
            enabled: true
+           process_id: 102 # this should not have the same value as underlay_ospf_process_id
```
...
l3_edge:
  p2p_links:
-   - ip: [10.10.10.0/31, 10.10.10.1/31, 10.10.10.2/31]
+     ip: [10.10.10.0/31, 10.10.10.1/31]
-     nodes: [peer1, peer2, peer3]
+     nodes: [peer1, peer2]
-     interfaces: [Ethernet1, Ethernet1, Ethernet1]
+     interfaces: [Ethernet1, Ethernet1]
-     descriptions: ["Custom description peer1", "Custom description peer2", "Custom description peer3"]
