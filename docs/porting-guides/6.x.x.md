...
| `router_bgp.listen_ranges[].prefix` | required |
| `router_bgp.listen_ranges[].peer_group` | required |
| `router_bgp.vrfs[].listen_ranges[].prefix` | required |
| `router_bgp.vrfs[].listen_ranges[].peer_group` | required |
