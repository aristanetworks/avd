...
# Removal of default-gateway Support for DHCP IPv6 Subnet

The default-gateway option is no longer supported for DHCP server IPv6 subnets in the EOS CLI and has therefore been removed from the data model and configuration generation.
...
-       default_gatway: 2001:db8:1:10::1
```
