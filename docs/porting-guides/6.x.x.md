...
### Execution of user-defined tests, stored in `user_catalogs` by default, or under the directory specified by `user_catalogs_dir_name` is now disabled by default
