...
### Role variables use role-specific prefixes

Starting with AVD 6.5.0, role-owned variables use the role name as a prefix. The previous unprefixed names remain supported as permanent aliases.
When both names are defined, the role-prefixed variable takes precedence, including when its value is `false`, an empty value, or `null`.

By default, a role emits one warning listing the legacy aliases it consumed. Values are never included in this message. Set the collection-wide control below to change this behavior:

```yaml
# warning: emit one warning per role invocation (default)
# error: reject consumed legacy aliases
# silent: accept consumed legacy aliases without a warning
avd_legacy_role_vars_mode: warning
```

The collection-wide variables `avd_verify_requirements`, `avd_ignore_requirements`, and `avd_create_directories` are unchanged.

#### `anta_runner`

| Legacy alias | Role-prefixed variable |
| ------------ | ---------------------- |
| `anta_devices` | `anta_runner_devices` |
| `anta_dir` | `anta_runner_dir` |
| `anta_dir_name` | `anta_runner_dir_name` |
| `anta_report_csv_path` | `anta_runner_report_csv_path` |
| `anta_report_custom_field` | `anta_runner_report_custom_field` |
| `anta_report_exclude_statuses` | `anta_runner_report_exclude_statuses` |
| `anta_report_expand_results` | `anta_runner_report_expand_results` |
| `anta_report_json_path` | `anta_runner_report_json_path` |
| `anta_report_md_path` | `anta_runner_report_md_path` |
| `anta_report_sort_fields` | `anta_runner_report_sort_fields` |
| `anta_report_status_priority` | `anta_runner_report_status_priority` |
| `anta_reports_dir` | `anta_runner_reports_dir` |
| `anta_reports_dir_name` | `anta_runner_reports_dir_name` |
| `avd_catalogs_dir` | `anta_runner_avd_catalogs_dir` |
| `avd_catalogs_dir_name` | `anta_runner_avd_catalogs_dir_name` |
| `avd_catalogs_enabled` | `anta_runner_avd_catalogs_enabled` |
| `avd_catalogs_extra_fabric_validation` | `anta_runner_avd_catalogs_extra_fabric_validation` |
| `avd_catalogs_filters` | `anta_runner_avd_catalogs_filters` |
| `avd_structured_config_file_format` | `anta_runner_structured_config_file_format` |
| `output_dir` | `anta_runner_output_dir` |
| `output_dir_name` | `anta_runner_output_dir_name` |
| `root_dir` | `anta_runner_root_dir` |
| `structured_dir` | `anta_runner_structured_dir` |
| `structured_dir_name` | `anta_runner_structured_dir_name` |
| `user_catalogs_dir` | `anta_runner_user_catalogs_dir` |
| `user_catalogs_dir_name` | `anta_runner_user_catalogs_dir_name` |
| `user_catalogs_enabled` | `anta_runner_user_catalogs_enabled` |

#### `build_output_folders`

All variables receive the `build_output_folders_` prefix. For example, `root_dir` becomes `build_output_folders_root_dir`.
This applies to `anta_dir`, `anta_dir_name`, `anta_reports_dir`, `anta_reports_dir_name`, `avd_catalogs_dir`, `avd_catalogs_dir_name`, `devices_dir`,
`devices_dir_name`, `documentation_dir`, `documentation_dir_name`, `eos_config_dir`, `eos_config_dir_name`, `fabric_dir`, `fabric_dir_name`, `output_dir`,
`output_dir_name`, `post_running_config_backup_dir`, `post_running_config_backup_dir_name`, `pre_running_config_backup_dir`,
`pre_running_config_backup_dir_name`, `root_dir`, `snapshots_backup_dir`, `snapshots_backup_dir_name`, `structured_cvp_dir`, `structured_cvp_dir_name`,
`structured_dir`, `structured_dir_name`, `user_catalogs_dir`, `user_catalogs_dir_name`.

#### `cv_deploy`

| Legacy alias | Role-prefixed variable |
| ------------ | ---------------------- |
| `avd_structured_config_file_format` | `cv_deploy_structured_config_file_format` |
| `avd_vault_id` | `cv_deploy_vault_id` |
| `cv_change_control_description` | `cv_deploy_change_control_description` |
| `cv_change_control_name` | `cv_deploy_change_control_name` |
| `cv_change_control_requested_state` | `cv_deploy_change_control_requested_state` |
| `cv_configlet_name_template` | `cv_deploy_configlet_name_template` |
| `cv_devices` | `cv_deploy_devices` |
| `cv_grpc_keepalives` | `cv_deploy_grpc_keepalives` |
| `cv_inventory_hostname` | `cv_deploy_inventory_hostname` |
| `cv_password` | `cv_deploy_password` |
| `cv_register_detailed_results` | `cv_deploy_register_detailed_results` |
| `cv_run_change_control` | `cv_deploy_run_change_control` |
| `cv_server` | `cv_deploy_server` |
| `cv_skip_missing_devices` | `cv_deploy_skip_missing_devices` |
| `cv_static_config_manifest` | `cv_deploy_static_config_manifest` |
| `cv_strict_system_mac_address` | `cv_deploy_strict_system_mac_address` |
| `cv_strict_tags` | `cv_deploy_strict_tags` |
| `cv_submit_workspace` | `cv_deploy_submit_workspace` |
| `cv_submit_workspace_force` | `cv_deploy_submit_workspace_force` |
| `cv_token` | `cv_deploy_token` |
| `cv_username` | `cv_deploy_username` |
| `cv_verify_certs` | `cv_deploy_verify_certs` |
| `cv_workspace_build_timeout` | `cv_deploy_workspace_build_timeout` |
| `cv_workspace_build_warnings_enabled` | `cv_deploy_workspace_build_warnings_enabled` |
| `cv_workspace_build_warnings_suppress_patterns` | `cv_deploy_workspace_build_warnings_suppress_patterns` |
| `cv_workspace_build_warnings_suppress_portfast` | `cv_deploy_workspace_build_warnings_suppress_portfast` |
| `cv_workspace_description` | `cv_deploy_workspace_description` |
| `cv_workspace_id` | `cv_deploy_workspace_id` |
| `cv_workspace_max_sync_retries` | `cv_deploy_workspace_max_sync_retries` |
| `cv_workspace_name` | `cv_deploy_workspace_name` |
| `cv_workspace_requested_state` | `cv_deploy_workspace_requested_state` |
| `eos_config_dir` | `cv_deploy_config_dir` |
| `eos_config_dir_name` | `cv_deploy_config_dir_name` |
| `output_dir` | `cv_deploy_output_dir` |
| `output_dir_name` | `cv_deploy_output_dir_name` |
| `proxy_host` | `cv_deploy_proxy_host` |
| `proxy_password` | `cv_deploy_proxy_password` |
| `proxy_port` | `cv_deploy_proxy_port` |
| `proxy_username` | `cv_deploy_proxy_username` |
| `read_structured_config_from_file` | `cv_deploy_read_structured_config_from_file` |
| `root_dir` | `cv_deploy_root_dir` |
| `structured_dir` | `cv_deploy_structured_dir` |
| `structured_dir_name` | `cv_deploy_structured_dir_name` |

#### `eos_designs` and `eos_cli_config_gen`

| Role | Legacy alias | Role-prefixed variable |
| ---- | ------------ | ---------------------- |
| `eos_designs` | `avd_digital_twin_mode` | `eos_designs_digital_twin_mode` |
| `eos_designs` | `avd_eos_designs_structured_config` | `eos_designs_structured_config` |
| `eos_designs` | `avd_structured_config_file_format` | `eos_designs_structured_config_file_format` |
| `eos_designs` | `avd_vault_id` | `eos_designs_vault_id` |
| `eos_cli_config_gen` | `avd_structured_config_file_format` | `eos_cli_config_gen_structured_config_file_format` |
| `eos_cli_config_gen` | `avd_vault_id` | `eos_cli_config_gen_vault_id` |
| `eos_cli_config_gen` | `custom_templates` | `eos_cli_config_gen_custom_templates` |
| `eos_cli_config_gen` | `read_structured_config_from_file` | `eos_cli_config_gen_read_structured_config_from_file` |

Directory variables receive the role prefix. For `eos_designs`, this applies to `root_dir`, `documentation_dir`, `documentation_dir_name`, `fabric_dir`,
`fabric_dir_name`, `output_dir`, `output_dir_name`, `structured_dir`, and `structured_dir_name`. For `eos_cli_config_gen`, this applies to `root_dir`,
`documentation_dir`, `documentation_dir_name`, `devices_dir`, `devices_dir_name`, `output_dir`, `output_dir_name`, `structured_dir`, `structured_dir_name`,
`eos_config_dir` (renamed to `eos_cli_config_gen_config_dir`), and `eos_config_dir_name` (renamed to `eos_cli_config_gen_config_dir_name`).

#### `eos_config_deploy_eapi` and `eos_snapshot`

For `eos_config_deploy_eapi`, directory and filename variables receive the role prefix. `eos_config_dir` and `eos_config_dir_name` become
`eos_config_deploy_eapi_config_dir` and `eos_config_deploy_eapi_config_dir_name`. The other aliases are `root_dir`, `output_dir`, `output_dir_name`,
`pre_running_config_backup_dir`, `pre_running_config_backup_dir_name`, `pre_running_config_backup_filename`, `post_running_config_backup_dir`,
`post_running_config_backup_dir_name`, and `post_running_config_backup_filename`.

| `eos_snapshot` legacy alias | Role-prefixed variable |
| --------------------------- | ---------------------- |
| `commands_list` | `eos_snapshot_commands` |
| `output_format` | `eos_snapshot_output_formats` |
| `root_dir` | `eos_snapshot_root_dir` |
| `snapshots_backup_dir` | `eos_snapshot_backup_dir` |
| `snapshots_backup_dir_name` | `eos_snapshot_backup_dir_name` |
...
| `snmp_settings.enable_inband_mgmt_vrf` | `snmp_settings.vrfs[name="use_inband_mgmt_vrf"].enable` |
| `snmp_settings.enable_mgmt_interface_vrf` | `snmp_settings.vrfs[name="use_mgmt_interface_vrf"].enable` |
...
| `<network_services_keys.name>[].vrfs[].l3_port_channels[].member_interfaces[].name` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<network_services_keys.name>[].vrfs[].l3_port_channels[].member_interfaces[].speed` | Added valid_values |
| `<network_services_keys.name>[].vrfs[].l3_port_channels[].name` | The pattern `Port-Channel[\\d/]+(\\.[\\d]+)?` must now match the whole string |
...
| `<node_type_keys.key>.defaults.isis_system_id_prefix` | The pattern `[0-9a-f]{4}\\.[0-9a-f]{4}` must now match the whole string |
| `<node_type_keys.key>.defaults.l3_interfaces[].name` | The pattern `Ethernet[\\d/]+(\\.[\\d]+)?` must now match the whole string |
| `<node_type_keys.key>.defaults.l3_interfaces[].speed` | Added valid_values |
| `<node_type_keys.key>.defaults.l3_port_channels[].member_interfaces[].name` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.defaults.l3_port_channels[].member_interfaces[].speed` | Added valid_values |
| `<node_type_keys.key>.defaults.l3_port_channels[].name` | The pattern `Port-Channel[\\d/]+(\\.[\\d]+)?` must now match the whole string |
...
| `<node_type_keys.key>.defaults.uplink_interfaces[]` | The pattern `Ethernet.*` must now match the whole string |
| `<node_type_keys.key>.defaults.uplink_switch_interface_speed` | Added valid_values |
| `<node_type_keys.key>.defaults.uplink_switch_interfaces[]` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.defaults.vtep_loopback` | The pattern `Loopback[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.defaults.wan_ha.ha_interfaces[]` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.node_groups[].isis_system_id_prefix` | The pattern `[0-9a-f]{4}\\.[0-9a-f]{4}` must now match the whole string |
| `<node_type_keys.key>.node_groups[].l3_interfaces[].name` | The pattern `Ethernet[\\d/]+(\\.[\\d]+)?` must now match the whole string |
| `<node_type_keys.key>.node_groups[].l3_interfaces[].speed` | Added valid_values |
| `<node_type_keys.key>.node_groups[].l3_port_channels[].member_interfaces[].name` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.node_groups[].l3_port_channels[].member_interfaces[].speed` | Added valid_values |
| `<node_type_keys.key>.node_groups[].l3_port_channels[].name` | The pattern `Port-Channel[\\d/]+(\\.[\\d]+)?` must now match the whole string |
...
| `<node_type_keys.key>.node_groups[].uplink_interfaces[]` | The pattern `Ethernet.*` must now match the whole string |
| `<node_type_keys.key>.node_groups[].uplink_switch_interface_speed` | Added valid_values |
| `<node_type_keys.key>.node_groups[].uplink_switch_interfaces[]` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.node_groups[].vtep_loopback` | The pattern `Loopback[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.node_groups[].wan_ha.ha_interfaces[]` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.node_groups[].nodes[].isis_system_id_prefix` | The pattern `[0-9a-f]{4}\\.[0-9a-f]{4}` must now match the whole string |
| `<node_type_keys.key>.node_groups[].nodes[].l3_interfaces[].name` | The pattern `Ethernet[\\d/]+(\\.[\\d]+)?` must now match the whole string |
| `<node_type_keys.key>.node_groups[].nodes[].l3_interfaces[].speed` | Added valid_values |
| `<node_type_keys.key>.node_groups[].nodes[].l3_port_channels[].member_interfaces[].name` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.node_groups[].nodes[].l3_port_channels[].member_interfaces[].speed` | Added valid_values |
| `<node_type_keys.key>.node_groups[].nodes[].l3_port_channels[].name` | The pattern `Port-Channel[\\d/]+(\\.[\\d]+)?` must now match the whole string |
...
| `<node_type_keys.key>.node_groups[].nodes[].uplink_interfaces[]` | The pattern `Ethernet.*` must now match the whole string |
| `<node_type_keys.key>.node_groups[].nodes[].uplink_switch_interface_speed` | Added valid_values |
| `<node_type_keys.key>.node_groups[].nodes[].uplink_switch_interfaces[]` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.node_groups[].nodes[].vtep_loopback` | The pattern `Loopback[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.node_groups[].nodes[].wan_ha.ha_interfaces[]` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.nodes[].isis_system_id_prefix` | The pattern `[0-9a-f]{4}\\.[0-9a-f]{4}` must now match the whole string |
| `<node_type_keys.key>.nodes[].l3_interfaces[].name` | The pattern `Ethernet[\\d/]+(\\.[\\d]+)?` must now match the whole string |
| `<node_type_keys.key>.nodes[].l3_interfaces[].speed` | Added valid_values |
| `<node_type_keys.key>.nodes[].l3_port_channels[].member_interfaces[].name` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.nodes[].l3_port_channels[].member_interfaces[].speed` | Added valid_values |
| `<node_type_keys.key>.nodes[].l3_port_channels[].name` | The pattern `Port-Channel[\\d/]+(\\.[\\d]+)?` must now match the whole string |
...
| `<node_type_keys.key>.nodes[].uplink_interfaces[]` | The pattern `Ethernet.*` must now match the whole string |
| `<node_type_keys.key>.nodes[].uplink_switch_interface_speed` | Added valid_values |
| `<node_type_keys.key>.nodes[].uplink_switch_interfaces[]` | The pattern `Ethernet[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.nodes[].vtep_loopback` | The pattern `Loopback[\\d/]+` must now match the whole string |
| `<node_type_keys.key>.nodes[].wan_ha.ha_interfaces[]` | The pattern `Ethernet[\\d/]+` must now match the whole string |
...
| `monitor_telemetry_influx.destinations[].url` | The pattern `(http(s)?\|udp\|unix)://.+` must now match the whole string |
| `monitor_telemetry_influx.source_sockets[].url` | The pattern `(http(s)?\|udp\|unix)://.+` must now match the whole string |
