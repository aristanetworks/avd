...
The tabs below shows a a simple example script to build a small fabric from generated inputs.
...
=== "PyAVD v5.x"
    --8<-- docs/pyavd/simple_example_5.x.md

=== "PyAVD v6.0.0"
    --8<-- docs/pyavd/simple_example_6.x.md

=== "PyAVD v5.x to 6.0.0"
    --8<-- docs/pyavd/simple_example_5_to_6.md
