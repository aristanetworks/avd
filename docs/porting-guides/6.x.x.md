...
| `<network_services_keys.name>[].vrfs[].l3_port_channels[].member_interfaces[].name` | regex fullmatch |
| `<network_services_keys.name>[].vrfs[].l3_port_channels[].member_interfaces[].speed` | Added valid_values |
| `<network_services_keys.name>[].vrfs[].l3_port_channels[].name` | regex fullmatch |
...
| `<node_type_keys.key>.defaults.isis_system_id_prefix` | regex fullmatch |
| `<node_type_keys.key>.defaults.l3_interfaces[].name` | regex fullmatch |
| `<node_type_keys.key>.defaults.l3_interfaces[].speed` | Added valid_values |
| `<node_type_keys.key>.defaults.l3_port_channels[].name` | regex fullmatch |
| `<node_type_keys.key>.defaults.l3_port_channels[].member_interfaces[].name` | regex fullmatch |
...
| `<node_type_keys.key>.defaults.uplink_interfaces[]` | regex fullmatch |
| `<node_type_keys.key>.defaults.uplink_switch_interfaces[]` | regex fullmatch |
| `<node_type_keys.key>.defaults.uplink_switch_interface_speed` | Added valid_values |
| `<node_type_keys.key>.defaults.vtep_loopback` | regex fullmatch |
| `<node_type_keys.key>.defaults.wan_ha.ha_interfaces` | regex fullmatch |
...
| `monitor_telemetry_influx.destinations[].url` | regex fullmatch |
| `monitor_telemetry_influx.source_sockets[].url` | regex fullmatch |
