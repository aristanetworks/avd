...
In AVD 6.0.0, this command can be configured without setting `ip_dhcp_snooping.information_option.enabled` as show below.
...
In AVD 6.0.0, this command can be configured without setting `dynamic_prefix_lists[].match_map` as show below.
