...
Starting AVD 6.0, this model is improved by supporting configuration of recovery interval for each cause. `errdisable.recovery.causes` is a now a list dictionary. Refer below diff to update the inputs according to new data model.
