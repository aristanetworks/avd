...
| Removed key | New key |
| ----------- | ------- |
| `<network_services_key.key>[].vrfs[].static_routes.destination_address_prefix` | `<network_services_key.key>[].vrfs[].static_routes.prefix` |
| `<network_services_key.key>[].vrfs[].static_routes.gateway` | `<network_services_key.key>[].vrfs[].static_routes.next_hop` |
| `<network_services_key.key>[].vrfs[].ipv6_static_routes.destination_address_prefix` | `<network_services_key.key>[].vrfs[].ipv6_static_routes.prefix` |
| `<network_services_key.key>[].vrfs[].static_routes.gateway` | `<network_services_key.key>[].vrfs[].ipv6_static_routes.next_hop` |
