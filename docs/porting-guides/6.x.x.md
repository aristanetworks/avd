...
This new validation helps identify keys that will not have any effect, contrary to previous version. By default, these warnings are enabled to help users identify potential configuration issues and transition.
