...
### Schema restriction for eos_designs data models

Starting AVD 6.0.0, the following data model keys have been changed in `eos_designs`.

| Keys | Changes |
| ---- | ------- |
| `aaa_settings.accounting.exec.default.type` | `required: true` |
| `aaa_settings.accounting.system.default.type` | `required: true` |
| `aaa_settings.accounting.dot1x.default.type` | `required: true` |
| `aaa_settings.accounting.commands.console[].type` | `required: true` |
| `aaa_settings.accounting.commands.default[].type` | `required: true` |
...
### Schema restriction for eos_cli_config_gen data models

Starting AVD 6.0.0, the following data model keys have been changed in `eos_cli_config_gen`.

| Keys | Changes |
| ---- | ------- |
| `aaa_accounting.exec.default.type` | `required: true` |
| `aaa_accounting.system.default.type` | `required: true` |
| `aaa_accounting.dot1x.default.type` | `required: true` |
| `aaa_accounting.commands.console[].type` | `required: true` |
| `aaa_accounting.commands.default[].type` | `required: true` |
