...
Starting with AVD 6.0.0, the default value has been changed to `rfc3411_type5`. This now generates a RFC 3411 Type 5 compliant engine ID and handles the inband management IP cases properly.
