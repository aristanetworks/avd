...
In AVD 5.x, if the lengths of `uplink_interfaces`, `uplink_switches`, and `uplink_switch_interfaces` do not match, AVD still generates the configuration without raising an error.
