...
```diff
- connected_endpoints/ethernet-interface.j2
- connected_endpoints/port-channel-interface.j2
- loopback_interfaces/overlay-loopback.j2
- loopback_interfaces/vtep-loopback.j2
- mlag/ethernet-interface.j2
- mlag/port-channel-interface.j2
- underlay/ethernet-interface.j2
- underlay/port-channel-interface.j2
```
