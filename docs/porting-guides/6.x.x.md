...
By default, warnings are enabled to help identify configuration that will be ignored. If you want to disable these warnings, you can set the `avd_eos_designs_validation_configuration.warn_eos_config_keys` variable to `false`:
