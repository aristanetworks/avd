...
Starting AVD 6.0.0, the default templates are removed from the eos_designs role. Custom templates may still be provided, but the role no longer includes built-in templates.
