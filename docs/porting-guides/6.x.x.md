...
| `p2p_links[].ip` | Was too permissive before and broke with more than 2 IPs. Now limited to exactly 2 entries. |
| `p2p_links[].nodes` | Was too permissive before and broke with more than 2 nodes. Now limited to exactly 2 entries. |
| `p2p_links[].interfaces` | Was too permissive before and broke with more than 2 interfaces. Now limited to exactly 2 entries. |
| `p2p_links[].description` | Was too permissive before and broke with more than 2 descriptions. Now limited to exactly 2 entries. |
