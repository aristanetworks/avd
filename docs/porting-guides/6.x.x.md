...
The following data model keys have been required from `eos_designs` in AVD 6.0.0.
...
The following data model keys have been required from `eos_cli_config_gen` in AVD 6.0.0.
