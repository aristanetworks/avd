...
Before AVD 6.x, it was not mandatory to set `mgmt_ip` or `ipv6_mgmt_ip` when using default value of `management_eapi.vrfs`.
This has changed in AVD 6.0. `mgmt_ip` or `ipv6_mgmt_ip` must be set to use default value of `mangement_eapi.vrfs`.
