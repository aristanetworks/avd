...
### Default value of `underlay_ospf_maximum_paths` set to 128
...
Since `128` is already the EOS system default, it will not be rendered in either the structured configuration or the CLI configuration.
