...
For example, after copying the templates to a repository `custom_templates` available in search path when the Ansible playbook is running as [documented here](https://docs.ansible.com/ansible/latest/playbook_guide/playbook_pathing.html):
