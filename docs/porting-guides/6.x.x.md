...
### The execution of user-defined tests, which are located in the directory specified by `user_catalogs_dir_name` (which defaults to the directory user_catalogs), is now disabled by default

To execute your custom tests, you must explicitly set the `user_catalogs_enabled` to true
