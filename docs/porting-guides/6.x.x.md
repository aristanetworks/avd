...
### `ethernet_interfaces[].encapsulation_vlan.client.encapsulation` is now a required key

Starting AVD 6.0.0, `ethernet_interfaces[].encapsulation_vlan.client.encapsulation` is a required key since `ethernet_interfaces[].encapsulation_vlan.client.dot1q` and `ethernet_interfaces[].encapsulation_vlan.client.unmatched` are removed.
...
### `ethernet_interfaces[].encapsulation_vlan.network.encapsulation` is now a required key

Starting AVD 6.0.0, `ethernet_interfaces[].encapsulation_vlan.network.encapsulation` is a required key since `ethernet_interfaces[].encapsulation_vlan.network.dot1q` and `ethernet_interfaces[].encapsulation_vlan.network.client` are removed.
...
### `port_channel_interfaces[].encapsulation_vlan.client.encapsulation` is now a required key

Starting AVD 6.0.0, `port_channel_interfaces[].encapsulation_vlan.client.encapsulation` is a required key since `port_channel_interfaces[].encapsulation_vlan.client.dot1q` and `port_channel_interfaces[].encapsulation_vlan.client.unmatched` are removed.
...
### `port_channel_interfaces[].encapsulation_vlan.network.encapsulation` is now a required key

Starting AVD 6.0.0, `port_channel_interfaces[].encapsulation_vlan.network.encapsulation` is a required key since `port_channel_interfaces[].encapsulation_vlan.network.dot1q` and `port_channel_interfaces[].encapsulation_vlan.network.client` are removed.
