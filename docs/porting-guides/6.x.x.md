...
In AVD 5.x, the data model `ip_http_client_source_interfaces` could generate multiple ip http client commands using the same VRF and source interface.
...
In AVD 5.x, the data model `ip_ssh_client_source_interfaces` could generate multiple ip ssh client commands using the same VRF and source interface.
