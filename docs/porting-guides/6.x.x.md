...
### The execution of user-defined tests, located in `user_catalogs` by default, or as defined by `user_catalogs_dir_name` is now disabled by default

Explicitly set `user_catalogs_enabled: true` to execute custom tests.
