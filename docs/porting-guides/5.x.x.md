...
The test categories are listed in the [role documentation](https://avd.arista.com/5.7/ansible_collections/arista/avd/roles/eos_validate_state/index.html#test-categories)
