...
- Python requirements:
  ...
  - PyAVD now requires the `python-socks[asyncio]` Python library to be version 2.7.2 or higher.<br>
    The latest version can be installed with with `pip install "python-socks[asyncio]>=2.7.2" --upgrade`.
