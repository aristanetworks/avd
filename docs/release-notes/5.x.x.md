...
| `evpn_ebgp_gateway_inter_domain` | - | Removing unused key. |
| `wan_use_agent_env_var_for_kernel_software_forwarding_ecmp` | `<node_type>.kernel_ecmp_cli` | - |
...
| `ip_ftp_client_source_interfaces` | `ip_ftp_client.source_interface` or `ip_ftp_client.vrfs[].source_interface` | - |
| `ip_http_client_source_interfaces` | `ip_http_client.source_interface` or `ip_http_client.vrfs[].source_interface` | - |
| `ip_name_servers` | ip_name_server.servers | - |
| `ip_ssh_client_source_interfaces` | `ip_ssh_client.source_interface` or `ip_ssh_client.vrfs[].source_interface` | - |
| `ip_telnet_client_source_interfaces` | `ip_telnet_client.source_interface` or `ip_telnet_client.vrfs[].source_interface` | - |
| `ip_tftp_client_source_interfaces` | `ip_tftp_client.source_interface` or `ip_tftp_client.vrfs[].source_interface` | - |
