...
| `router_bgp.vlan_aware_bundles.tenant` | `router_bgp.vlan_aware_bundles.metadata.tenant` | Only used for validation and documentation purposes. |
...
| `vlans[].tenant` | `vlans[].metadata.tenant` | Only used for validation and documentation purposes. |
| `vrfs[].tenant` | `vrfs[].metadata.tenant` | Only used for validation and documentation purposes. |
