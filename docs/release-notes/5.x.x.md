...
AVD 5.x.x is incompatible with Python 3.13.10, 3.13.11, 3.14.1 and 3.14.2 due to a critical bug in CPython.
AVD may crash or produce unexpected results when running using these Python versions.

<!--
**Root Cause:** CPython bugs [gh-142218](https://github.com/python/cpython/issues/142218) and
[gh-143189](https://github.com/python/cpython/issues/143189) introduced a regression in Python 3.13.10 and 3.14.1
that was only fully fixed in Python 3.13.12 and 3.14.3.
-->

#### Symptoms

Running AVD with affected Python versions may result in:

- `TypeError: argument of type 'NoneType' is not iterable`
- Crashes during structured config generation
- Unexpected behavior in the eos_designs role
