...
The following data model keys have been deprecated from eos_cli_config_gen in AVD 5.7.0 and will be removed in AVD 6.0.0.
...
| `radius_server.hosts` | `radius_server.servers` | Used to configure hosts with default VRF |
