...
For more details, see the `arista.avd.cv_deploy` role documentation on [AVD website](https://avd.arista.com/stable/ansible_collections/arista/avd/roles/cv_deploy/index.html).
