...
#### arista.avd.configlet_build_config and arista.avd.inventory_to_container

The plugins/modules `arista.avd.configlet_build_config` and `arista.avd.inventory_to_container` will be removed in AVD version 6.0.0.
