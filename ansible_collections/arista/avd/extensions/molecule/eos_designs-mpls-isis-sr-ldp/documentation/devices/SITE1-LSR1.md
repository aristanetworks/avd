...
| --------- | ----------- | ------------- | -------------- | --- | --- | -------- | -------------- | --------------- | ---------------------- | -------------------- | -------- | ----------------- | ----------- | ------------ |
| Ethernet1 | P2P_SITE1-LER1_Ethernet1 | - | 2001:db8:0:fffe::1/127 | default | 9178 | False | - | - | - | - | - | - | - | - |
| Ethernet3 | P2P_SITE2-LSR1_Ethernet3 | - | 2001:db8:0:fffe::8/127 | default | 9178 | False | - | - | - | - | - | - | - | - |
| Ethernet4 | P2P_SITE1-RR1_Ethernet4 | - | 2001:db8:0:fffe::6/127 | default | 9178 | False | - | - | - | - | - | - | - | - |
...
interface Ethernet1
   ...
   ipv6 enable
   ipv6 address 2001:db8:0:fffe::1/127
   mpls ldp igp sync
   mpls ldp interface
   mpls ip
   isis enable CORE
...
interface Ethernet3
   ...
   ipv6 enable
   ipv6 address 2001:db8:0:fffe::8/127
   mpls ldp igp sync
   mpls ldp interface
   mpls ip
   isis enable CORE
...
interface Ethernet4
   ...
   ipv6 enable
   ipv6 address 2001:db8:0:fffe::6/127
   mpls ldp igp sync
   mpls ldp interface
   mpls ip
   isis enable CORE
...
| --------- | ----------- | --- | -------------- |
| Loopback0 | ROUTER_ID | default | 2001:db8:300:ffff::1/128 |
...
interface Loopback0
   ...
   ipv6 address 2001:db8:300:ffff::1/128
   mpls ldp interface
