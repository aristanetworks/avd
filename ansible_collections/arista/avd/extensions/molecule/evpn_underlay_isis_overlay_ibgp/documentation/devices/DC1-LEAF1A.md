...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 192.168.255.5:0 additive | - | - |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 192.168.255.5:0 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 192.168.255.5:0 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 192.168.255.5:0
```
