...
| Ethernet2 | P2P_dc1-leaf1b_Ethernet1 | - | 10.255.255.2/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_dc1-svc-leaf1_Ethernet1 | - | 10.255.255.82/31 | default | 1500 | False | - | - |
...
| 10.255.0.10 | 65110 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
...
| 10.255.255.83 | 65110 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 10.255.0.10 remote-as 65110
   neighbor 10.255.0.10 description dc1-svc-leaf1_Loopback0
   ...
   neighbor 10.255.255.3 description dc1-leaf1b_Ethernet1
   neighbor 10.255.255.83 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.83 remote-as 65110
   neighbor 10.255.255.83 description dc1-svc-leaf1_Ethernet1
