...
| dc1-leaf1b | OSPF | VerifyOSPFMaxLSA | Verifies all OSPF instances did not cross the maximum LSA threshold. | Generated by AVD | unset | - |
| dc1-leaf1b | OSPF | VerifyOSPFNeighborState | Verifies all OSPF neighbors are in FULL state. | Generated by AVD | unset | - |
