...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.169.3.2/32 | - |
...
| --------- | --------------- | ------------ | --------- |
| NODE_GROUP_A | Vlan4094 | 192.168.3.96 | Port-Channel4 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | FIREWALL_firewall-1_Eth2 | - | - | - | - | - |
| Ethernet2 | - | - | - | - | - | - |
...
| Ethernet11.100 | P2P_digital-twin-ethernet-ports-1_Ethernet11.100 | - | 192.168.3.187/31 | default | - | False | - | - |
| Ethernet11.101 | P2P_digital-twin-ethernet-ports-1_Ethernet11.101 | - | 192.168.3.189/31 | default | - | False | - | - |
| Ethernet13 | P2P_external-device-2_Ethernet13 | - | 192.168.3.194/31 | default | 9214 | False | - | - |
| Ethernet13.100 | P2P_external-device-2_Ethernet13.100 | - | 192.168.3.196/31 | default | - | False | - | - |
...
!
interface Ethernet3
   description P2P_digital-twin-ethernet-ports-1_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet4
   description MLAG_digital-twin-ethernet-ports-1_Ethernet4
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_digital-twin-ethernet-ports-1_Ethernet5
   no shutdown
   channel-group 4 mode active
!
interface Ethernet9
...
interface Port-Channel4
   description MLAG_digital-twin-ethernet-ports-1_Port-Channel4
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.3.130/32 |
...
| Vlan4093 | default | 192.168.3.81/31 | - | - | - | - |
| Vlan4094 | default | 192.168.3.97/31 | - | - | - | - |
...
!
interface Vxlan1
   description digital.twin.ethernet.ports.2_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ----------------------- | ------------------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 192.168.3.80 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - | - |
| 192.168.3.114 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - | - |
| 192.168.3.184 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - | - |
| 192.168.3.186 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - | - |
| 192.168.3.188 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - | - |
| 192.168.3.195 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - | - |
| 192.168.3.197 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - | - |
| 192.168.3.198 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - | - |
| 192.168.3.203 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - | - |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| TENANT_A_VRF_A | 192.168.3.130:1025 | connected | - |
...
router bgp 65001
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description digital-twin-ethernet-ports-1
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 256000
   neighbor 192.168.3.80 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.3.80 description digital-twin-ethernet-ports-1_Vlan4093
