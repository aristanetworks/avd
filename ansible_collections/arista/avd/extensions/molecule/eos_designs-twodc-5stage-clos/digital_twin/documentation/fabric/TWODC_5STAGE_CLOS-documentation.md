...
| server-4 | SpecialEndpoint | Eth5 | DC1.POD1.LEAF2A | Port-Channel28 | SPECIALENDPOINT_server-4_Eth5 | False | access | 110 | - | NESTED_TENANT_A |
| server-4 | SpecialEndpoint | Eth6 | DC1-POD1-LEAF2B | Port-Channel28 | SPECIALENDPOINT_server-4_Eth6 | False | access | 110 | - | NESTED_TENANT_A |

### Servers

| Name | Type | Port | Fabric Device | Fabric Port | Description | Shutdown | Mode | Access VLAN | Trunk Allowed VLANs | Profile |
| ---- | ---- | ---- | ------------- | ------------| ----------- | -------- | ---- | ----------- | ------------------- | ------- |
| server-1 | server | Eth1 | DC1.POD1.LEAF2A | Port-Channel16 | SERVER_server-1_Eth1 | False | access | 110 | - | TENANT_A |
| server-1 | server | Eth3 | DC1.POD1.LEAF2A | Port-Channel17 | Set using structured_config on server adapter | False | access | 110 | - | TENANT_A |
| server-1 | server | Eth5 | DC1.POD1.LEAF2A | Port-Channel18 | SERVER_server-1_Eth5 | False | access | 110 | - | NESTED_TENANT_A |
| server-1 | server | Eth7 | DC1.POD1.LEAF2A | Port-Channel19 | SERVER_server-1_Eth7 | False | access | 110 | - | NESTED_TENANT_A |
| server-1 | server | Eth2 | DC1-POD1-LEAF2B | Port-Channel16 | SERVER_server-1_Eth2 | False | access | 110 | - | TENANT_A |
| server-1 | server | Eth4 | DC1-POD1-LEAF2B | Port-Channel17 | Set using structured_config on server adapter | False | access | 110 | - | TENANT_A |
| server-1 | server | Eth6 | DC1-POD1-LEAF2B | Port-Channel18 | SERVER_server-1_Eth6 | False | access | 110 | - | NESTED_TENANT_A |
| server-1 | server | Eth8 | DC1-POD1-LEAF2B | Port-Channel19 | SERVER_server-1_Eth8 | False | access | 110 | - | NESTED_TENANT_A |
