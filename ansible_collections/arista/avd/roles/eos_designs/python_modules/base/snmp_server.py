...
class SnmpServerMixin(UtilsMixin):
    ...
    def _snmp_engine_ids(self, snmp_settings: dict) -> str | None:
        """
        Return engine ids if "snmp_settings.compute_local_engineid" is True.
        Otherwise return None
        """
        if not snmp_settings.get("compute_local_engineid") is True:
            return None
    ...
    def _snmp_location(self, snmp_settings: dict) -> str | None:
        """
    ...
    def _snmp_hosts(self, snmp_settings) -> list | None:
        """
    ...
    def _snmp_local_interfaces(self, source_interfaces_inputs: dict | None) -> list | None:
        """
    ...
    def _snmp_vrfs(self, snmp_settings: dict | None) -> list | None:
        """
