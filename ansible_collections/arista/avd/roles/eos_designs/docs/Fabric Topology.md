...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;mac_address</samp>](## "node_type.defaults.mac_address") | String |  |  |  | `mac_address` can be leverage to document management mac address for use with DHCP provisioning roles |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mac_address</samp>](## "node_type.node_groups.[].mac_address") | String |  |  |  | `mac_address` can be leverage to document management mac address for use with DHCP provisioning roles |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mac_address</samp>](## "node_type.node_groups.[].nodes.[].mac_address") | String |  |  |  | `mac_address` can be leverage to document management mac address for use with DHCP provisioning roles |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mac_address</samp>](## "node_type.nodes.[].mac_address") | String |  |  |  | `mac_address` can be leverage to document management mac address for use with DHCP provisioning roles |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;mac_address</samp>](## "&lt;node_type_keys.key&gt;.defaults.mac_address") | String |  |  |  | `mac_address` can be leverage to document management mac address for use with DHCP provisioning roles |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mac_address</samp>](## "&lt;node_type_keys.key&gt;.node_groups.[].mac_address") | String |  |  |  | `mac_address` can be leverage to document management mac address for use with DHCP provisioning roles |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mac_address</samp>](## "&lt;node_type_keys.key&gt;.node_groups.[].nodes.[].mac_address") | String |  |  |  | `mac_address` can be leverage to document management mac address for use with DHCP provisioning roles |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mac_address</samp>](## "&lt;node_type_keys.key&gt;.nodes.[].mac_address") | String |  |  |  | `mac_address` can be leverage to document management mac address for use with DHCP provisioning roles |
...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag_interfaces_speed</samp>](## "node_type.node_groups.[].nodes.[].mlag_interfaces_speed") | String |  |  |  | < interface_speed or forced interface_speed or auto interface_speed > |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag_port_channel_id</samp>](## "node_type.node_groups.[].nodes.[].mlag_port_channel_id") | Integer |  |  |  | If not set, the mlag port-channel id is generated based on the digits of the first interface present in 'mlag_interfaces'. Valid port-channel id numbers are < 1-2000 > for EOS < 4.25.0F and < 1 - 999999 > for EOS >= 4.25.0F. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag_interfaces_speed</samp>](## "&lt;node_type_keys.key&gt;.node_groups.[].nodes.[].mlag_interfaces_speed") | String |  |  |  | < interface_speed or forced interface_speed or auto interface_speed > |
...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;uplink_interface_speed</samp>](## "node_type.node_groups.[].nodes.[].uplink_interface_speed") | String |  |  |  | Point-to-Point interface speed - will apply to uplinks on both ends<br>< interface_speed or forced interface_speed or auto interface_speed ><br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;uplink_interface_speed</samp>](## "&lt;node_type_keys.key&gt;.node_groups.[].nodes.[].uplink_interface_speed") | String |  |  |  | Point-to-Point interface speed - will apply to uplinks on both ends<br>< interface_speed or forced interface_speed or auto interface_speed ><br> |
