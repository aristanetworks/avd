...
--8<--
ansible_collections/arista/avd/roles/eos_designs/docs/tables/platform-skus.md
--8<--

## Platform families

--8<--
ansible_collections/arista/avd/roles/eos_designs/docs/tables/platform-families.md
--8<--
