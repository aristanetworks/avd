...
### node-type-evpn-ipvpn-gateway-configuration
...
### node-type-inband-management-configuration
...
### node-type-l2-mlag-configuration
...
### node-type-loopback-vtep-configuration
...
### node-type-uplink-configuration
...
### role-documentation-output-settings
