...
### 2 - Node type common configuration
...
### 3 - Node type inband management configuration
...
### 4 - Node type uplink configuration
...
### 5 - Node type L2 & MLAG configuration
...
### 6 - Node type loopback and VTEP configuration
...
### 8 - Node type ISIS configuration
...
### 9 - Node type MPLS configuration
...
### 10 - Node type EVPN Services configuration
...
### 11 - Node type EVPN multi-domain gateway configuration
...
### 12 - Node type EVPN IP-VPN Gateway configuration
...
### 13 - Node type PTP configuration
