...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sflow</samp>](## "&lt;connected_endpoints_keys.key&gt;.[].adapters.[].sflow") | Boolean |  | False |  | Configures sFlow on the interface. This variable is the most specific in the device, so it takes precedence over any other sFlow port definition.<br> |
...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;sflow</samp>](## "network_ports.[].sflow") | Boolean |  | False |  | Configures sFlow on the interface. This variable is the most specific in the device, so it takes precedence over any other sFlow port definition.<br> |
...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;sflow</samp>](## "port_profiles.[].sflow") | Boolean |  | False |  | Configures sFlow on the interface. This variable is the most specific in the device, so it takes precedence over any other sFlow port definition.<br> |
