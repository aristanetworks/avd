...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;use_local_interface_cli</samp>](## "logging_settings.use_local_interface_cli") | Boolean |  | `False` |  | Use `logging local-interface <interface>` CLI instead of the deprecated `logging source-interface <interface>` CLI.<br>The new CLI was introduced in EOS version 4.33. |
