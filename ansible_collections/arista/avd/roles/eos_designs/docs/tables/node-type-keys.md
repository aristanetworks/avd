...
=== "YAML"
    ...
    node_type_keys:
      - key: <str; required; unique>
        ...
        default_underlay_routing_protocol: <str; "ebgp" | "ibgp" | "ospf" | "isis" | "isis-sr" | "isis-ldp" | "isis-sr-ldp" | "ospf-ldp" | "none"; default="ebgp">
