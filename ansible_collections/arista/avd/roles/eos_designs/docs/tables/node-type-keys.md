...
=== "YAML"
    ...
    node_type_keys:
      - key: <str; required; unique>
        ...
        # For `p2p-vrfs`, the uplink is configured as an L3 interface with a subinterface for each VRF
