...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;default_flow_tracker_type</samp>](## "node_type_keys.[].default_flow_tracker_type") | String |  |  | Valid Values:<br>- <code>sampled</code><br>- <code>hardware</code> | Set the default flow tracker type.<br> |
...
=== "YAML"
    ...
    node_type_keys:
      - key: <str; required; unique>
        ...
        default_flow_tracker_type: <str; "sampled" | "hardware">
