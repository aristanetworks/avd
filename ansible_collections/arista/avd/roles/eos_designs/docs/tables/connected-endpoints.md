...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;validate_state</samp>](## "<connected_endpoints_keys.key>.[].adapters.[].validate_state") | Boolean |  |  |  | Key only used for validation purposes |
      ...
      - name: <str; required; unique>
        ...
        adapters:
          ...
          - switch_ports: # required
            ...
            # Key only used for validation purposes
            validate_state: <bool>
