      ...
      - name: <str; required; unique>
        ...
        adapters:
          ...
          - switch_ports: # required
            ...
            # - `all_defined_endpoint_vlans` will configure all endpoint VLANs defined on a switch as explicitly allowed VLANs on the trunk port.
