...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mode</samp>](## "<connected_endpoints_keys.key>.[].adapters.[].port_channel.lacp_fallback.mode") | String |  |  | Valid Values:<br>- <code>static</code><br>- <code>individual</code> | Either static or individual mode is supported. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;profile</samp>](## "<connected_endpoints_keys.key>.[].adapters.[].port_channel.lacp_fallback.individual.profile") | String |  |  |  | Port-profile name to inherit configuration.<br>Currently the "mode", "vlans", "native_vlan" and "native_vlan_tag" from the profile are supported to be inherited.<br> |
            ...
            port_channel:
              ...
              lacp_fallback:
                ...
                individual:
                  ...
                  # Port-profile name to inherit configuration.
                  # Currently the "mode", "vlans", "native_vlan" and "native_vlan_tag" from the profile are supported to be inherited.
                  profile: <str>
