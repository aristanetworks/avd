...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;access_group</samp>](## "<connected_endpoints_keys.key>.[].adapters.[].monitor_sessions.[].source_settings.access_group") | Dictionary |  |  |  | This can be set only when `session_settings.access_group` is not set. |
            ...
            monitor_sessions:
              ...
              - name: <str; required>
                ...
                source_settings:
                  ...
                  # This can be set only when `session_settings.access_group` is not set.
                  access_group:
