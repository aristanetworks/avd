...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;ipv4_standard_acl</samp>](## "dot1x_settings.web_authentication.ipv4_standard_acl") | String |  |  |  | Name of the IPv4 standard access-list to apply to the captive portal.<br>This ACL must be present in `ipv4_standard_acls` catalog. |
