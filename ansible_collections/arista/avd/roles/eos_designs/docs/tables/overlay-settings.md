...
=== "Table"
    ...
    | [<samp>vtep_loopback_description</samp>](## "vtep_loopback_description") | String |  | `VXLAN_TUNNEL_SOURCE` |  | Customize the description on VTEP interface, typically Loopback1. |
