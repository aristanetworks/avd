...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;hardware_tcam</samp>](## "custom_platform_settings.[].feature_support.hardware_tcam") | Boolean |  | `True` |  | Support for hardware TCAM configuration.<br>When `false`, all hardware TCAM configuration is omitted. |
