...
=== "Table"
    ...
    | [<samp>local_users</samp>](## "local_users") <span style="color:red">deprecated</span> | List, items: Dictionary |  |  |  | <span style="color:red">This key is deprecated. Use <samp>aaa_settings.local_users</samp> instead.</span> |
