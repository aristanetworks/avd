...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;servers</samp>](## "dns_settings.servers") <span style="color:red">removed</span> | List, items: Dictionary | Required |  | Min Length: 1 | <span style="color:red">This key was removed. Support was removed in AVD version 6.0.0. Use <samp>ip_name_server</samp> instead.</span> |
