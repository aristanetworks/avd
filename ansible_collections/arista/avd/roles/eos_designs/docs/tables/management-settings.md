...
=== "Table"
    ...
    | [<samp>local_users</samp>](## "local_users") <span style="color:red">removed</span> | List, items: Dictionary |  |  |  | <span style="color:red">This key was removed. Support was removed in AVD version 6.0.0. Use <samp>aaa_settings.local_users</samp> instead.</span> |
