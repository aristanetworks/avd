...
=== "Table"
    ...
    | -------- | ---- | -------- | ------- | ------------------ | ----------- |
    | [<samp>wan_encapsulation</samp>](## "wan_encapsulation") | String |  | `path-selection` | Valid Values:<br>- <code>vxlan</code><br>- <code>path-selection</code> | Select the encapsulation to use for EVPN peerings for WAN BGP peers. |
...
=== "YAML"
    ...
    wan_encapsulation: <str; "vxlan" | "path-selection"; default="path-selection">
