...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;only_configure_route_map_connected_to_bgp_vrfs_when_required</samp>](## "avd_design_future.only_configure_route_map_connected_to_bgp_vrfs_when_required") | Boolean |  |  |  | Remove the route map `RM-CONN-2-BGP-VRFS` when `underlay_rfc5549` and<br>`overlay_mlag_rfc5549` are set.<br> |
