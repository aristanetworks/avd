...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;configure_reverse_evpn_gateway_remote_peers</samp>](## "avd_design_future.configure_reverse_evpn_gateway_remote_peers") | Boolean |  | `False` |  | Available from AVD 6.4.0.<br>Configure reverse EVPN Gateway core BGP peerings for inventory peers referenced by hostname under `evpn_gateway.remote_peers`. |
...
=== "YAML"
    ...
    avd_design_future:
      ...
      # Available from AVD 6.4.0.
      # Configure reverse EVPN Gateway core BGP peerings for inventory peers referenced by hostname under `evpn_gateway.remote_peers`.
      configure_reverse_evpn_gateway_remote_peers: <bool; default=False>
