...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;remove_mpls_lsr_dependency_for_mpls_overlay_role_server</samp>](## "avd_design_future.remove_mpls_lsr_dependency_for_mpls_overlay_role_server") | Boolean |  | `False` |  | Available from AVD 6.5.0.<br>For iBGP Route Reflectors using `mpls_overlay_role: server` with `mpls_lsr: false`,<br>configure `bgp route-reflector preserve-attributes` and<br>`next-hop resolution disabled` under enabled EVPN and/or VPN address families. |
...
=== "YAML"
    ...
    avd_design_future:
      ...
      remove_mpls_lsr_dependency_for_mpls_overlay_role_server: <bool; default=False>
