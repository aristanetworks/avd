...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;render_pvst_border_when_mode_is_mstp</samp>](## "avd_design_future.render_pvst_border_when_mode_is_mstp") | Boolean |  | `False` |  | Available from AVD 6.3.0.<br>Pvst border parameters would not have any effect unless it's MST. |
