...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;raise_for_underlay_router_with_port_channel_uplink</samp>](## "avd_design_future.raise_for_underlay_router_with_port_channel_uplink") | Boolean |  | `False` |  | Raise an error if a node has both 'underlay_router: true' and 'uplink_type: port-channel' set,<br>since this combination is not supported. |
...
=== "YAML"
    ...
    avd_design_future:
      ...
      raise_for_underlay_router_with_port_channel_uplink: <bool; default=False>
    ```
