...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;enforce_presence_of_acl_in_ipv4_standard_acl_catalog</samp>](## "avd_design_future.enforce_presence_of_acl_in_ipv4_standard_acl_catalog") | Boolean |  | `False` |  | Available from AVD 6.3.0.<br>When true, this key enforces `snmp_settings.communities[].access_list_ipv4` to be present in `ipv4_standard_acls` catalog. |
...
=== "YAML"
    ...
    avd_design_future:
      ...
      # Available from AVD 6.3.0.
      # When true, this key enforces `snmp_settings.communities[].access_list_ipv4` to be present in `ipv4_standard_acls` catalog.
      enforce_presence_of_acl_in_ipv4_standard_acl_catalog: <bool; default=False>
