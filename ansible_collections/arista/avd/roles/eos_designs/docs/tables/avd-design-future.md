...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;remove_redundant_ipv4_unicast_for_peer_groups</samp>](## "avd_design_future.remove_redundant_ipv4_unicast_for_peer_groups") | Boolean |  | `False` |  | Fix to configure TLS on RADIUS server group members to match their global RADIUS server configurations. |
