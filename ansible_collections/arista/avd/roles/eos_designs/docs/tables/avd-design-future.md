...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;remove_peer_group_mlag_ipv4_vrfs_peer</samp>](## "avd_design_future.remove_peer_group_mlag_ipv4_vrfs_peer") | Boolean |  | `False` |  | Configure the `mlag_ipv4_vrfs_peer` BGP peer group only when needed. |
