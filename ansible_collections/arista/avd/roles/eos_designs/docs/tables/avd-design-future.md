...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;retain_inband_mgmt_ipv6_behaviour</samp>](## "avd_design_future.retain_inband_mgmt_ipv6_behaviour") | Boolean |  | `True` |  | Retain the current behavior of IPv6 inband management. When this key is set to false:<br>1. Inband management VRF is generated when IPv6 inband management is set.<br>2. Prefix list `IPv6-PL-L2LEAF-INBAND-MGMT` is not generated when overlay_routing_protocol is `none`. |
