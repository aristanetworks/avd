...
=== "Table"
    ...
    | [<samp>underlay_isis_authentication_cleartext_key</samp>](## "underlay_isis_authentication_cleartext_key") | String |  |  |  | Cleartext password. `underlay_isis_authentication_key` takes precedence over this key.<br>To protect the password at rest it is strongly recommended to make use of a vault or similar.<br> |
