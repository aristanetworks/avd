...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "default_interfaces.[].uplink_interfaces.[]") | String |  |  | Pattern: `Ethernet\d+(-\d+)?(,\d+(-\d+)?)*(/\d+(-\d+)?(,\d+(-\d+)?)*)*` | Interface range or interface. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "default_interfaces.[].mlag_interfaces.[]") | String |  |  | Pattern: `Ethernet\d+(-\d+)?(,\d+(-\d+)?)*(/\d+(-\d+)?(,\d+(-\d+)?)*)*` | Interface range or interface. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "default_interfaces.[].downlink_interfaces.[]") | String |  |  | Pattern: `Ethernet\d+(-\d+)?(,\d+(-\d+)?)*(/\d+(-\d+)?(,\d+(-\d+)?)*)*` | Interface range or interface. |
