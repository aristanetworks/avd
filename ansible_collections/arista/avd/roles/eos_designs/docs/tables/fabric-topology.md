...
=== "Table"
    ...
    | -------- | ---- | -------- | ------- | ------------------ | ----------- |
    | [<samp>campus</samp>](## "campus") | String |  |  |  | PREVIEW: This option is marked as "preview", meaning the data models or generated configuration can change at any time.<br>Name of the Campus fabric.<br>Used to generate CloudVision device Topology tags with the `generate_cv_tags` feature. |
    | [<samp>campus_access_pod</samp>](## "campus_access_pod") | String |  |  |  | PREVIEW: This option is marked as "preview", meaning the data models or generated configuration can change at any time.<br>Name of the Campus access pod.<br>Used to generate CloudVision device Topology tags. |
    | [<samp>campus_pod</samp>](## "campus_pod") | String |  |  |  | PREVIEW: This option is marked as "preview", meaning the data models or generated configuration can change at any time.<br>Name of the Campus pod.<br>Used to generate CloudVision device Topology tags. |
...
=== "YAML"
    ...
    # Used to generate CloudVision device Topology tags with the `generate_cv_tags` feature.
    campus: <str>
