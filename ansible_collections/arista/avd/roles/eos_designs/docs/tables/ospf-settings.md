...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key</samp>](## "underlay_ospf_authentication.message_digest_keys.[].key") <span style="color:red">deprecated</span> | String |  |  | Min Length: 1<br>Max Length: 16 | Clear text key.<br>To protect the password at rest it is strongly recommended to make use of a vault or similar.<span style="color:red">This key is deprecated. Support will be removed in AVD version 6.0.0. Use <samp>cleartext_key</samp> instead.</span> |
