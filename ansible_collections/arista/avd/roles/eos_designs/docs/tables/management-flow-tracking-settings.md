...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;wan_ha_links</samp>](## "fabric_flow_tracking.wan_ha_links") | Dictionary |  |  |  | Enable flow-tracking on all non uplink WAN HA links.. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "fabric_flow_tracking.wan_ha_links.enabled") | Boolean |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;name</samp>](## "fabric_flow_tracking.wan_ha_links.name") | String |  |  |  | Flow tracker name as defined in flow_tracking_settings. |
...
=== "YAML"
    ...
    fabric_flow_tracking:
      ...
      # Enable flow-tracking on all non uplink WAN HA links..
      wan_ha_links:
        enabled: <bool>
