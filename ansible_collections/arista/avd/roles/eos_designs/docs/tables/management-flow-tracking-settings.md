...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;collector</samp>](## "flow_tracking_settings.trackers.[].exporters.[].collector") <span style="color:red">deprecated</span> | Dictionary |  |  |  | <span style="color:red">This key is deprecated. Support will be removed in AVD version 6.0.0. Use <samp>flow_tracking_settings.trackers[].exporters[].collectors</samp> instead.</span> |
        ...
        - name: <str; required; unique>
          ...
          exporters:
            ...
            - name: <str; required; unique>
              ...
              # Use `flow_tracking_settings.trackers[].exporters[].collectors` instead.
              collector:
