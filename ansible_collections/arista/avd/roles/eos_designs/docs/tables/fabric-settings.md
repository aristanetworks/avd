...
=== "Table"
    ...
    | [<samp>underlay_multicast_pim_sm</samp>](## "underlay_multicast_pim_sm") | Boolean |  |  |  | Enable Protocol Independent Multicast sparse mode in the underlay on all p2p uplink interfaces, mlag l3 peer interface and core interfaces.<br>Specifically PIM Sparse-Mode will be configured on all routed underlay interfaces.<br> |
    | [<samp>underlay_multicast_static</samp>](## "underlay_multicast_static") | Boolean |  |  |  | Enable static Multicast in the underlay on all p2p uplink interfaces, mlag l3 peer interface and core interfaces.<br>Specifically "multicast ipv4 static" will be configured on all routed underlay interfaces.<br> |
