...
=== "Table"
    ...
    | [<samp>underlay_ipv6_numbered</samp>](## "underlay_ipv6_numbered") | Boolean |  | `False` |  | This feature allows pure IPv6 underlay routing protocol with numbered addresses.<br>Currently sets both underlay and overlay, including MLAG, to use IPv6 addresses.<br>Requires:<br>  - "underlay_ipv6: true"<br>  - "loopback_ipv6_pool"<br>  - "underlay_routing_protocol: ebgp"<br>A number of settings are not yet supported with IPv6 underlay, such as:<br>  - underlay_multicast<br>  - underlay_multicast_rp_interfaces<br>  - underlay_rfc5549<br>  - is_wan_router<br>  - vtep_vvtep_ip<br>  - inband_ztp<br> |
...
=== "YAML"
    ...
    # A number of settings are not yet supported with IPv6 underlay, such as:
    #   - underlay_multicast
