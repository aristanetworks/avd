...
=== "Table"
    ...
    | [<samp>underlay_ipv6</samp>](## "underlay_ipv6") | Boolean |  | `False` |  | This feature turns on IPv6 routing in the underlay.<br>It works with isis underlays and ebgp underlays using "underlay_rfc5549" or "underlay_ipv6_numbered".<br>It requires a "loopback_ipv6_pool" to be defined under the node type settings.<br> |
...
=== "YAML"
    ...
    # It works with isis underlays and ebgp underlays using "underlay_rfc5549" or "underlay_ipv6_numbered".
    # It requires a "loopback_ipv6_pool" to be defined under the node type settings.
