...
=== "Table"
    ...
    | [<samp>underlay_multicast_pim_sm</samp>](## "underlay_multicast_pim_sm") | Boolean |  |  |  | Enable Protocol Independent Multicast sparse mode in the underlay on all p2p uplink interfaces, mlag l3 peer interface and l3_edge / core interfaces.<br>Specifically PIM Sparse-Mode will be configured on all routed underlay interfaces.<br>When true, configure<br>    router multicast<br>      ipv4 routing |
    | [<samp>underlay_multicast_static</samp>](## "underlay_multicast_static") | Boolean |  | `False` |  | Enable static multicast in the underlay on all p2p uplink interfaces, mlag l3 peer interface and core interfaces.<br>Specifically 'multicast ipv4 static' will be configured on all routed underlay interfaces.<br>When true, configure<br>    router multicast<br>      ipv4 routing |
...
=== "YAML"
    ...
    # Enable Protocol Independent Multicast sparse mode in the underlay on all p2p uplink interfaces, mlag l3 peer interface and l3_edge / core interfaces.
    # Specifically PIM Sparse-Mode will be configured on all routed underlay interfaces.
    # When true, configure
    #     router multicast
    #       ipv4 routing
