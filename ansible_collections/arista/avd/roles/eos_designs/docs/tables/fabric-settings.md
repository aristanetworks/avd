...
=== "Table"
    ...
    | [<samp>p2p_uplinks_mtu</samp>](## "p2p_uplinks_mtu") | Integer |  | `9294` | Min: 68<br>Max: 65535 | Point to Point Links MTU. For WAN router default MTU is 9194. |
...
=== "YAML"
    ...
    p2p_uplinks_mtu: <int; 68-65535; default=9294>
