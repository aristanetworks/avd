...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;parent_profile</samp>](## "svi_profiles.[].parent_profile") | String |  |  |  | Parent SVI profile name to apply.<br>svi_profiles can refer to another svi_profile to inherit settings in up to two levels (svi -> svi_profile -> svi_parent_profile).<br>From AVD 6.5.0 onwards, if `avd_design_future.allow_infinite_inheritance` is enabled, a profile can inherit settings across an infinite number of levels.<br> |
...
=== "YAML"
    ...
    svi_profiles:
      ...
      - profile: <str; required; unique>
        ...
        # From AVD 6.5.0 onwards, if `avd_design_future.allow_infinite_inheritance` is enabled, a profile can inherit settings across an infinite number of levels.
        parent_profile: <str>
