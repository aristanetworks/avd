                  ...
                  - node: <str; required; unique>
                    ...
                    ip_helpers:
                      ...
                      - ip_helper: <str; required; unique>
                        ...
                        # - Any other string will be used directly as the source interface. An error is raised, if source VRF is set with `use_mgmt_interface_vrf` or `use_inband_mgmt_vrf`
                        #   or `use_default_mgmt_method_vrf`; and the string does not match with the calculated source interface.
