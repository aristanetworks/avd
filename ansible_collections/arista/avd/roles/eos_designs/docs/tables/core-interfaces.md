...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;use_underlay_authentication</samp>](## "core_interfaces.p2p_links_profiles.[].use_underlay_authentication") | Boolean |  | `False` |  | Enable underlay authentication for this link.<br>When set to `true`:<br>- For OSPF underlay with 'underlay_ospf_authentication.enabled', OSPF message digest keys defined in<br>  'underlay_ospf_authentication.message_digest_keys' will be configured on the interface.<br>- For ISIS underlay, the ISIS authentication key defined in 'underlay_isis_authentication_key' or<br>  'underlay_isis_authentication_cleartext_key' will be configured on the interface. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;use_underlay_authentication</samp>](## "core_interfaces.p2p_links.[].use_underlay_authentication") | Boolean |  | `False` |  | Enable underlay authentication for this link.<br>When set to `true`:<br>- For OSPF underlay with 'underlay_ospf_authentication.enabled', OSPF message digest keys defined in<br>  'underlay_ospf_authentication.message_digest_keys' will be configured on the interface.<br>- For ISIS underlay, the ISIS authentication key defined in 'underlay_isis_authentication_key' or<br>  'underlay_isis_authentication_cleartext_key' will be configured on the interface. |
