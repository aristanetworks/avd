...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;sflow</samp>](## "core_interfaces.p2p_links.[].sflow") | Boolean |  |  |  | Enable sFlow. Overrides `fabric_sflow.core_interfaces` setting. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;flow_tracking</samp>](## "core_interfaces.p2p_links.[].flow_tracking") | Dictionary |  |  |  | Enable flow-tracking. Overrides `fabric_flow_tracking.core_interfaces` setting. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "core_interfaces.p2p_links.[].flow_tracking.enabled") | Boolean |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type</samp>](## "core_interfaces.p2p_links.[].flow_tracking.type") | String |  |  | Valid Values:<br>- <code>sampled</code><br>- <code>hardware</code> | Flow tracker type. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sflow</samp>](## "core_interfaces.p2p_links_profiles.[].sflow") | Boolean |  |  |  | Enable sFlow. Overrides `fabric_sflow.l3_edge` setting. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;flow_tracking</samp>](## "core_interfaces.p2p_links_profiles.[].flow_tracking") | Dictionary |  |  |  | Enable flow-tracking. Overrides `fabric_flow_tracking.l3_edge` setting. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "core_interfaces.p2p_links_profiles.[].flow_tracking.enabled") | Boolean |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type</samp>](## "core_interfaces.p2p_links_profiles.[].flow_tracking.type") | String |  |  | Valid Values:<br>- <code>sampled</code><br>- <code>hardware</code> | Flow tracker type. |
...
=== "YAML"
    ...
    core_interfaces:
      p2p_links:
          ...
          # Enable sFlow. Overrides `fabric_sflow.core_interfaces` setting.
        - sflow: <bool>

          # Enable flow-tracking. Overrides `fabric_flow_tracking.core_interfaces` setting.
          flow_tracking:
            enabled: <bool>
      ...
      p2p_links_profiles:
        ...
        - name: <str; required; unique>
          ...
          # Enable sFlow. Overrides `fabric_sflow.l3_edge` setting.
          sflow: <bool>

          # Enable flow-tracking. Overrides `fabric_flow_tracking.l3_edge` setting.
          flow_tracking:
            enabled: <bool>
