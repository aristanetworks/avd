...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast</samp>](## "core_interfaces.p2p_links_profiles.[].underlay_multicast") <span style="color:red">deprecated</span> | Boolean |  |  |  | Enable PIM sparse mode. Requires `include_in_underlay_protocol` and the global `underlay_multicast` to be `true`.<span style="color:red">This key is deprecated. Support will be removed in AVD version 6.0.0. Use <samp>multicast_pim_sm</samp> instead.</span> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_multicast</samp>](## "core_interfaces.p2p_links.[].underlay_multicast") <span style="color:red">deprecated</span> | Boolean |  |  |  | Enable PIM sparse mode. Requires `include_in_underlay_protocol` and the global `underlay_multicast` to be `true`.<span style="color:red">This key is deprecated. Support will be removed in AVD version 6.0.0. Use <samp>multicast_pim_sm</samp> instead.</span> |
