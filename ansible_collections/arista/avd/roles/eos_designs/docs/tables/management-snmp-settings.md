...
=== "YAML"
    ...
    snmp_settings:
      ...
      # - `rfc3411` use the value of `local_engineid_ip` to find the mgmt ip and calculate an RFC3411 compliant EngineID based on 8000757104+ sha1(hostname + local_engineid_ip)
      ...
      compute_local_engineid_source: <str; "rfc3411" | "system_mac" | "hostname_and_ip"; default="rfc3411">
