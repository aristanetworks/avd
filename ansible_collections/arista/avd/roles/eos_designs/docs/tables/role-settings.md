...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;inband_ztp_attached_hosts</samp>](## "avd_6_behaviors.inband_ztp_attached_hosts") | Boolean |  | `False` |  | Opt-in to the new behavior for inband management route export:<br>- `ip attached-host route export` will only be rendered for inband management interfaces if the underlay protocol is BGP.<br>- This means for non-BGP underlay deployments, the route export will be omitted for inband interfaces. |
...
=== "YAML"
    ...
    avd_6_behaviors:
      ...
      # - `ip attached-host route export` will only be rendered for inband management interfaces if the underlay protocol is BGP.
      # - This means for non-BGP underlay deployments, the route export will be omitted for inband interfaces.
      inband_ztp_attached_hosts: <bool; default=False>
