...
=== "YAML"
    ...
    # Replaces the default route.
    # This setting is ignored when 'mgmt_ip' is set to 'dhcp' and avd_design_future.accept_dhcp_default_route_for_mgmt_ip_dhcp is set to true, since the DHCP server will provide routes.
