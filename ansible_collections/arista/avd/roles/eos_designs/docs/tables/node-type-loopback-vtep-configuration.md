...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;multi_vtep_mlag</samp>](## "<node_type_keys.key>.defaults.multi_vtep_mlag") | Boolean |  | `False` |  | Enable to make MLAG VTEPs utilize the multi-VTEP MLAG feature.<br>This feature cannot be enabled when evpn gw or ipv6 underlay is enabled.<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;multi_vtep_mlag</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].multi_vtep_mlag") | Boolean |  | `False` |  | Enable to make MLAG VTEPs utilize the multi-VTEP MLAG feature.<br>This feature cannot be enabled when evpn gw or ipv6 underlay is enabled.<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;multi_vtep_mlag</samp>](## "<node_type_keys.key>.node_groups.[].multi_vtep_mlag") | Boolean |  | `False` |  | Enable to make MLAG VTEPs utilize the multi-VTEP MLAG feature.<br>This feature cannot be enabled when evpn gw or ipv6 underlay is enabled.<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;multi_vtep_mlag</samp>](## "<node_type_keys.key>.nodes.[].multi_vtep_mlag") | Boolean |  | `False` |  | Enable to make MLAG VTEPs utilize the multi-VTEP MLAG feature.<br>This feature cannot be enabled when evpn gw or ipv6 underlay is enabled.<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;multi_vtep_mlag</samp>](## "device_profiles.[].multi_vtep_mlag") | Boolean |  | `False` |  | Enable to make MLAG VTEPs utilize the multi-VTEP MLAG feature.<br>This feature cannot be enabled when evpn gw or ipv6 underlay is enabled.<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;multi_vtep_mlag</samp>](## "devices.[].multi_vtep_mlag") | Boolean |  | `False` |  | Enable to make MLAG VTEPs utilize the multi-VTEP MLAG feature.<br>This feature cannot be enabled when evpn gw or ipv6 underlay is enabled.<br> |
...
=== "YAML"
    ...
    <node_type_keys.key>:
      ...
      defaults:
        ...
        # This feature cannot be enabled when evpn gw or ipv6 underlay is enabled.
