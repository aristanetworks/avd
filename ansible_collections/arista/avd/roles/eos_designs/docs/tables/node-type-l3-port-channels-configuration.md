...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "<node_type_keys.key>.defaults.l3_port_channels.[].bgp") | Dictionary |  |  |  | Configure BGP peering for the interface. Supports IPv4 BGP peering (when `peer_ip` is set)<br>and IPv6 BGP peering (when `peer_ipv6_address` is set). IPv6 BGP is not supported for WAN interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_port_channels.[].bgp") | Dictionary |  |  |  | Configure BGP peering for the interface. Supports IPv4 BGP peering (when `peer_ip` is set)<br>and IPv6 BGP peering (when `peer_ipv6_address` is set). IPv6 BGP is not supported for WAN interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "<node_type_keys.key>.node_groups.[].l3_port_channels.[].bgp") | Dictionary |  |  |  | Configure BGP peering for the interface. Supports IPv4 BGP peering (when `peer_ip` is set)<br>and IPv6 BGP peering (when `peer_ipv6_address` is set). IPv6 BGP is not supported for WAN interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "<node_type_keys.key>.nodes.[].l3_port_channels.[].bgp") | Dictionary |  |  |  | Configure BGP peering for the interface. Supports IPv4 BGP peering (when `peer_ip` is set)<br>and IPv6 BGP peering (when `peer_ipv6_address` is set). IPv6 BGP is not supported for WAN interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "device_profiles.[].l3_port_channels.[].bgp") | Dictionary |  |  |  | Configure BGP peering for the interface. Supports IPv4 BGP peering (when `peer_ip` is set)<br>and IPv6 BGP peering (when `peer_ipv6_address` is set). IPv6 BGP is not supported for WAN interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "devices.[].l3_port_channels.[].bgp") | Dictionary |  |  |  | Configure BGP peering for the interface. Supports IPv4 BGP peering (when `peer_ip` is set)<br>and IPv6 BGP peering (when `peer_ipv6_address` is set). IPv6 BGP is not supported for WAN interfaces. |
