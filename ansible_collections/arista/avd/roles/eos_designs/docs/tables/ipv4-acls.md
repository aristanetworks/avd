...
=== "YAML"
    ...
    # - For node type L3 interfaces and L3 port-channels: resolved from `ip_address`. If set to "dhcp", the value of `dhcp_ip` is used instead.
