...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;ssh_client</samp>](## "source_interfaces.ssh_client") <span style="color:red">deprecated</span> | Dictionary |  |  |  | IP SSH Client source-interfaces.<span style="color:red">This key is deprecated. Support will be removed in AVD version 7.0.0. Use <samp>ssh_settings.client_source_interfaces</samp> instead.</span> |
...
=== "YAML"
    ...
    source_interfaces:
      ...
      # Use `ssh_settings.client_source_interfaces` instead.
      ssh_client:
