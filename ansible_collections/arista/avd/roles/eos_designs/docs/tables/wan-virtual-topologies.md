...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;internet_exit_policy</samp>](## "wan_virtual_topologies.control_plane_virtual_topology.internet_exit_policy") | String |  |  |  | Internet-exit policy name associated with this virtual_topology.<br>The policy must be defined under `internet_exit_policies`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;internet_exit_policy</samp>](## "wan_virtual_topologies.policies.[].application_virtual_topologies.[].internet_exit_policy") | String |  |  |  | Internet-exit policy name associated with this virtual_topology.<br>The policy must be defined under `internet_exit_policies`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;internet_exit_policy</samp>](## "wan_virtual_topologies.policies.[].default_virtual_topology.internet_exit_policy") | String |  |  |  | Internet-exit policy name associated with this virtual_topology.<br>The policy must be defined under `internet_exit_policies`. |
...
=== "YAML"
    ...
    wan_virtual_topologies:
      ...
      control_plane_virtual_topology:
        ...
        # The policy must be defined under `internet_exit_policies`.
