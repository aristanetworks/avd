...
=== "YAML"
    ...
    # Requires "underlay_multicast: true" or "underlay_multicast_pim_sm: true" or "underlay_multicast_static: true" and IGMP snooping enabled globally (default).
