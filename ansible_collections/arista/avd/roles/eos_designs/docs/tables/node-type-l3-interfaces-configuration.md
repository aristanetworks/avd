...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.defaults.l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ip" token. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_in</samp>](## "<node_type_keys.key>.defaults.l3_interfaces.[].ipv6_acl_in") | String |  |  |  | Name of the IPv6 access-list to be assigned in the ingress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_out</samp>](## "<node_type_keys.key>.defaults.l3_interfaces.[].ipv6_acl_out") | String |  |  |  | Name of the IPv6 Access-list to be assigned in the egress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ip" token. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_in</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].ipv6_acl_in") | String |  |  |  | Name of the IPv6 access-list to be assigned in the ingress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_out</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].ipv6_acl_out") | String |  |  |  | Name of the IPv6 Access-list to be assigned in the egress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ip" token. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_in</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].ipv6_acl_in") | String |  |  |  | Name of the IPv6 access-list to be assigned in the ingress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_out</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].ipv6_acl_out") | String |  |  |  | Name of the IPv6 Access-list to be assigned in the egress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ip" token. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_in</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].ipv6_acl_in") | String |  |  |  | Name of the IPv6 access-list to be assigned in the ingress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_out</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].ipv6_acl_out") | String |  |  |  | Name of the IPv6 Access-list to be assigned in the egress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "device_profiles.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ip" token. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_in</samp>](## "device_profiles.[].l3_interfaces.[].ipv6_acl_in") | String |  |  |  | Name of the IPv6 access-list to be assigned in the ingress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_out</samp>](## "device_profiles.[].l3_interfaces.[].ipv6_acl_out") | String |  |  |  | Name of the IPv6 Access-list to be assigned in the egress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "devices.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ip" token. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_in</samp>](## "devices.[].l3_interfaces.[].ipv6_acl_in") | String |  |  |  | Name of the IPv6 access-list to be assigned in the ingress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_out</samp>](## "devices.[].l3_interfaces.[].ipv6_acl_out") | String |  |  |  | Name of the IPv6 Access-list to be assigned in the egress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "l3_interface_profiles.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ip" token. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_in</samp>](## "l3_interface_profiles.[].ipv6_acl_in") | String |  |  |  | Name of the IPv6 access-list to be assigned in the ingress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;ipv6_acl_out</samp>](## "l3_interface_profiles.[].ipv6_acl_out") | String |  |  |  | Name of the IPv6 Access-list to be assigned in the egress direction.<br>The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`). |
      ...
      defaults:
        ...
        l3_interfaces:
          ...
          - profile: <str>
            ...
            # The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ip" token.
            peer_ipv6: <str>
            ...
            # The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip" and "peer_ip" (resolved from `peer_ipv6`).
            ipv6_acl_in: <str>
