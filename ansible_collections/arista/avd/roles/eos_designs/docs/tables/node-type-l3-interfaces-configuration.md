...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.defaults.l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "<node_type_keys.key>.defaults.l3_interfaces.[].bgp") | Dictionary |  |  |  | Configure IPv4 and/or IPv6 BGP peering for the interface when `peer_ip` and/or `peer_ipv6` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "<node_type_keys.key>.defaults.l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "<node_type_keys.key>.defaults.l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].bgp") | Dictionary |  |  |  | Configure IPv4 and/or IPv6 BGP peering for the interface when `peer_ip` and/or `peer_ipv6` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].bgp") | Dictionary |  |  |  | Configure IPv4 and/or IPv6 BGP peering for the interface when `peer_ip` and/or `peer_ipv6` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].bgp") | Dictionary |  |  |  | Configure IPv4 and/or IPv6 BGP peering for the interface when `peer_ip` and/or `peer_ipv6` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "device_profiles.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "device_profiles.[].l3_interfaces.[].bgp") | Dictionary |  |  |  | Configure IPv4 and/or IPv6 BGP peering for the interface when `peer_ip` and/or `peer_ipv6` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "device_profiles.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "device_profiles.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "devices.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "devices.[].l3_interfaces.[].bgp") | Dictionary |  |  |  | Configure IPv4 and/or IPv6 BGP peering for the interface when `peer_ip` and/or `peer_ipv6` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "devices.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "devices.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "l3_interface_profiles.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;bgp</samp>](## "l3_interface_profiles.[].bgp") | Dictionary |  |  |  | Configure IPv4 and/or IPv6 BGP peering for the interface when `peer_ip` and/or `peer_ipv6` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "l3_interface_profiles.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "l3_interface_profiles.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
