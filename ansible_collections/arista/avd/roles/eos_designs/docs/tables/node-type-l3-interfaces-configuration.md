      ...
      defaults:
        ...
        l3_interfaces:
          ...
          - profile: <str>
            ...
            # The access-list must be defined under `ipv6_acls` and supports field substitution for "interface_ip", "interface_ipv6" (both resolve to the interface IPv6 address) and "peer_ip" (resolved from `peer_ipv6`).
            ipv6_acl_in: <str>
