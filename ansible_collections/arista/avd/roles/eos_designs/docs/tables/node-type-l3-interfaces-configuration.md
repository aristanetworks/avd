...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "<node_type_keys.key>.defaults.l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "<node_type_keys.key>.defaults.l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set.<br>IPv6 BGP peering using `peer_ipv6` and `bgp` is not supported when `wan_carrier` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set.<br>IPv6 BGP peering using `peer_ipv6` and `bgp` is not supported when `wan_carrier` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "<node_type_keys.key>.node_groups.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set.<br>IPv6 BGP peering using `peer_ipv6` and `bgp` is not supported when `wan_carrier` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "<node_type_keys.key>.nodes.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "device_profiles.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set.<br>IPv6 BGP peering using `peer_ipv6` and `bgp` is not supported when `wan_carrier` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "device_profiles.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "device_profiles.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "devices.[].l3_interfaces.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set.<br>IPv6 BGP peering using `peer_ipv6` and `bgp` is not supported when `wan_carrier` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "devices.[].l3_interfaces.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "devices.[].l3_interfaces.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;peer_ipv6</samp>](## "l3_interface_profiles.[].peer_ipv6") | String |  |  |  | The peer device IPv6 address (no mask). Used for field substitution in `ipv6_acls` entries with the "peer_ipv6" token<br>and for creating IPv6 BGP peering if `bgp` is also set.<br>IPv6 BGP peering using `peer_ipv6` and `bgp` is not supported when `wan_carrier` is set. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_in</samp>](## "l3_interface_profiles.[].bgp.ipv6_prefix_list_in") | String |  |  |  | IPv6 prefix list name. Accept routes for only these IPv6 prefixes from the peer.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_list_out</samp>](## "l3_interface_profiles.[].bgp.ipv6_prefix_list_out") | String |  |  |  | IPv6 prefix list name. Advertise routes for only these IPv6 prefixes.<br>Only applied when `peer_ipv6` is set; otherwise ignored.<br>The specified prefix list name must exist in `ipv6_prefix_list_catalog`. |
