...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;allow_access_list</samp>](## "port_profiles.[].dot1x.authentication_failure.allow_access_list") | String |  |  |  | Name of access-list to apply when authentication fails. |
