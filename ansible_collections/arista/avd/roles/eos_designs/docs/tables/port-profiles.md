...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;digital_twin</samp>](## "port_profiles.[].digital_twin") | Boolean |  | `True` |  | PREVIEW: This option is marked as "preview", meaning the data models or generated configuration can change at any time.<br>Setting this flag to `true` includes the interfaces in "Digital Twin" mode. |
