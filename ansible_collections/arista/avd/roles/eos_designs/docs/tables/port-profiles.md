...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;allow_ipv4_access_list</samp>](## "port_profiles.[].dot1x.authentication_failure.allow_ipv4_access_list") | String |  |  |  | Name of the IPv4 standard access list to be applied to unauthenticated traffic. |
