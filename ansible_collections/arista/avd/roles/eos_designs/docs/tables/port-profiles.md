...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;mac_acl_in</samp>](## "port_profiles.[].mac_acl_in") | String |  |  |  | MAC access-list to apply in inward direction. The ACL should be present in `mac_acls`. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;mac_acl_out</samp>](## "port_profiles.[].mac_acl_out") | String |  |  |  | MAC access-list to apply in outward direction. The ACL should be present in `mac_acls`. |
