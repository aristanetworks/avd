...
=== "Table"
    ...
    | [<samp>digital_twin_custom_structured_configuration_prefix</samp>](## "digital_twin_custom_structured_configuration_prefix") | List, items: String |  | See (+) on YAML tab |  | PREVIEW: This option is marked as "preview", while we refactor the code to conform to the described behavior.<br>Custom EOS Structured Configuration keys that will be only applied to the fabric nodes in the Digital Twin mode.<br> |
    | [<samp>&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "digital_twin_custom_structured_configuration_prefix.[]") | String |  |  |  |  |
...
=== "YAML"
    ...
    # Custom EOS Structured Configuration keys that will be only applied to the fabric nodes in the Digital Twin mode.
    digital_twin_custom_structured_configuration_prefix: # (1)!
      - <str>
    ```
    ...
    1. Default Value
        ...
        - digital_twin_custom_structured_configuration_
        ```
