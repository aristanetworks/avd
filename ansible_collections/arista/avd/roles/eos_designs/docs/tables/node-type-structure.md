...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag</samp>](## "<node_type_keys.key>.defaults.underlay_multicast.pim_sm.mlag") | Boolean |  |  |  | Configure PIM sparse-mode in the underlay on all mlag l3 peer interface and core interfaces for the specific node.<br>Set as `false` to remove all mlag l3 peer interface and core interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag</samp>](## "<node_type_keys.key>.defaults.underlay_multicast.static.mlag") | Boolean |  |  |  | Configure static PIM in the underlay on all mlag l3 peer interface and core interfaces for the specific node.<br>Set as `false` to remove all mlag l3 peer interface and core interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].underlay_multicast.pim_sm.mlag") | Boolean |  |  |  | Configure PIM sparse-mode in the underlay on all mlag l3 peer interface and core interfaces for the specific node.<br>Set as `false` to remove all mlag l3 peer interface and core interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].underlay_multicast.static.mlag") | Boolean |  |  |  | Configure static PIM in the underlay on all mlag l3 peer interface and core interfaces for the specific node.<br>Set as `false` to remove all mlag l3 peer interface and core interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag</samp>](## "<node_type_keys.key>.node_groups.[].underlay_multicast.pim_sm.mlag") | Boolean |  |  |  | Configure PIM sparse-mode in the underlay on all mlag l3 peer interface and core interfaces for the specific node.<br>Set as `false` to remove all mlag l3 peer interface and core interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag</samp>](## "<node_type_keys.key>.node_groups.[].underlay_multicast.static.mlag") | Boolean |  |  |  | Configure static PIM in the underlay on all mlag l3 peer interface and core interfaces for the specific node.<br>Set as `false` to remove all mlag l3 peer interface and core interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag</samp>](## "<node_type_keys.key>.nodes.[].underlay_multicast.pim_sm.mlag") | Boolean |  |  |  | Configure PIM sparse-mode in the underlay on all mlag l3 peer interface and core interfaces for the specific node.<br>Set as `false` to remove all mlag l3 peer interface and core interfaces. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mlag</samp>](## "<node_type_keys.key>.nodes.[].underlay_multicast.static.mlag") | Boolean |  |  |  | Configure static PIM in the underlay on all mlag l3 peer interface and core interfaces for the specific node.<br>Set as `false` to remove all mlag l3 peer interface and core interfaces. |
      ...
      defaults:
        underlay_multicast:
          pim_sm:
            ...
            # Configure PIM sparse-mode in the underlay on all mlag l3 peer interface and core interfaces for the specific node.
          ...
          static:
            ...
            # Configure static PIM in the underlay on all mlag l3 peer interface and core interfaces for the specific node.
            # Set as `false` to remove all mlag l3 peer interface and core interfaces.
            mlag: <bool>
