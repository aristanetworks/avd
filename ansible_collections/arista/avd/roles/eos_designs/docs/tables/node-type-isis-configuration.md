=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;isis_system_id_prefix</samp>](## "&lt;node_type_keys.key&gt;.defaults.isis_system_id_prefix") | String |  |  | Allowed formats:<br>- regex,[0-9a-f]{4}\.[0-9a-f]{4} | (4.4 hexadecimal). |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isis_system_id_prefix</samp>](## "&lt;node_type_keys.key&gt;.node_groups.[].nodes.[].isis_system_id_prefix") | String |  |  | Allowed formats:<br>- regex,[0-9a-f]{4}\.[0-9a-f]{4} | (4.4 hexadecimal). |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isis_system_id_prefix</samp>](## "&lt;node_type_keys.key&gt;.node_groups.[].isis_system_id_prefix") | String |  |  | Allowed formats:<br>- regex,[0-9a-f]{4}\.[0-9a-f]{4} | (4.4 hexadecimal). |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isis_system_id_prefix</samp>](## "&lt;node_type_keys.key&gt;.nodes.[].isis_system_id_prefix") | String |  |  | Allowed formats:<br>- regex,[0-9a-f]{4}\.[0-9a-f]{4} | (4.4 hexadecimal). |
