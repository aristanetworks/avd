...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;wan</samp>](## "custom_platform_settings.[].feature_support.wan") | Boolean |  | `True` |  | Support for Arista SD-WAN solution.<br>This feature raises an exception when used on unsupported platforms. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ptp</samp>](## "custom_platform_settings.[].feature_support.ptp") | Boolean |  | `True` |  | Support for Precision Time Protocol (PTP).<br>Feature will be ignored on unsupported platforms. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;wan</samp>](## "platform_settings.[].feature_support.wan") | Boolean |  | `True` |  | Support for Arista SD-WAN solution.<br>This feature raises an exception when used on unsupported platforms. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ptp</samp>](## "platform_settings.[].feature_support.ptp") | Boolean |  | `True` |  | Support for Precision Time Protocol (PTP).<br>Feature will be ignored on unsupported platforms. |
    ...
    custom_platform_settings:
      - platforms:
        ...
        feature_support:
          ...
          # This feature raises an exception when used on unsupported platforms.
