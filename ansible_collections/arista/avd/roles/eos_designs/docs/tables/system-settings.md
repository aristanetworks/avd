...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eligibility_forwarding</samp>](## "mac_address_table.static_entries.[].eligibility_forwarding") | Boolean |  |  |  | Enable the ability to forward traffic on the specified interface and VLAN for this MAC address. This option is only applicable when 'interface' is defined. |
    ...
    mac_address_table:
      ...
      static_entries:
        ...
        - mac_address: <str; required>
          ...
          # Enable the ability to forward traffic on the specified interface and VLAN for this MAC address. This option is only applicable when 'interface' is defined.
