...
=== "YAML"
    ...
    fabric_ip_addressing:
      mlag:
        ...
        #     This allocation method will use the first available /<prefixlen> subnet from the provided pool for all MLAG links.
