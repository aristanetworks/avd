      ...
      defaults:
        ...
        evpn_gateway:
          ...
          evpn_l3:
            ...
            # - next-hop-self: (default) RD and RT values for the routes coming from remote EVPN domain are not modified.
