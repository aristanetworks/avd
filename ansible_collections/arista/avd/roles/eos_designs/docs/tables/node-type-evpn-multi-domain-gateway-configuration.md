    ...
    <node_type_keys.key>:
      ...
      defaults:
        ...
        evpn_gateway:
          ...
          # Reverse EVPN Gateway core peering is only auto-rendered for inventory peers where neither `ip_address` nor `bgp_as` is manually overridden.
          remote_peers:
