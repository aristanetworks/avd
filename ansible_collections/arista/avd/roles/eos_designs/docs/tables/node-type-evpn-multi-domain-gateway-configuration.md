    ...
    <node_type_keys.key>:
      ...
      defaults:
        ...
        evpn_gateway:
          ...
          # Auto-rendered reverse EVPN Gateway peers must have EVPN enabled with role `server` or `client`.
