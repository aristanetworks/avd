...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isis_authentication_cleartext_key</samp>](## "l3_edge.p2p_links_profiles.[].isis_authentication_cleartext_key") | String |  |  |  | Cleartext password. `isis_authentication_key` takes precedence over this key. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isis_authentication_cleartext_key</samp>](## "l3_edge.p2p_links.[].isis_authentication_cleartext_key") | String |  |  |  | Cleartext password. `isis_authentication_key` takes precedence over this key. |
