...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;authentication</samp>](## "<network_services_keys.name>.[].vrfs.[].ospf.authentication") | String |  |  | Valid Values:<br>- <code>simple</code><br>- <code>message-digest</code> | Configure OSPF authentication at the VRF level.<br>Configuration at the interface level under `l3_interfaces` or `l3_port_channels` takes precedence. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;simple_auth_key</samp>](## "<network_services_keys.name>.[].vrfs.[].svis.[].nodes.[].ospf.simple_auth_key") | String |  |  |  | Key for OSPF simple authentication.<br>Expect a cleartext password if `encrypt_passwords: true`, otherwise expect a type 7 password.<br>Maximum 8 characters for cleartext password. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key</samp>](## "<network_services_keys.name>.[].vrfs.[].svis.[].nodes.[].ospf.message_digest_keys.[].key") | String |  |  |  | Key for OSPF simple authentication.<br>Expect a cleartext password if `encrypt_passwords: true`, otherwise expect a type 7 password.<br>Maximum 8 characters for cleartext password. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;simple_auth_key</samp>](## "<network_services_keys.name>.[].vrfs.[].svis.[].ospf.simple_auth_key") | String |  |  |  | Key for OSPF simple authentication.<br>Expect a cleartext password if `encrypt_passwords: true`, otherwise expect a type 7 password.<br>Maximum 8 characters for cleartext password. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key</samp>](## "<network_services_keys.name>.[].vrfs.[].svis.[].ospf.message_digest_keys.[].key") | String |  |  |  | Key for OSPF simple authentication.<br>Expect a cleartext password if `encrypt_passwords: true`, otherwise expect a type 7 password.<br>Maximum 8 characters for cleartext password. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;simple_auth_key</samp>](## "svi_profiles.[].nodes.[].ospf.simple_auth_key") | String |  |  |  | Key for OSPF simple authentication.<br>Expect a cleartext password if `encrypt_passwords: true`, otherwise expect a type 7 password.<br>Maximum 8 characters for cleartext password. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key</samp>](## "svi_profiles.[].nodes.[].ospf.message_digest_keys.[].key") | String |  |  |  | Key for OSPF simple authentication.<br>Expect a cleartext password if `encrypt_passwords: true`, otherwise expect a type 7 password.<br>Maximum 8 characters for cleartext password. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;simple_auth_key</samp>](## "svi_profiles.[].ospf.simple_auth_key") | String |  |  |  | Key for OSPF simple authentication.<br>Expect a cleartext password if `encrypt_passwords: true`, otherwise expect a type 7 password.<br>Maximum 8 characters for cleartext password. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key</samp>](## "svi_profiles.[].ospf.message_digest_keys.[].key") | String |  |  |  | Key for OSPF simple authentication.<br>Expect a cleartext password if `encrypt_passwords: true`, otherwise expect a type 7 password.<br>Maximum 8 characters for cleartext password. |
