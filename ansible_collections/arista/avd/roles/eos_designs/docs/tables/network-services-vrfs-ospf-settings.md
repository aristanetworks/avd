...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key</samp>](## "<network_services_keys.name>.[].vrfs.[].ospf.message_digest_keys.[].key") | String | Required |  | Min Length: 1<br>Max Length: 16 | Key password.<br>Only plaintext passwords are supported here as `eos_designs` will encrypt the password for each individual `l3_interfaces`, `l3_port_channels` or `svis`.<br>To protect the password at rest it is strongly recommended to make use of a vault or similar.<br>Configuration at the interface level under `l3_interfaces` or `l3_port_channels` takes precedence.<br>`encrypt_passwords` value does not have any effect on this key. |
            ...
            ospf:
              ...
              message_digest_keys: # 1-2 items
                - id: <int; required; unique>
                  ...
                  # Key password.
                  # Only plaintext passwords are supported here as `eos_designs` will encrypt the password for each individual `l3_interfaces`, `l3_port_channels` or `svis`.
