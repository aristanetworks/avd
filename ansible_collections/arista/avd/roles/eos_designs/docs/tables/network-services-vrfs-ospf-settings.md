...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;structured_config</samp>](## "<network_services_keys.name>.[].vrfs.[].ospf.structured_config") | Dictionary |  |  |  | Custom structured config added under router_ospf.process_ids.[process_id=<process_id>] for EOS Config schema. |
        ...
        vrfs:
          - name: <str; required; unique>
            ...
            ospf:
              ...
              # Custom structured config added under router_ospf.process_ids.[process_id=<process_id>] for EOS Config schema.
