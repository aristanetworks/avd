...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;ipv4_pool</samp>](## "<node_type_keys.key>.defaults.downlink_pools.[].ipv4_pool") | String |  |  | Format: ipv4_cidr | IPv4 pool from which subnets will be allocated for links to downlink switches. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;ipv4_pool</samp>](## "<node_type_keys.key>.node_groups.[].downlink_pools.[].ipv4_pool") | String |  |  | Format: ipv4_cidr | IPv4 pool from which subnets will be allocated for links to downlink switches. |
