...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;downlink_ipv4_pool</samp>](## "<node_type_keys.key>.defaults.downlink_ipv4_pool") | String |  |  | Format: ipv4_cidr | IPv4 subnet to use to connect to downlink switches. Set this on the parent switch. Cannot be combined with uplink_ipv4_pool for the same link. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;downlink_interfaces</samp>](## "<node_type_keys.key>.defaults.downlink_interfaces") | List, items: String |  |  |  | Local downlink interfaces<br>Each list item supports range syntax that can be expanded into a list of interfaces.<br>If downlink_interfaces is not defined, platform-specific defaults (defined under default_interfaces) will be used instead.<br>Please note that default_interfaces are not defined by default, you should define these yourself.<br> |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "<node_type_keys.key>.defaults.downlink_interfaces.[]") | String |  |  | Pattern: Ethernet[\d/]+ |  |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;downlink_ipv4_pool</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].downlink_ipv4_pool") | String |  |  | Format: ipv4_cidr | IPv4 subnet to use to connect to downlink switches. Set this on the parent switch. Cannot be combined with uplink_ipv4_pool for the same link. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;downlink_interfaces</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].downlink_interfaces") | List, items: String |  |  |  | Local downlink interfaces<br>Each list item supports range syntax that can be expanded into a list of interfaces.<br>If downlink_interfaces is not defined, platform-specific defaults (defined under default_interfaces) will be used instead.<br>Please note that default_interfaces are not defined by default, you should define these yourself.<br> |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].downlink_interfaces.[]") | String |  |  | Pattern: Ethernet[\d/]+ |  |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;downlink_ipv4_pool</samp>](## "<node_type_keys.key>.node_groups.[].downlink_ipv4_pool") | String |  |  | Format: ipv4_cidr | IPv4 subnet to use to connect to downlink switches. Set this on the parent switch. Cannot be combined with uplink_ipv4_pool for the same link. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;downlink_interfaces</samp>](## "<node_type_keys.key>.node_groups.[].downlink_interfaces") | List, items: String |  |  |  | Local downlink interfaces<br>Each list item supports range syntax that can be expanded into a list of interfaces.<br>If downlink_interfaces is not defined, platform-specific defaults (defined under default_interfaces) will be used instead.<br>Please note that default_interfaces are not defined by default, you should define these yourself.<br> |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "<node_type_keys.key>.node_groups.[].downlink_interfaces.[]") | String |  |  | Pattern: Ethernet[\d/]+ |  |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;downlink_ipv4_pool</samp>](## "<node_type_keys.key>.nodes.[].downlink_ipv4_pool") | String |  |  | Format: ipv4_cidr | IPv4 subnet to use to connect to downlink switches. Set this on the parent switch. Cannot be combined with uplink_ipv4_pool for the same link. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;downlink_interfaces</samp>](## "<node_type_keys.key>.nodes.[].downlink_interfaces") | List, items: String |  |  |  | Local downlink interfaces<br>Each list item supports range syntax that can be expanded into a list of interfaces.<br>If downlink_interfaces is not defined, platform-specific defaults (defined under default_interfaces) will be used instead.<br>Please note that default_interfaces are not defined by default, you should define these yourself.<br> |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "<node_type_keys.key>.nodes.[].downlink_interfaces.[]") | String |  |  | Pattern: Ethernet[\d/]+ |  |
...
=== "YAML"
    ...
    <node_type_keys.key>:
      ...
      defaults:
        ...
        # IPv4 subnet to use to connect to downlink switches. Set this on the parent switch. Cannot be combined with uplink_ipv4_pool for the same link.
        downlink_ipv4_pool: <str>

        # Local downlink interfaces
        # Each list item supports range syntax that can be expanded into a list of interfaces.
        # If downlink_interfaces is not defined, platform-specific defaults (defined under default_interfaces) will be used instead.
        # Please note that default_interfaces are not defined by default, you should define these yourself.
        downlink_interfaces:
          - <str>
