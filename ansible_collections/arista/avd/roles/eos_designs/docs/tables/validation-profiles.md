...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;transceiver_manufacturers</samp>](## "validation_profiles.[].hardware.transceiver_manufacturers") | List, items: String |  | See (+) on YAML tab |  | List of approved transceiver manufacturers for the device.<br>Include "Not Present" in the transceiver_manufacturers list. Otherwise validation will error out on all ports with no transceivers connected. |
