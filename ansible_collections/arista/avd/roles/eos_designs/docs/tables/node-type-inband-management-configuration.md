...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;inband_ztp_parent</samp>](## "<node_type_keys.key>.defaults.inband_ztp_parent") | Boolean |  | `False` |  | Enable to allow downstream devices to ZTP inband<br>This setting also requires that the inband_mgmt_vlan is set for the downstream device. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;inband_ztp_parent</samp>](## "<node_type_keys.key>.node_groups.[].nodes.[].inband_ztp_parent") | Boolean |  | `False` |  | Enable to allow downstream devices to ZTP inband<br>This setting also requires that the inband_mgmt_vlan is set for the downstream device. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;inband_ztp_parent</samp>](## "<node_type_keys.key>.node_groups.[].inband_ztp_parent") | Boolean |  | `False` |  | Enable to allow downstream devices to ZTP inband<br>This setting also requires that the inband_mgmt_vlan is set for the downstream device. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;inband_ztp_parent</samp>](## "<node_type_keys.key>.nodes.[].inband_ztp_parent") | Boolean |  | `False` |  | Enable to allow downstream devices to ZTP inband<br>This setting also requires that the inband_mgmt_vlan is set for the downstream device. |
...
=== "YAML"
    ...
    <node_type_keys.key>:
      ...
      defaults:
        ...
        inband_ztp_parent: <bool; default=False>
