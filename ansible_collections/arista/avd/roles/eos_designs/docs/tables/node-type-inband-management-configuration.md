...
=== "YAML"
    ...
    <node_type_keys.key>:
      ...
      defaults:
        ...
        # This setting is applicable to L2 switches (switches using L2 trunks as uplinks).
        #
        # This setting is ignored when 'mgmt_ip' is set to 'dhcp' and 'avd_design_future.accept_dhcp_default_route_for_inband_mgmt_ip_dhcp: true', since the DHCP server will provide the gateway.
