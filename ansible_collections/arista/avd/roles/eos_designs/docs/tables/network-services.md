    ...
    <network_services_keys.name>:
      ...
      - name: <str; required; unique>
        ...
        vpws:
          ...
          # The default is false as this is more commonly used in Segment Routing designs, but it can be set to true for better interoperability with non-Segment Routing designs.
          mpls_control_word: <bool; default=False>

          # MTU for VPWS pseudowires. This is configured on the Port-Channel interfaces of the pseudowire endpoints.
          mtu: <int>
