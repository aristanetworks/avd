...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;name</samp>](## "cv_settings.onprem_clusters.[].name") | String | Required, Unique |  |  | Short name for the cluster. Used when configuring multiple clusters. |
...
=== "YAML"
    ...
    # This key is deprecated.
    # Support will be removed in AVD version 6.0.0.
    # Use `cv_settings.onprem_clusters[].servers[].name` or `cv_settings.cvaas.fqdn` instead.
    cvp_instance_ips:
