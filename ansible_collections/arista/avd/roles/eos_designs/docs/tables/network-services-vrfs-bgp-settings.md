...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;nodes</samp>](## "<network_services_keys.name>.[].vrfs.[].bgp_peers.[].nodes") | List, items: String |  |  |  | Nodes is required to restrict configuration of BGP neighbors to certain nodes in the network.<br>The hostname should match fully with any one of the regex patterns in the list.                     |
          ...
          - name: <str; required; unique>
            ...
            bgp_peers:
              ...
              - ip_address: <str; required>
                ...
                # Nodes is required to restrict configuration of BGP neighbors to certain nodes in the network.
                # The hostname should match fully with any one of the regex patterns in the list.
                nodes:
                  - <str>
