...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;redistribute_connected</samp>](## "<network_services_keys.name>.[].vrfs.[].redistribute_connected") | Boolean |  | `True` |  | Non-selectively enabling or disabling redistribution of connected routes to BGP inside the VRF. |
      ...
      - name: <str; required; unique>
        ...
        vrfs:
          - name: <str; required; unique>
            ...
            # Non-selectively enabling or disabling redistribution of connected routes to BGP inside the VRF.
