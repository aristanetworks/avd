...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rd_override</samp>](## "<network_services_keys.name>.[].vrfs.[].rd_override") | String |  |  |  | By default the VRF RD will be derived from overlay loopback and vrf_id.<br>The rd_override allows us to override this value and statically define it.<br><br>rd_override supports two formats:<br>  - A single number which will be used in the RD assigned number field instead of vrf_id (see 'overlay_rd_type' for details).<br>  - A full RD string with colon seperator which will override the full RD.<br> |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rt_override</samp>](## "<network_services_keys.name>.[].vrfs.[].rt_override") | String |  |  |  | By default the VRF RT will be derived from the vrf_id.<br>The rt_override allows us to override this value and statically define it.<br><br>rt_override supports two formats:<br>  - A single number which will be used in the RT fields instead of vrf_id (see 'overlay_rt_type' for details).<br>  - A full RT string with colon seperator which will override the full RT.<br> |
      ...
      - name: <str; required; unique>
        ...
        vrfs:
          - name: <str; required; unique>
            ...
            # By default the VRF RD will be derived from overlay loopback and vrf_id.
            # The rd_override allows us to override this value and statically define it.

            # rd_override supports two formats:
            #   - A single number which will be used in the RD assigned number field instead of vrf_id (see 'overlay_rd_type' for details).
            #   - A full RD string with colon seperator which will override the full RD.
            rd_override: <str>

            # By default the VRF RT will be derived from the vrf_id.
            # The rt_override allows us to override this value and statically define it.

            # rt_override supports two formats:
            #   - A single number which will be used in the RT fields instead of vrf_id (see 'overlay_rt_type' for details).
