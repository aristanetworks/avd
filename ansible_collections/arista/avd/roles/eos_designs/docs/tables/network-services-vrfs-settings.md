        ...
        vrfs:
          - name: <str; required; unique>
            ...
            vtep_diagnostic:
              ...
              # `loopback_ip_pools` takes precedence for IPv4 if `pod_name` and `loopback_ip_pools` are defined.
              ...
              # `loopback_ip_pools` takes precedence for IPV6 if `pod_name` and `loopback_ip_pools` are defined.
              # Loopback is not created unless `loopback_ip_range`, `loopback_ipv6_range` or `loopback_ip_pools` are set.
