...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "aaa_settings.tacacs.servers.[].groups.[]") | String |  |  | Pattern: `^(?:t[^a].*|ta[^c].*|tac[^a].*|taca[^c].*|tacac[^s].*|tacacs[^+].*|tacacs\+.+|[^t].*)$` |  |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "aaa_settings.radius.servers.[].groups.[]") | String |  |  | Pattern: `^(?:r[^a].+|ra[^d].+|rad[^i].+|radi[^u].+|radiu[^s].+|radius.+|[^r].*)$` |  |
