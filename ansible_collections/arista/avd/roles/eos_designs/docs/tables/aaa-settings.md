...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "aaa_settings.tacacs.servers.[].groups.[]") | String |  |  | Pattern: `^(?:tacacs\+.+|tacacs[^+].|tacac[^s].|taca[^c].|tac[^a].|ta[^c].|t[^a].|[^t].*|t|ta|tac|taca|tacac|tacacs?)$` |  |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "aaa_settings.radius.servers.[].groups.[]") | String |  |  | Pattern: `^(?:radius.+|radiu[^s].|radi[^u].|rad[^i].|ra[^d].|r[^a].|[^r].*|r|ra|rad|radi|radiu)$` |  |
