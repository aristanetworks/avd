...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tls</samp>](## "aaa_settings.radius.servers.[].tls") | Dictionary |  |  |  | When TLS is configured, `key` and `cleartext_key` are ignored.<br>For proper functionality to render TLS settings on the<br>server group member entry, set `avd_design_future.fix_radius_server_group_tls: true`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;default</samp>](## "aaa_settings.authentication.login.default") | String |  |  |  | Login authentication method(s) as a string.<br>Examples:<br>- "group tacacs+ local"<br>- "group MYGROUP none"<br>- "group radius group MYGROUP local"<br>- "group ldap"<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;dot1x</samp>](## "aaa_settings.authentication.dot1x") <span style="color:red">removed</span> | Dictionary |  |  |  | <span style="color:red">This key was removed. Support was removed in AVD version 6.0.0. Use <samp>dot1x_settings.authentication</samp> instead.</span> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;dynamic</samp>](## "aaa_settings.authorization.dynamic") <span style="color:red">removed</span> | Dictionary |  |  |  | <span style="color:red">This key was removed. Support was removed in AVD version 6.0.0. Use <samp>dot1x_settings.dynamic_authorization</samp> instead.</span> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;dot1x</samp>](## "aaa_settings.accounting.dot1x") <span style="color:red">removed</span> | Dictionary |  |  |  | <span style="color:red">This key was removed. Support was removed in AVD version 6.0.0. Use <samp>dot1x_settings.accounting</samp> instead.</span> |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;default</samp>](## "aaa_settings.accounting.dot1x.default") | Dictionary |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type</samp>](## "aaa_settings.accounting.dot1x.default.type") <span style="color:red">removed</span> | String |  |  | Valid Values:<br>- <code>start-stop</code><br>- <code>stop-only</code> | <span style="color:red">This key was removed. Support was removed in AVD version 6.0.0. Use <samp>dot1x_settings.accounting.mode</samp> instead.</span> |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;methods</samp>](## "aaa_settings.accounting.dot1x.default.methods") | List, items: Dictionary |  |  | Min Length: 1 |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;method</samp>](## "aaa_settings.accounting.dot1x.default.methods.[].method") <span style="color:red">removed</span> | String | Required |  | Valid Values:<br>- <code>logging</code><br>- <code>group</code> | <span style="color:red">This key was removed. Support was removed in AVD version 6.0.0. Use <samp>dot1x_settings.accounting.syslog or dot1x_settings.accounting.radius_groups</samp> instead.</span> |
      ...
      radius:
        servers:
          ...
          - host: <str; required>
            ...
            # For proper functionality to render TLS settings on the
            # server group member entry, set `avd_design_future.fix_radius_server_group_tls: true`.
            tls:
