    ...
    <network_services_keys.name>:
      ...
      - name: <str; required; unique>
        ...
        evpn_l2_multicast:
          ...
          # Always configure `redistribute igmp` under BGP for all SVIs within the Tenant.
          ...
          # Configuring `redistribute igmp` when both L2 and L3 EVPN Mutlicast is enabled will take up additional control-plane and data-plane resources,
