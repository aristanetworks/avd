    ...
    <network_services_keys.name>:
      ...
      - name: <str; required; unique>
        ...
        igmp_snooping_querier:
          ...
          # - `vrf_router_id` will configure the VRF router ID address according to `vrf.bgp.router_id`.
