...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_l2_multicast_flood_group_ipv4_pool</samp>](## "<network_services_keys.name>.[].evpn_l2_multicast.underlay_l2_multicast_flood_group_ipv4_pool") | String |  |  | Format: ipv4_pool | Comma separated list of prefixes (IPv4 address/Mask) or ranges (IPv4_address-IPv4_address). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;underlay_l2_multicast_flood_group_ipv4_pool_offset</samp>](## "<network_services_keys.name>.[].evpn_l2_multicast.underlay_l2_multicast_flood_group_ipv4_pool_offset") | Integer |  | `0` |  |  |
    ...
    <network_services_keys.name>:
      ...
      - name: <str; required; unique>
        ...
        evpn_l2_multicast:
          ...
          # Comma separated list of prefixes (IPv4 address/Mask) or ranges (IPv4_address-IPv4_address).
          underlay_l2_multicast_flood_group_ipv4_pool: <str>
          underlay_l2_multicast_flood_group_ipv4_pool_offset: <int; default=0>
