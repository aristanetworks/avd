...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;dhcp_server_interfaces</samp>](## "address_locking_settings.dhcp_server_interfaces") | List, items: String |  |  |  | The list of interfaces connected to the DHCP server. |
