...
!!! note
    ...
    This limitation will be addressed in AVD once CloudVision 2025.2.1 is released. Post this - automatic registration of new devices by `cv_deploy` in CloudVision `Inventory and Topology` studio will automatically include `Model` and `Interfaces`.
