...
- `["!" conversion]`: Convert string to supported methods. Note the regular Python conversions "!r", "!s", "!a" have been removed.
  ...
  - `"!c"`: convert network interfaces to _compact_ names. e.g. Port-channel20 to Po20. The interface types ethernet, port-channel, loopback, tunnel, vlan are supported for this conversion. For the other strings, returns the same string.
