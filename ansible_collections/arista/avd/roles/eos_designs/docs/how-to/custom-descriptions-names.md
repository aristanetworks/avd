...
- `["!" conversion]`: Convert string to supported methods. Note the regular Python conversions "!r", "!s", "!a" have been removed.
  ...
  - `"!c"`: convert network interfaces to shorter names. e.g. Port-channel20 to Po20. For the other strings, this conversion gives no result. The interface types ethernet, port-channel, loopback, tunnel, vlan are supported for this conversion.
