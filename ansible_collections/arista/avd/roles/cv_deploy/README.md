...
# Only applicable if cv_workspace_requested_state is not set.
...
# Only applicable if cv_workspace_requested_state is set to 'submitted' or cv_workspace_requested_state is not set and cv_submit_workspace is true.
...
# Only applicable if both conditions below are met:
# - cv_workspace_requested_state is set to "submitted" or cv_workspace_requested_state is not set and cv_submit_workspace is true
# - cv_change_control_requested_state is not set
...
# Set the ID of the created Workspace. If there is already a workspace with the same ID, it must be in the 'pending' state.
# cv_workspace_id: <str>

# Set the requested state for the Workspace. Takes precedence over cv_submit_workspace.
...
# Set the requested state of the created Change Control. Takes precedence over cv_run_change_control.
