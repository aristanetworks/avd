...
!!! warning
    Deprecation Warning!
    The role 'arista.avd.eos_config_deploy_cvp' has been deprecated and will be removed in AVD version 6.0.0.
...
- **`build`**: Generate Arista AVD configuration for EOS devices (structure_configs / configs / documentation) and CloudVision inputs.
