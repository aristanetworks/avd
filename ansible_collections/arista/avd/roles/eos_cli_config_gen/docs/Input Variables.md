...
| [<samp>&nbsp;&nbsp;&nbsp;&nbsp;ipv6_address_virtual</samp>](## "vlan_interfaces.[].ipv6_address_virtual") <span style="color:red">removed</span> | String |  |  |  | IPv6_address/Mask<br>If both "ipv6_address_virtual" and "ipv6_address_virtuals" are set, all addresses will be configured<br><span style="color:red">This key was removed. Support was removed in AVD v5.0.0. Use <samp>ipv6_address_virtuals</samp> instead. See [here](http://avd.sh) for details.</span> |
