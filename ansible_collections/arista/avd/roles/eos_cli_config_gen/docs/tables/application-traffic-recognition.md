...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dscp_ranges</samp>](## "application_traffic_recognition.applications.ipv4_applications.[].dscp_ranges") | List, items: String |  |  |  | Accept DSCP value(s) or range(s).<br>DSCP values can be between 0 and 63.<br>Other valid values are cs0 to cs7, af11-13, af21-23, af31-33, af41-af43 and ef. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "application_traffic_recognition.applications.ipv4_applications.[].dscp_ranges.[]") | String |  |  |  | DSCP value or range. |
