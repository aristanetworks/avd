    ...
    errdisable:
      detect:
        causes:
            ...
            # The list of supported causes is built dynamically from Sysdb and
            # depends on both the EOS version and the hardware platform. Your device
            # may not support all causes shown here.
      ...
      recovery:
        causes:
            ...
            # Available recovery causes are generated dynamically from Sysdb and
            # vary by EOS version and hardware platform. Your device may not support
            # all causes listed.
