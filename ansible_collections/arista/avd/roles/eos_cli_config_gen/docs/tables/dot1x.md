...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;delimiter</samp>](## "dot1x.mac_based_auth_radius.delimiter") | String | Required |  | Valid Values:<br>- <code>colon</code><br>- <code>hyphen</code><br>- <code>none</code><br>- <code>period</code> | Delimiter to use in MAC address string. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;mac_string_letter_case</samp>](## "dot1x.mac_based_auth_radius.mac_string_letter_case") | String | Required |  | Valid Values:<br>- <code>lowercase</code><br>- <code>uppercase</code> | MAC address string in lowercase/uppercase. |
...
=== "YAML"
    ...
    dot1x:
      ...
      mac_based_auth_radius:
        ...
        mac_string_letter_case: <str; "lowercase" | "uppercase"; required>
      radius_av_pair:
        service_type: <bool>
