...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;multi_topology</samp>](## "router_isis.address_family_ipv6.multi_topology") | Boolean |  |  |  | Enable ISIS multi-topology for ipv6 address family. This is needed for ipv6 adjacencies to form on ISIS interfaces where there is no ipv4 address. |
...
=== "YAML"
    ...
    router_isis:
      ...
      address_family_ipv6:
        ...
        # Enable ISIS multi-topology for ipv6 address family. This is needed for ipv6 adjacencies to form on ISIS interfaces where there is no ipv4 address.
        multi_topology: <bool>
        fast_reroute_ti_lfa:
          mode: <str; "link-protection" | "node-protection">
