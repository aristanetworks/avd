...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&lt;str&gt;</samp>](## "loopback_interfaces.[].ipv6_addresses.[]") | String |  |  |  | IPv6_address/Mask.<br>This option is mutually exclusive with `ipv6_address_auto_config` and takes precedence if both are defined. |
