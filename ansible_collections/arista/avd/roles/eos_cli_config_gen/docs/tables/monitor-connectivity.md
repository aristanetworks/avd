...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;description</samp>](## "monitor_connectivity.hosts.[].description") | String |  |  |  | Description of format<br>```<br>description<br><description><br>``` |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;description_new</samp>](## "monitor_connectivity.hosts.[].description_new") | String |  |  |  | Description of format `description <description> `. |
