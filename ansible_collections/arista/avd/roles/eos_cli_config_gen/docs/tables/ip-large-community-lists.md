...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;entries</samp>](## "ip_large_community_lists.[].entries") | List, items: Dictionary | Required |  | Min Length: 1 | Large communities and regexp entries MUST not be configured in the same entry.<br> |
