...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;hold_ptp_time</samp>](## "ptp.hold_ptp_time") | Integer |  |  | Min: 0<br>Max: 172000 | The length of time that PTP will remain in hold-down on the internal oscillator if the connection to the GM is lost.<br>If a new GM is not elected before the expiry of the hold-down time, the clock will revert to free-running. |
