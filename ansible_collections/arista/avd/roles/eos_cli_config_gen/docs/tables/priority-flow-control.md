...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;action</samp>](## "priority_flow_control.watchdog.action") | String |  |  | Valid Values:<br>- <code>drop</code><br>- <code>errdisable</code><br>- <code>notify-only</code> | Action on stuck queue.<br> |
...
=== "YAML"
    ...
    priority_flow_control:
      ...
      watchdog:
        ...
        action: <str; "drop" | "errdisable" | "notify-only">
