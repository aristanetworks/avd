...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;source_interface</samp>](## "ip_ftp_client.source_interface") | String |  |  |  | Define `source_interface` for VRF default. |
    | [<samp>&nbsp;&nbsp;vrfs</samp>](## "ip_ftp_client.vrfs") | List, items: Dictionary |  |  |  | Define `source interfaces` for any VRF other than default. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;name</samp>](## "ip_ftp_client.vrfs.[].name") | String | Required, Unique |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;source_interface</samp>](## "ip_ftp_client.vrfs.[].source_interface") | String | Required |  |  |  |
