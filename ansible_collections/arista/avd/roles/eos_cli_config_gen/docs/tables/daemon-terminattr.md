...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cvaddrs</samp>](## "daemon_terminattr.clusters.[].cvaddrs") | List, items: String | Required |  |  | Streaming address(es) for CloudVision cluster.<br>- TCP 9910 is used for CV on-prem<br>- TCP 443 is used for CV as a Service<br> |
