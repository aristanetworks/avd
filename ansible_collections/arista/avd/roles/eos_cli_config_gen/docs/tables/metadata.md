...
=== "Table"
    ...
    | [<samp>serial_number</samp>](## "serial_number") | String |  |  |  | Serial Number of the device.<br>Used only for documentation and deployment purposes. It is used by the 'cv_deploy' roles. |
...
=== "YAML"
    ...
    # Used only for documentation and deployment purposes. It is used by the 'cv_deploy' roles.
    serial_number: <str>
    ```
