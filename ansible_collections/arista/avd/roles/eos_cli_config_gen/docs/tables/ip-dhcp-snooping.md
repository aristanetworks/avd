...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;circuit_id_type_format</samp>](## "ip_dhcp_snooping.information_option.circuit_id_type_format") | String |  |  | Valid Values:<br>- <code>%h:%p</code><br>- <code>%p:%v</code> | - "%h:%p" Hostname and interface name or<br>- "%p:%v" Interface name and VLAN ID |
...
=== "YAML"
    ...
    ip_dhcp_snooping:
      ...
      information_option:
        ...
        circuit_id_type_format: <str; "%h:%p" | "%p:%v">
