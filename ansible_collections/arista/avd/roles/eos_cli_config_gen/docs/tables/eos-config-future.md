...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;new_ip_routing_vrfs_separator</samp>](## "eos_config_future.new_ip_routing_vrfs_separator") | Boolean |  | `False` |  | Always render a '!' before the '(no) ip routing command' section. |
