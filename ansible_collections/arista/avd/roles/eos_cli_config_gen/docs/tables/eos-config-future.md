...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;always_render_ipv6_unicast_routing_vrfs_separator</samp>](## "eos_config_future.always_render_ipv6_unicast_routing_vrfs_separator") | Boolean |  | `False` |  | Available from AVD 6.3.0.<br>Always render a '!' before the '(no) ipv6 unicast-routing vrf' command section.<br>Without this the '!' is missing when first VRF is not configured for ipv6_routing. |
