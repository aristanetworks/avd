...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pattern</samp>](## "load_balance.policies.sand_profiles.[].fields.udp.match.pattern") | String | Required |  |  | Bit pattern to match in the UDP payload. The value must match the number of bits defined in `payload_bits`.<br>The valid range is from 0 to (2^N - 1), where N is the number of bits selected in `payload_bits`.<br>Matching is supported only on up to 16 bits of the UDP payload.<br>Supports both integer and hexadecimal values for this field.<br>Integer inputs will be internally converted to their hexadecimal representation by EOS. |
            ...
            fields:
              ...
              udp:
                ...
                match:
                  ...
                  # Supports both integer and hexadecimal values for this field.
                  # Integer inputs will be internally converted to their hexadecimal representation by EOS.
