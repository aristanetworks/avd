...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;shape_rate_percent_adaptive</samp>](## "qos.tx_queue.shape_rate_percent_adaptive") | Boolean |  |  |  | Use the parent available bandwidth for txQueue percentage-based allocation. |
...
=== "YAML"
    ...
    qos:
      ...
      tx_queue:
        ...
        # Use the parent available bandwidth for txQueue percentage-based allocation.
