...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;-&nbsp;name</samp>](## "dynamic_prefix_lists.[].name") | String | Required, Unique |  |  | Dynamic prefix-list name. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;match_map</samp>](## "dynamic_prefix_lists.[].match_map") | String | Required |  |  | Route-map name. |
