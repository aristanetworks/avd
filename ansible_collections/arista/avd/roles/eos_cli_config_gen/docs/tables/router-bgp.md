...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;hrw</samp>](## "router_bgp.vrfs.[].evpn_multicast_gateway_dr_election_algorithm.hrw") | Boolean |  |  |  | Default selection based on highest random weight. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;modulus</samp>](## "router_bgp.vrfs.[].evpn_multicast_gateway_dr_election_algorithm.modulus") | Boolean |  |  |  | Selection based on VLAN ID modulo number of candidates. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;preference</samp>](## "router_bgp.vrfs.[].evpn_multicast_gateway_dr_election_algorithm.preference") | Integer |  |  | Min: 0<br>Max: 65535 | Selection based on a configured preference value. |
