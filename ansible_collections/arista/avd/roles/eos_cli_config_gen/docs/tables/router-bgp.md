...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enforce_first_as</samp>](## "router_bgp.peer_groups.[].enforce_first_as") | Boolean |  |  |  | Enforce the first AS in eBGP updates. EOS default is true. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes</samp>](## "router_bgp.peer_groups.[].maximum_accepted_routes") | Integer |  |  | Min: 0<br>Max: 4294967294 | Maximum number of accepted routes (0 means unlimited). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes_warning_limit</samp>](## "router_bgp.peer_groups.[].maximum_accepted_routes_warning_limit") | String |  |  |  | Maximum number of routes accepted after which a warning is issued (0 means never warn) or<br>Percentage of maximum number of accepted routes at which to warn ("<1-100> percent").<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enforce_first_as</samp>](## "router_bgp.neighbors.[].enforce_first_as") | Boolean |  |  |  | Enforce the first AS in eBGP updates. EOS default is true. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes</samp>](## "router_bgp.neighbors.[].maximum_accepted_routes") | Integer |  |  | Min: 0<br>Max: 4294967294 | Maximum number of accepted routes (0 means unlimited). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes_warning_limit</samp>](## "router_bgp.neighbors.[].maximum_accepted_routes_warning_limit") | String |  |  |  | Maximum number of routes accepted after which a warning is issued (0 means never warn) or<br>Percentage of maximum number of accepted routes at which to warn ("<1-100> percent").<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes</samp>](## "router_bgp.address_family_ipv4.peer_groups.[].maximum_accepted_routes") | Integer |  |  | Min: 0<br>Max: 4294967294 | Maximum number of accepted routes (0 means unlimited). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes_warning_limit</samp>](## "router_bgp.address_family_ipv4.peer_groups.[].maximum_accepted_routes_warning_limit") | String |  |  |  | Maximum number of routes accepted after which a warning is issued (0 means never warn) or<br>Percentage of maximum number of accepted routes at which to warn ("<1-100> percent").<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes</samp>](## "router_bgp.address_family_ipv4.neighbors.[].maximum_accepted_routes") | Integer |  |  | Min: 0<br>Max: 4294967294 | Maximum number of accepted routes (0 means unlimited). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes_warning_limit</samp>](## "router_bgp.address_family_ipv4.neighbors.[].maximum_accepted_routes_warning_limit") | String |  |  |  | Maximum number of routes accepted after which a warning is issued (0 means never warn) or<br>Percentage of maximum number of accepted routes at which to warn ("<1-100> percent").<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes</samp>](## "router_bgp.address_family_ipv6.peer_groups.[].maximum_accepted_routes") | Integer |  |  | Min: 0<br>Max: 4294967294 | Maximum number of accepted routes (0 means unlimited). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes_warning_limit</samp>](## "router_bgp.address_family_ipv6.peer_groups.[].maximum_accepted_routes_warning_limit") | String |  |  |  | Maximum number of routes accepted after which a warning is issued (0 means never warn) or<br>Percentage of maximum number of accepted routes at which to warn ("<1-100> percent").<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;default_originate</samp>](## "router_bgp.address_family_ipv6.neighbors.[].default_originate") | Dictionary |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enabled</samp>](## "router_bgp.address_family_ipv6.neighbors.[].default_originate.enabled") | Boolean |  |  |  |  |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;always</samp>](## "router_bgp.address_family_ipv6.neighbors.[].default_originate.always") | Boolean |  |  |  | Always advertise a default route to this peer. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;route_map</samp>](## "router_bgp.address_family_ipv6.neighbors.[].default_originate.route_map") | String |  |  |  | Route-map name. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes</samp>](## "router_bgp.address_family_ipv6.neighbors.[].maximum_accepted_routes") | Integer |  |  | Min: 0<br>Max: 4294967294 | Maximum number of accepted routes (0 means unlimited). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes_warning_limit</samp>](## "router_bgp.address_family_ipv6.neighbors.[].maximum_accepted_routes_warning_limit") | String |  |  |  | Maximum number of routes accepted after which a warning is issued (0 means never warn) or<br>Percentage of maximum number of accepted routes at which to warn ("<1-100> percent").<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;no_graceful_restart</samp>](## "router_bgp.vrfs.[].no_graceful_restart") | Boolean |  |  |  | Disables graceful-restart for this VRF. Mutually exclusive with `graceful_restart`. `graceful_restart` takes precedence.<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes</samp>](## "router_bgp.vrfs.[].neighbors.[].maximum_accepted_routes") | Integer |  |  | Min: 0<br>Max: 4294967294 | Maximum number of accepted routes (0 means unlimited). |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maximum_accepted_routes_warning_limit</samp>](## "router_bgp.vrfs.[].neighbors.[].maximum_accepted_routes_warning_limit") | String |  |  |  | Maximum number of routes accepted after which a warning is issued (0 means never warn) or<br>Percentage of maximum number of accepted routes at which to warn ("<1-100> percent").<br> |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;enforce_first_as</samp>](## "router_bgp.vrfs.[].neighbors.[].enforce_first_as") | Boolean |  |  |  | Enforce the first AS in eBGP updates. EOS default is true. |
    ...
    router_bgp:
      ...
      vrfs:
        ...
        - name: <str; required; unique>
          ...
          # Disables graceful-restart for this VRF. Mutually exclusive with `graceful_restart`. `graceful_restart` takes precedence.
          no_graceful_restart: <bool>
          networks:
