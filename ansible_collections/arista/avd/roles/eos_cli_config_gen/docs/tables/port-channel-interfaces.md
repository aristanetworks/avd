...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;storm_control_discards</samp>](## "port_channel_interfaces.[].logging.event.storm_control_discards") | Boolean |  |  |  | Discards due to storm-control.<br>Note: `logging event storm-control discards use-global` is the default and it does not show up in the config.<br> |
      ...
      - name: <str; required; unique>
        ...
        logging:
          event:
            ...
            # Note: `logging event storm-control discards use-global` is the default and it does not show up in the config.
