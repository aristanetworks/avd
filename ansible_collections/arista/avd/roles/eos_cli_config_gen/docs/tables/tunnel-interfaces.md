...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;source_interface</samp>](## "tunnel_interfaces.[].source_interface") | String |  |  |  | Tunnel Source Interface Name.<br>Mutually exclusive with source_ipaddress, if both are defined source_interface takes precedence. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;source_ipaddress</samp>](## "tunnel_interfaces.[].source_ipaddress") | String |  |  |  | Tunnel Source IPv4/IPv6 address.<br>Mutually exclusive with source_interface, if both are defined source_interface takes precedence. |
...
=== "YAML"
    ...
    tunnel_interfaces:
      ...
      - name: <str; required; unique>
        ...
        # Mutually exclusive with source_ipaddress, if both are defined source_interface takes precedence.
