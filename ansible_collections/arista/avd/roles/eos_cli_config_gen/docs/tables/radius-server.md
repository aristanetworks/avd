...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;hosts</samp>](## "radius_server.hosts") | List, items: Dictionary |  |  |  | Hosts configuration with default vrf. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;host</samp>](## "radius_server.hosts.[].host") | String | Required |  |  | -> Host IP address or name. Multiple server with the same host can be configured for TLS and no TLS. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;name</samp>](## "radius_server.vrfs.[].name") | String | Required, Unique |  |  | VRF name. |
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;servers</samp>](## "radius_server.vrfs.[].servers") | List, items: Dictionary |  |  |  | Hosts configuration with default vrf. |
