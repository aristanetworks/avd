...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;subscribe_rcf</samp>](## "router_general.vrfs.[].leak_routes.[].subscribe_rcf") | String |  |  |  | RCF Policy.<br>Mutually exclusive with `subscribe_policy`, if both are defined `subscribe_policy` takes precedence. |
