...
The AVD Schema format is a proprietary schema, inspired from JSON Shema, Ansible Argument Specificion and Arista
...
This also means that a poorly written schema could potentially have conflicting schema options, which in the end may not allow
