...
See the full data model in the [documentation](../../roles/eos_designs/docs/input-variables.html#bgp-settings)
...
See the full data model in the [documentation](../../roles/eos_cli_config_gen/docs/input-variables.html#ip-name-servers)
