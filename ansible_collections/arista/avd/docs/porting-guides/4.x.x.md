...
### New model for `hardware counters features`

The new data model allows to configure the list of hardware counters feature
...
The available values of the different keys 'direction', 'address_type', ...
are feature and hardware dependent and this model DOES NOT validate that the
combinations are valid. For the sake of flexibility, it is the responsability
of the user of this data model to make sure that the rendered CLI is accepted
