...
In AVD 4.0.0, the router-isis address-family configuration and documentation were generated independently of the `router_isis.address_family_ipv4/6.enabled` key.
