...
As of avd 5.0.0 `monitor_sessions` configuration will be generated if either `monitor_sessions.sources` or `monitor_sessions.destinations` are not defined. To revert this behavior update your inventory to remove the configuration.
