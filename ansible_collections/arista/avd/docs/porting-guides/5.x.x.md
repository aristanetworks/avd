...
Added support for filtering of additional_paths using prefix-lists in `router_bgp.address_family_evpn.vrfs[].address_family_ipv4.bgp.additional_paths` and `router_bgp.address_family_evpn.vrfs[].address_family_ipv6.bgp.additional_paths`.
