...
| <node_type_key>[].nodes[].inband_management_subnet | <node_type_key>[].nodes[].defaults.inband_mgmt_subnet |
| <node_type_key>[].nodes[].inband_management_vlan | <node_type_key>[].nodes[].defaults.inband_mgmt_vlan |
