...
### Removed `redistribute igmp` from BGP VLAN configuration belonging to a VRF with EVPN Multicast
...
### The base class for custom IP addressing `AvdIpAddressing` was moved
