...
| node_type.defaults.inband_management_subnet | node_type.defaults.inband_mgmt_subnet |
| node_type.defaults.inband_management_vlan | node_type.defaults.inband_mgmt_vlan |
