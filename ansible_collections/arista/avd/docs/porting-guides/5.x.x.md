...
With AVD version 5.0.0 the encapsulation used by default for EVPN iBGP peering for WAN router is `path-selection`. Before AVD 5.x.x only the default encapsulation (`vxlan`) was supported.
