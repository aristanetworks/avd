...
In AVD 5.0.0 it is also possible to control the port-channel description separately by setting`description` key under `port_channel`. It will replace the full port-channel interface description.
