...
In AVD 4.0.0, the default MTU for Dps1 and WAN HA interfaces was `9214`.
...
The precedence for setting MTU on point-to-point uplink interfaces is now as follows:

1. `<node_type>.uplink_mtu`
2. `platform_settings.p2p_uplinks_mtu`
3. `p2p_uplinks_mtu`
