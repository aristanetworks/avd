...
- AVD no longer requires an upper bound on the version of the Python package `jsonschema>=4.5.1`.<br>
  The latest version can be installed with `pip install "jsonschema>=4.5.1" --upgrade`.
