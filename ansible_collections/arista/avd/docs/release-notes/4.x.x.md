...
#### Improved hardware_counders.features data model

The `hardware_counders.features` model has been improved to allow more options.

See details in the [Porting guide for AVD 4.x.x](../porting-guides/4.x.x.md#hardware_counders.features).
...
- Fix(eos_designs) - Fix issue with hardware_counders python code by @gmuloc in https://github.com/aristanetworks/avd/pull/2447
...
- Refactor(eos_cli_config_gen) - Add guards for missing name for hardware_counders legacy syntax by @gmuloc in https://github.com/aristanetworks/avd/pull/2741
