...
- AVD now requires a newer minimum version of `ansible-core` version 2.15
...
- AVD now requires a newer minimum version of the Python package `md-toc>=8.1.0`.<br>
  The latest version can be installed with `pip install "md-toc>=8.1.0"--upgrade`.
