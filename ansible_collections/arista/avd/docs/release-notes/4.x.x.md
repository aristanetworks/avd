...
#### All eos_designs and eos_cli_config_gen variables are enforced by a schema

In AVD 4.0.0, all eos_designs and eos_cli_config_gen keys are enforced by a schema.
...
The change has been incorporated into eos_designs, no action is necessary to retain the same functionality.
...
- Feat(eos_designs,eos_cli_config_gen)! - bgp graceful-restart by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2842
...
- Fix(eos_cli_config_gen) - Add convert_types to router ospf area id schema by @danieltudares in https://github.com/aristanetworks/ansible-avd/pull/2391
...
- Fix(eos_cli_config_gen) - Update Schema for OSPF maximum paths from 32 to 128 by @RyanM-Arista in https://github.com/aristanetworks/ansible-avd/pull/2424
- Fix(eos_cli_config_gen) - Correct schema min values for terminal length/width by @emilarista in https://github.com/aristanetworks/ansible-avd/pull/2481
...
- Fix(eos_cli_config_gen) - Relax schema for maintenance unit profile by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2492
- Fix(eos_cli_config_gen) - Add variable protection for router_bgp.as in doc template by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2503
- Fix(eos_cli_config_gen) - Update schema for logging by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2553
- Fix(eos_cli_config_gen) - Update schema for storm_control levels to support int or float by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2562
- Fix(eos_cli_config_gen) - min value on local_users privilege by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2617
...
- Fix(eos_designs) - Replace sorted with natural_sort in overlay/utils.py by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2374
...
- Fix(eos_designs) - Ensure proper formatting of raised errors by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2578
...
- Fix(eos_designs) - Add back dir creation wrongly removed by #2015 by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2622
...
- Fix(eos_designs) - Change IP addressing templates from ansible netcommon to ansible.utils by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2677
...
- Fix(eos_designs) - Fix and test custom python modules for ip addressing and interface descriptions by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2664
...
- Fix(eos_designs) - Add mlag_ibgp_origin_incomplete in eos_designs schema by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2716
...
- Fix(eos_designs) - connected endpoints interface mode valid values by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2758
...
- Fix(eos_designs) - Improve error message for missing device facts by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2813
...
- Fix(eos_designs) - Correct schema descriptions for raw_eos_cli and structured_config under network services by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2898
...
- Fix(eos_designs) - Schema validation in eos_designs_facts by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2948
...
- Fix(eos_designs) - Fix schema for storm_control and endpoint_ports under adapters by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2967

#### Fixed issues in both eos_designs and eos_cli_config_gen

- Fix(eos_cli_config_gen,eos_designs) - Update schemas missing `items` and remove unused keys by @chetryan in https://github.com/aristanetworks/ansible-avd/pull/2892
- Fix(eos_designs,eos_cli_config_gen) - Update schema keys for VRFs to accept numeric VRF names by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2979

#### Other Fixed issues

- Fix - Logging buffered default level not required by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2364
- Fix(plugins) - Fix bgp_utils for ansible-test sanity and update requirements by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2401
...
- Fix - Formatting to pass latest galaxy-importer and ansible-lint rules by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2445
- Fix(plugins) - update verify_requirements to use a color that is supported for logging by @chetryan in https://github.com/aristanetworks/ansible-avd/pull/2638
- Fix(plugins) - Handle git not found for verify_requirements by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2667
...
- Fix(plugins) - Ensure proper headings in schema generated docs by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2771
- Fix(plugins) - Inheritance of schema documentation options by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2861
- Fix(plugins) - Fix minor schema tooling issues by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2870

#### Documentation

- Doc - Add release notes for 3.8.0 by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2378
- Doc - Changelog for release v3.8.0 by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2414
- Doc - Fix typo in plugins README.md by @pvinci-arista in https://github.com/aristanetworks/ansible-avd/pull/2495
...
- Doc(eos_cli_config_gen) - Update site navigation with new schemas by @JulioPDX in https://github.com/aristanetworks/ansible-avd/pull/2427
- Doc - release notes 3.8.2 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2542
- Doc - release notes 3.8.3 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2588
...
- Doc(plugins) - Fix quotes in BGP password example by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2597
- Doc(plugins) - Fix plugin name in BGP example by @JulioPDX in https://github.com/aristanetworks/ansible-avd/pull/2601
...
- Doc - release notes v3.8.4 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2649
- Doc - Navigation fix and bump mkdocs-material version by @JulioPDX in https://github.com/aristanetworks/ansible-avd/pull/2536
- Doc - Fix typo in batch_template documentation by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2668
- Doc - Release notes v3.8.5 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2736
- Doc - Pinned mkdocs-material version and updated make by @JulioPDX in https://github.com/aristanetworks/ansible-avd/pull/2788
- Doc - Fix typo in custom structured configuration documentation example by @philippebureau in https://github.com/aristanetworks/ansible-avd/pull/2807
- Doc - Release notes v3.8.6 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2827
- Doc - Gather role documentation in a single file per role by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2873
- Doc - Various documentation fixes by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2877
...
- Doc - Update l3ls dual dc example data model to 4.0.0 by @Vibhu-gslab in https://github.com/aristanetworks/ansible-avd/pull/2919
- Doc - Update single-dc-l3ls example data model to 4.0.0 by @Vibhu-gslab in https://github.com/aristanetworks/ansible-avd/pull/2914
- Doc - Update campus-fabric example data model to AVD-4.0.0 by @Shivani-chourasiya in https://github.com/aristanetworks/ansible-avd/pull/2913
- Doc - Update l2ls example data model to 4.0.0 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2908
- Doc - Minor updates to campus readme by @JulioPDX in https://github.com/aristanetworks/ansible-avd/pull/2943
- Doc - Updated l2ls example readme with new data models by @JulioPDX in https://github.com/aristanetworks/ansible-avd/pull/2944
- Doc(eos_designs) - Update documentation layout by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2960
...
- Doc - Porting guide updates by @JulioPDX in https://github.com/aristanetworks/ansible-avd/pull/2945
...
- Doc - Grammar corrections on contribution guides by @JulioPDX in https://github.com/aristanetworks/ansible-avd/pull/2973
- Doc - Add details on data model changes to RN and porting-guide by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2977
- Doc - Adding mike version provider to requirements and mkdocs by @JulioPDX in https://github.com/aristanetworks/ansible-avd/pull/2971
...
- Feat(eos_designs) - Schema for default interfaces by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2512
...
- Feat(eos_designs) - Schema for node_type by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2517
- Feat(eos_designs) - Schema for platforms by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2519
- Feat(eos_designs) - Schema for CVP by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2509
- Feat(eos_designs) - Schema for evpn by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2514
- Feat(eos_designs) - Add support for serial_number by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2645
- Feat(eos_designs) - Schema for isis by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2515
- Feat(eos_designs) - Schema for underlay by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2520
...
- Feat(eos_designs) - Schema for overlay by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2518
- Feat(eos_designs) - Schema for routing by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2507
- Feat(eos_designs) - Schema for topology by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2510
- Feat(eos_designs) - Schema for connected endpoints by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2505
...
- Feat(eos_designs) - Schema for l3_edge and core_interfaces by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2516
...
- Feat(eos_designs) - Schema for management by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2513
- Feat(eos_designs) - Schema for network services by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2506
...
- Feat(eos_designs) - Add schema for ptp_profiles by @nielsjlarsen in https://github.com/aristanetworks/ansible-avd/pull/2847
- Feat(eos_designs) - Add hardware_counters schema by @chetryan in https://github.com/aristanetworks/ansible-avd/pull/2856
- Feat(eos_designs) - Adding schemas for eos_designs missing keys by @Vibhu-gslab in https://github.com/aristanetworks/ansible-avd/pull/2862
- Feat(eos_designs) - Add `is_deployed` & `mgmt_interface_description` to schema by @chetryan in https://github.com/aristanetworks/ansible-avd/pull/2858
...
- Feat(eos_designs) - Schema for custom structured configuration by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2508
- Feat(eos_designs) - Add schema for queue_monitor_length by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2897

#### Other new features and enhancements

- Feat(plugins) - Make 'dest' optional on 'validate_and_template' by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2423
...
- Feat(plugins) - Support for importlib.metadata multi dist detection by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2614
...
- Feat(plugins) - Schema support for 'convert_to_lower_case' by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2688
...
- Feat(plugins) - Add sections in schema-based docs by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2969

#### Other Changes

- Bump - Update galaxy.yml to 4.0.0-dev0 by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2361
- Cut(eos_designs) - Remove unused overlay jinja2 templates by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2363
- Cut - Remove upgrade tools for 2.x to 3.0 upgrade by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2368
- Refactor(eos_designs) - Use natural_sort instead of sorted everywhere by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2384
- Bump - Update ansible-core requirement to ">=2.12.6, <2.15, !=2.13.0" by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2400
- Refactor - Input data conversion to support conversion messages by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2349
- Bump - Release notes for v3.8.1 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2462
- Revert(eos_validate_state) - Revert removal of error=ignore on lookups by @philippebureau in https://github.com/aristanetworks/ansible-avd/pull/2468
- Bump - Pre-release v4.0.0-dev1 by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2471
- Refactor(eos_designs) - Auto-convert eos_designs output according to schema by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2381
- Refactor(plugins) - Improvements of schema tools preparing for eos_designs schemas by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2437
- Bump - Pre-release v4.0.0-dev2 by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2487
...
- Bump - Pre-release v4.0.0-dev3 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2524
- Refactor(plugins) - Add ability raise on missing dependencies in validator by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2501
- Bump - Pre-release v4.0.0-dev4 by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2546
- Refactor(eos_designs) - network_services/ip_igmp_snooping python_module as per eos_cli_config_gen by @Shivani-chourasiya in https://github.com/aristanetworks/ansible-avd/pull/2554
- Refactor(eos_designs) - schema auto documentation template by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2571
...
- Bump - Pre-release v4.0.0-dev5 by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2574
- Refactor(eos_designs) - route_maps, vrfs, ip_ext_community_lists and struct_cfgs python_module as per eos_cli_config_gen by @Shivani-chourasiya in https://github.com/aristanetworks/ansible-avd/pull/2567
- Refactor(eos_designs) - prefix_lists python_module as per eos_cli_config_gen by @Vibhu-gslab in https://github.com/aristanetworks/ansible-avd/pull/2555
- Bump - Cap ansible-lint to <6.14 by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2595
- Refactor(eos_designs) - router_ospf python_module as per eos_cli_config_gen by @Vibhu-gslab in https://github.com/aristanetworks/ansible-avd/pull/2559
- Refactor(eos_designs) - vlans, virtual_source_nat_vrfs python_modules as per eos_cli_config_gen by @mayurgs34 in https://github.com/aristanetworks/ansible-avd/pull/2577
- Refactor(eos_designs) - vxlan_interface, management_interfaces python_modules as per eos_cli_config_gen by @Vibhu-gslab in https://github.com/aristanetworks/ansible-avd/pull/2584
- Refactor(eos_designs) - vlan_interfaces python_module as per eos_cli_config_gen by @Shivani-chourasiya in https://github.com/aristanetworks/ansible-avd/pull/2592
- Refactor(eos_designs) - loopback_interfaces python_module as per eos_ci_config_gen by @Shivani-chourasiya in https://github.com/aristanetworks/ansible-avd/pull/2598
- Bump - Pre-release v4.0.0-dev6 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2602
- Refactor(eos_designs) - port_channel_interfaces python_module as per eos_cli_config_gen by @Shivani-chourasiya in https://github.com/aristanetworks/ansible-avd/pull/2609
- Refactor(eos_designs) - base python_module as per eos_cli_config_gen by @mayurgs34 in https://github.com/aristanetworks/ansible-avd/pull/2624
...
- Bump - Pre-release v4.0.0-dev7 by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2637
- Refactor(eos_designs) - Improve code reuse in parsing of connected endpoints by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2633
- Refactor(plugins) - Optimize loading of schemas by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2575
- Bump - Pre-release v4.0.0-dev8 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2662
...
- Refactor(plugins) - Optimize schema tooling by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2672
- Refactor(eos_designs) - Optimize and fix switch facts by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2678
- Bump - Pre-release v4.0.0-dev9 by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2681
...
- Refactor(eos_designs) - Remove template data from avd_switch_facts by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2687
- Refactor(eos_designs) - router_bgp python_module as per eos_cli_config_gen by @Shivani-chourasiya in https://github.com/aristanetworks/ansible-avd/pull/2625
- Bump - Pre-release v4.0.0-dev10 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2721
- Refactor - Change $def to $defs by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2734
- Refactor(eos_designs) - Add "shared_utils" and optimize code by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2708
- Bump(requirements) - ansible.utils to ">=2.9.0" by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2740
- Refactor(eos_designs) - ethernet_interfaces python module as per eos_cli_config_gen by @Vibhu-gslab in https://github.com/aristanetworks/ansible-avd/pull/2627
...
- Bump - Pre-release v4.0.0-dev11 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2769
...
- Bump(requirements) - Remove direct dependency of `ansible.netcommon` collection by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2801
- Refactor(plugins) - Optimize convert_dicts by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2810
- Bump - Pre-release v4.0.0-dev12 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2830
- Refactor(eos_designs) - Return list-based data models from eos_designs python modules - MLAG by @Shivani-chourasiya in https://github.com/aristanetworks/ansible-avd/pull/2831
...
- Refactor(eos_designs) - New plugin eos_designs_structured_config instead of yaml_templates_to_facts by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2857
- Bump - Pre-release v4.0.0-rc1 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2872
...
- Bump - Pre-release 4.0.0-rc2 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2905
...
- Bump - Collection requirements and cvprac by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2956
- Revert(eos_designs) - Revert enabling of graceful-restart by default by @ClausHolbechArista in https://github.com/aristanetworks/ansible-avd/pull/2958
- Bump - Pre-release 4.0.0-rc3 by @carlbuchmann in https://github.com/aristanetworks/ansible-avd/pull/2965
