...
The following deprecated Ansible role has been removed from the `arista.avd` Ansible collection in v5.0.0.

- `arista.avd.deploy_to_cv`

See the [porting guide](../porting-guides/5.x.x.md#removal-of-ansible-roles) for details.
