...
The class `AvdInterfaceDescriptions` was heavily modified and users having
subclassed it for custom descriptions need to adjust their code. The updated
version gives more flexibility to customizing interface descriptions.
