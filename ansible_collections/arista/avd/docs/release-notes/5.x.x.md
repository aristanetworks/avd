...
Starting AVD 5.0.0, `p2p_uplinks_mtu` support added in platform settings and default MTU for Dps1 and WAN HA interfaces changed to 9194.

See the [porting guide](../porting-guides/5.x.x.md#default-mtu-value-changed-from-9214-to-9194-for-dps1-and-wan-ha-interfaces) for details.
