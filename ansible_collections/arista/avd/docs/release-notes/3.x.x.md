...
Documentation for AVD version `3.5.0` [available here](https://www.avd.sh/en/v.3.5.0/)
...
- Fix(eos_cli_config_gen): VRF BGP neighbor allowas_in.enabled renders invalid config (#1891)

#### Fixed issues in eos_designs

- Fix(eos_designs): Wrong passive interfaces rendered under OSPF process (#1893)
- Fix(eos_designs): Correct pruning of vlans when no vlans are allowed (#1879)
