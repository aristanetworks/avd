...
- Fix(eos_designs,eos_cli_config_gen): Configure "ip routing ipv6 interface vrf X" for RFC5549 (#2660) by @gmuloc in https://github.com/aristanetworks/ansible-avd/pull/2733
