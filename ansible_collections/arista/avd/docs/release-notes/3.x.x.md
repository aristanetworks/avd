...
* Documentation for AVD version `3.7.0` [available here](https://www.avd.sh/en/stable/)
...
- __Node Types variables:__

  - `node_type_keys.<key>.custom_templates_extra_vars` introduced in 3.7.0 has been removed. This is non-breaking since the custom template
    environment now supports all host- and groupvars by default.

### Changes to requirements

- AVD now requires ansible-core from __2.11.3__ to __2.12.x__ excluding __2.12.0__ to __2.12.5__<br>
  ...
  in __2.12.6__ and __2.13.1__.<br>
