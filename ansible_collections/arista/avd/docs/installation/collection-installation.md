...
- Install [ansible-core](https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html) from from **2.11.3** to **2.14.x** excluding **2.12.0** to **2.12.5** and **2.13.0**
!!! note
