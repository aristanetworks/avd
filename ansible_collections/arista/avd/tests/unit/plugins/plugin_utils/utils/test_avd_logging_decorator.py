...
class TestAvdLoggingDecorator:
    ...
    def test_decorator_logger_levels(self, mock_action_plugin: MagicMock, mock_display: MagicMock, verbosity: int, expected_levels: dict[str, int]) -> None:
        ...
        run_plugin(mock_action_plugin, task_vars={})
    ...
    def test_decorator_logging(self, mock_action_plugin: MagicMock, mock_display: MagicMock, verbosity: int, expected_methods_called: list[str]) -> None:
    ...
    def test_decorator_with_context_and_format(
        ...
        run_plugin(mock_action_plugin, task_vars=task_vars)
    ...
    def test_decorator_save_logs(self, mock_action_plugin: MagicMock, mock_display: MagicMock) -> None:
        ...
        mock_action_plugin._task.args["save_logs"] = True
        result = run_plugin(mock_action_plugin, task_vars={})
    ...
    def test_decorator_live_display_false(self, mock_action_plugin: MagicMock, mock_display: MagicMock) -> None:
        ...
        mock_action_plugin._task.args["live_display"] = False
        run_plugin(mock_action_plugin, task_vars={})

        # Assert the display handler was NOT called
        mock_display.warning.assert_not_called()

    def test_decorator_exception_handling(self, mock_action_plugin: MagicMock) -> None:
    ...
    def test_decorator_warning_capture(self, mock_action_plugin: MagicMock, warning_type: type[Warning], message: str, expected_key: str) -> None:
    ...
    def test_decorator_handles_dirty_logger_state(self, mock_action_plugin: MagicMock, mock_display: MagicMock) -> None:
