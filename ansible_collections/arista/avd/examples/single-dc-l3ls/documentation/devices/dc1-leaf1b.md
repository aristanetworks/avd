...
| --------- | ----------- | ---- | ------------- |
| Ethernet3 | MLAG_dc1-leaf1a_Ethernet3 | active | 3 |
| Ethernet4 | MLAG_dc1-leaf1a_Ethernet4 | active | 3 |
| Ethernet5 | SERVER_dc1-leaf1-server1_PCI2 | active | 5 |
| Ethernet8 | L2_dc1-leaf1c_Ethernet2 | active | 8 |
...
| --------- | ----------- | --- | --- | -------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_dc1-leaf1a_Port-Channel3 | default | - | False | - | - | - | - |
| Port-Channel5 | SERVER_dc1-leaf1-server1_Bond1 | default | - | False | - | - | 5 | - |
