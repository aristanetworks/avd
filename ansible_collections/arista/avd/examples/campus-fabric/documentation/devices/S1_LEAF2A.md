...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1/1 | L2_S1_SPINE1_Ethernet49/1 | *trunk | *10,210,220,230 | *- | *- | 11 |
| Ethernet1/3 | L2_S1_SPINE2_Ethernet49/1 | *trunk | *10,210,220,230 | *- | *- | 11 |
...
interface Ethernet1/1
   description L2_S1_SPINE1_Ethernet49/1
   no shutdown
   channel-group 11 mode active
!
interface Ethernet1/3
   description L2_S1_SPINE2_Ethernet49/1
   no shutdown
   channel-group 11 mode active
!
