...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.16.100.108/24 | 172.16.100.1 |
...
| Ethernet97/1 | L2_S1_LEAF3A_Ethernet97/3 | *trunk | *10,310,320,330 | *- | *- | 971 |
| Ethernet97/2 | L2_S1_LEAF3B_Ethernet97/3 | *trunk | *10,310,320,330 | *- | *- | 971 |
...
interface Ethernet97/1
   description L2_S1_LEAF3A_Ethernet97/3
   no shutdown
   channel-group 971 mode active
!
interface Ethernet97/2
   description L2_S1_LEAF3B_Ethernet97/3
   no shutdown
   channel-group 971 mode active
```
