...
| Ethernet97/1 | L2_S1_SPINE1_Ethernet50/1 | *trunk | *10,310,320,330 | *- | *- | 971 |
| Ethernet97/2 | L2_S1_SPINE2_Ethernet50/1 | *trunk | *10,310,320,330 | *- | *- | 971 |
| Ethernet97/3 | L2_S1_LEAF3C_Ethernet97/1 | *trunk | *10,310,320,330 | *- | *- | 973 |
| Ethernet97/4 | L2_S1_LEAF3D_Ethernet97/1 | *trunk | *10,310,320,330 | *- | *- | 974 |
| Ethernet98/1 | L2_S1_LEAF3E_Ethernet97/1 | *trunk | *10,310,320,330 | *- | *- | 981 |
| Ethernet98/3 | MLAG_S1_LEAF3B_Ethernet98/3 | *trunk | *- | *- | *MLAG | 983 |
| Ethernet98/4 | MLAG_S1_LEAF3B_Ethernet98/4 | *trunk | *- | *- | *MLAG | 983 |
...
interface Ethernet97/1
   description L2_S1_SPINE1_Ethernet50/1
   no shutdown
   channel-group 971 mode active
!
interface Ethernet97/2
   description L2_S1_SPINE2_Ethernet50/1
   no shutdown
   channel-group 971 mode active
!
interface Ethernet97/3
   description L2_S1_LEAF3C_Ethernet97/1
   no shutdown
   channel-group 973 mode active
!
interface Ethernet97/4
   description L2_S1_LEAF3D_Ethernet97/1
   no shutdown
   channel-group 974 mode active
!
interface Ethernet98/1
   description L2_S1_LEAF3E_Ethernet97/1
   no shutdown
   channel-group 981 mode active
!
interface Ethernet98/3
   description MLAG_S1_LEAF3B_Ethernet98/3
   no shutdown
   channel-group 983 mode active
!
interface Ethernet98/4
   description MLAG_S1_LEAF3B_Ethernet98/4
   no shutdown
   channel-group 983 mode active
```
...
| Port-Channel973 | L2_S1_LEAF3C_Port-Channel971 | trunk | 10,310,320,330 | - | - | - | - | 973 | - |
| Port-Channel974 | L2_S1_LEAF3D_Port-Channel971 | trunk | 10,310,320,330 | - | - | - | - | 974 | - |
| Port-Channel981 | L2_S1_LEAF3E_Port-Channel971 | trunk | 10,310,320,330 | - | - | - | - | 981 | - |
| Port-Channel983 | MLAG_S1_LEAF3B_Port-Channel983 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel973
   description L2_S1_LEAF3C_Port-Channel971
   no shutdown
   switchport trunk allowed vlan 10,310,320,330
   switchport mode trunk
   switchport
...
interface Port-Channel974
   description L2_S1_LEAF3D_Port-Channel971
   no shutdown
   switchport trunk allowed vlan 10,310,320,330
   switchport mode trunk
   switchport
...
interface Port-Channel981
   description L2_S1_LEAF3E_Port-Channel971
   no shutdown
   switchport trunk allowed vlan 10,310,320,330
   switchport mode trunk
   switchport
...
interface Port-Channel983
   description MLAG_S1_LEAF3B_Port-Channel983
   no shutdown
   switchport mode trunk
