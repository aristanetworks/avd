...
| Ethernet97/1 | L2_SITE1_LEAF3A_Ethernet97/3 | *trunk | *10,310,320,330 | *- | *- | 971 |
| Ethernet97/2 | L2_SITE1_LEAF3B_Ethernet97/3 | *trunk | *10,310,320,330 | *- | *- | 971 |
...
interface Ethernet97/1
   description L2_SITE1_LEAF3A_Ethernet97/3
   no shutdown
   channel-group 971 mode active
!
interface Ethernet97/2
   description L2_SITE1_LEAF3B_Ethernet97/3
   no shutdown
   channel-group 971 mode active
```
