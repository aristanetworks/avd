...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_S1_LEAF1B_Ethernet51 | *trunk | *10,110,120,130 | *- | *- | 1 |
| Ethernet49/1 | L2_S1_LEAF2A_Ethernet1/3 | *trunk | *10,210,220,230 | *- | *- | 491 |
| Ethernet50/1 | L2_S1_LEAF3A_Ethernet97/2 | *trunk | *10,310,320,330 | *- | *- | 501 |
| Ethernet51/1 | L2_S1_LEAF3B_Ethernet97/2 | *trunk | *10,310,320,330 | *- | *- | 501 |
| Ethernet55/1 | MLAG_S1_SPINE1_Ethernet55/1 | *trunk | *- | *- | *MLAG | 551 |
| Ethernet56/1 | MLAG_S1_SPINE1_Ethernet56/1 | *trunk | *- | *- | *MLAG | 551 |
...
!
interface Ethernet1
   description L2_S1_LEAF1B_Ethernet51
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description L2_S1_LEAF2A_Ethernet1/3
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description L2_S1_LEAF3A_Ethernet97/2
   no shutdown
   channel-group 501 mode active
!
interface Ethernet51/1
   description L2_S1_LEAF3B_Ethernet97/2
   no shutdown
   channel-group 501 mode active
!
...
interface Ethernet55/1
   description MLAG_S1_SPINE1_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_S1_SPINE1_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel491 | L2_S1_LEAF2A_Port-Channel11 | trunk | 10,210,220,230 | - | - | - | - | 491 | - |
| Port-Channel501 | L2_IDF3_AGG_Port-Channel971 | trunk | 10,310,320,330 | - | - | - | - | 501 | - |
| Port-Channel551 | MLAG_S1_SPINE1_Port-Channel551 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel491
   description L2_S1_LEAF2A_Port-Channel11
   no shutdown
...
interface Port-Channel551
   description MLAG_S1_SPINE1_Port-Channel551
   no shutdown
   switchport mode trunk
