...
| Ethernet51 | L2_SITE1_SPINE2_Ethernet1 | *trunk | *10,110,120,130 | *- | *- | 51 |
| Ethernet53 | MLAG_SITE1_LEAF1A_Ethernet53 | *trunk | *- | *- | *MLAG | 53 |
| Ethernet54 | MLAG_SITE1_LEAF1A_Ethernet54 | *trunk | *- | *- | *MLAG | 53 |
...
interface Ethernet51
   description L2_SITE1_SPINE2_Ethernet1
   no shutdown
   channel-group 51 mode active
!
interface Ethernet53
   description MLAG_SITE1_LEAF1A_Ethernet53
   no shutdown
   channel-group 53 mode active
!
interface Ethernet54
   description MLAG_SITE1_LEAF1A_Ethernet54
   no shutdown
   channel-group 53 mode active
```
...
interface Port-Channel53
   description MLAG_SITE1_LEAF1A_Port-Channel53
   no shutdown
   switchport mode trunk
