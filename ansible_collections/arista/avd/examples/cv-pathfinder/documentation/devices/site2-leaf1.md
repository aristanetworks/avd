...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_site2-leaf2_Ethernet5 | *trunk | *- | *- | *LEAF_PEER_L3, MLAG | 5 |
| Ethernet6 | MLAG_PEER_site2-leaf2_Ethernet6 | *trunk | *- | *- | *LEAF_PEER_L3, MLAG | 5 |
...
| --------- | ----------- | ------- | -------------- | -------------------- |
| Ethernet3.100 | P2P_LINK_TO_SITE2-WAN1_Ethernet1.100_vrf_BLUE | - | 100 | - |
| Ethernet3.101 | P2P_LINK_TO_SITE2-WAN1_Ethernet1.101_vrf_RED | - | 101 | - |

##### IPv4

| Interface | Description | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SITE2-WAN1_Ethernet1 | - | 10.0.2.12/31 | default | 9214 | False | - | - |
| Ethernet3.100 | P2P_LINK_TO_SITE2-WAN1_Ethernet1.100_vrf_BLUE | - | 10.0.2.12/31 | BLUE | 9214 | False | - | - |
| Ethernet3.101 | P2P_LINK_TO_SITE2-WAN1_Ethernet1.101_vrf_RED | - | 10.0.2.12/31 | RED | 9214 | False | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_SITE2-WAN1_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet3.100
   description P2P_LINK_TO_SITE2-WAN1_Ethernet1.100_vrf_BLUE
   no shutdown
   mtu 9214
...
interface Ethernet3.101
   description P2P_LINK_TO_SITE2-WAN1_Ethernet1.101_vrf_RED
   no shutdown
   mtu 9214
...
!
interface Ethernet5
   description MLAG_PEER_site2-leaf2_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_PEER_site2-leaf2_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_site2-leaf2_Po5 | trunk | - | - | LEAF_PEER_L3, MLAG | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_site2-leaf2_Po5
   no shutdown
   switchport
...
router bgp 65102
   ...
   neighbor 10.255.251.17 description site2-leaf2
