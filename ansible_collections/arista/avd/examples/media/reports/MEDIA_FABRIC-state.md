...
| 773 | media-PTP-1 | BGP | ArBGP is configured and operating | ArBGP | FAIL | Operating routing protocol model: ribd, Configured routing protocol model: multi-agent (will apply after next reboot) |
...
| 352 | amber-leaf1 | Interface State | Ethernet Interface & Line Protocol == "adminDown" | Ethernet36 - mcs senders/receivers | PASS | - |
...
| 389 | amber-leaf2 | Interface State | Ethernet Interface & Line Protocol == "adminDown" | Ethernet19 - C100-2 P2-3 | PASS | - |
...
| 426 | amber-spine1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet27/1 - P2P_LINK_TO_MEDIA-PTP-1_Ethernet51 | PASS | - |
...
| 463 | amber-spine1 | Interface State | Ethernet Interface & Line Protocol == "adminDown" | Ethernet30/1 - Links to blue-spine1 | PASS | - |
...
| 500 | blue-leaf1 | Interface State | Ethernet Interface & Line Protocol == "adminDown" | Ethernet36 - BLUE_VLAN121 | PASS | - |
...
| 537 | blue-leaf2 | Interface State | Ethernet Interface & Line Protocol == "adminDown" | Ethernet10 - BLUE_VLAN122 | PASS | - |
...
| 574 | blue-leaf2 | Interface State | Ethernet Interface & Line Protocol == "adminDown" | Ethernet47 - BLUE_VLAN122 | PASS | - |
...
| 611 | media-PTP-1 | Interface State | Ethernet Interface & Line Protocol == "adminDown" | Ethernet5 - mcs senders/receivers | PASS | - |
...
| 648 | media-PTP-1 | Interface State | Ethernet Interface & Line Protocol == "adminDown" | Ethernet42 - mcs senders/receivers | PASS | - |
...
| 685 | media-PTP-2 | Interface State | Ethernet Interface & Line Protocol == "adminDown" | Ethernet25 - mcs senders/receivers | PASS | - |
...
| 722 | amber-leaf2 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback0 - Router_ID | PASS | - |
...
| 759 | blue-spine1 | IP Reachability | ip reachability test p2p links | Source: blue-spine1_Ethernet17/1 - Destination: blue-leaf1_Ethernet51/1 | PASS | - |
...
| 766 | media-PTP-2 | IP Reachability | ip reachability test p2p links | Source: media-PTP-2_Ethernet52 - Destination: blue-spine1_Ethernet28/1 | PASS | - |
| 767 | amber-leaf1 | BGP | ArBGP is configured and operating | ArBGP | PASS | - |
| 768 | amber-leaf2 | BGP | ArBGP is configured and operating | ArBGP | PASS | - |
| 769 | amber-spine1 | BGP | ArBGP is configured and operating | ArBGP | PASS | - |
| 770 | blue-leaf1 | BGP | ArBGP is configured and operating | ArBGP | PASS | - |
| 771 | blue-leaf2 | BGP | ArBGP is configured and operating | ArBGP | PASS | - |
| 772 | blue-spine1 | BGP | ArBGP is configured and operating | ArBGP | PASS | - |
| 773 | media-PTP-1 | BGP | ArBGP is configured and operating | ArBGP | FAIL | Operating routing protocol model: ribd, Configured routing protocol model: multi-agent (will apply after next reboot) |
| 774 | media-PTP-2 | BGP | ArBGP is configured and operating | ArBGP | PASS | - |
| 775 | amber-leaf1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.254.0 | PASS | - |
| 776 | amber-leaf2 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.254.2 | PASS | - |
| 777 | amber-spine1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.254.1 | PASS | - |
| 778 | amber-spine1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.254.3 | PASS | - |
| 779 | amber-spine1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.1 | PASS | - |
| 780 | amber-spine1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.5 | PASS | - |
| 781 | blue-leaf1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.255.0 | PASS | - |
| 782 | blue-leaf2 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.255.2 | PASS | - |
| 783 | blue-spine1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.255.1 | PASS | - |
| 784 | blue-spine1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.255.3 | PASS | - |
| 785 | blue-spine1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.3 | PASS | - |
| 786 | blue-spine1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.7 | PASS | - |
| 787 | media-PTP-2 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.4 | PASS | - |
| 788 | media-PTP-2 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.6 | PASS | - |
