...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet51 | P2P_LINK_TO_AMBER-SPINE1_Ethernet27/1 | routed | - | 10.255.253.1/31 | default | 9214 | False | - | - |
| Ethernet52 | P2P_LINK_TO_BLUE-SPINE1_Ethernet27/1 | routed | - | 10.255.253.3/31 | default | 9214 | False | - | - |
...
interface Ethernet52
   description P2P_LINK_TO_BLUE-SPINE1_Ethernet27/1
   no shutdown
   mtu 9214
   no switchport
...
router bgp 65401
   ...
   neighbor 10.255.253.0 description amber-spine1_Ethernet27/1
   neighbor 10.255.253.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.253.2 remote-as 65200
   neighbor 10.255.253.2 description blue-spine1_Ethernet27/1
