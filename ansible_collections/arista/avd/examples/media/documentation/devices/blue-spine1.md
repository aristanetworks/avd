...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.90.227.12/24 | 10.252.0.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet17/1 | P2P_LINK_TO_BLUE-LEAF1_Ethernet51/1 | routed | - | 10.255.255.0/31 | default | 9214 | False | - | - |
| Ethernet25/1 | P2P_LINK_TO_BLUE-LEAF2_Ethernet54/1 | routed | - | 10.255.255.2/31 | default | 9214 | False | - | - |
| Ethernet27/1 | P2P_LINK_TO_MEDIA-PTP-1_Ethernet52 | routed | - | 10.255.253.2/31 | default | 9214 | False | - | - |
| Ethernet28/1 | P2P_LINK_TO_MEDIA-PTP-2_Ethernet52 | routed | - | 10.255.253.6/31 | default | 9214 | False | - | - |
...
interface Ethernet25/1
   description P2P_LINK_TO_BLUE-LEAF2_Ethernet54/1
   no shutdown
   mtu 9214
   no switchport
...
| 10.255.255.3 | 65202 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor 10.255.253.3 description media-PTP-1_Ethernet52
   neighbor 10.255.253.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.253.7 remote-as 65402
   neighbor 10.255.253.7 description media-PTP-2_Ethernet52
   neighbor 10.255.255.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.1 remote-as 65201
   neighbor 10.255.255.1 description blue-leaf1_Ethernet51/1
   neighbor 10.255.255.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.3 remote-as 65202
   neighbor 10.255.255.3 description blue-leaf2_Ethernet54/1
