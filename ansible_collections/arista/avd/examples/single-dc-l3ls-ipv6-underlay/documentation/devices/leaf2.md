...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF1 | Vlan4094 | 2001:db8:3::1 | Port-Channel11 |
...
| Ethernet11 | MLAG_PEER_leaf1_Ethernet11 | *trunk | *- | *- | *LEAF_PEER_L3, MLAG | 11 |
| Ethernet12 | MLAG_PEER_leaf1_Ethernet12 | *trunk | *- | *- | *LEAF_PEER_L3, MLAG | 11 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_LINK_TO_SPINE1_Ethernet2 | - | 2001:db8:2:2::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_LINK_TO_SPINE2_Ethernet2 | - | 2001:db8:2:3::2/64 | default | 1500 | False | - | - | - | - |
...
interface Ethernet12
   description MLAG_PEER_leaf1_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_PEER_leaf1_Po11 | trunk | - | - | LEAF_PEER_L3, MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_PEER_leaf1_Po11
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | EVPN_Overlay_Peering | default | 2001:db8:1:2::1/64 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 2001:db8:5:1::1/64 |
...
| 2001:db8:2:2::1 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:2:3::1 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:4::1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4::1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4::1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 2001:db8:2:2::1 peer group IPv4-UNDERLAY-PEERS
   neighbor 2001:db8:2:2::1 remote-as 65100
   neighbor 2001:db8:2:2::1 description spine1_Ethernet2
   neighbor 2001:db8:2:3::1 peer group IPv4-UNDERLAY-PEERS
   neighbor 2001:db8:2:3::1 remote-as 65100
   neighbor 2001:db8:2:3::1 description spine2_Ethernet2
   neighbor 2001:db8:4::1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 2001:db8:4::1 description leaf1
