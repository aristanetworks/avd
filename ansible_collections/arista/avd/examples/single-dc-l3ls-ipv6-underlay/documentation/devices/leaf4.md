...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.16.1.34/24 | 172.16.1.1 |
...
| Ethernet11 | MLAG_leaf3_Ethernet11 | *trunk | *- | *- | *MLAG | 11 |
| Ethernet12 | MLAG_leaf3_Ethernet12 | *trunk | *- | *- | *MLAG | 11 |
...
interface Ethernet11
   description MLAG_leaf3_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_leaf3_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | PortChannel dc1-leaf2-server1 | trunk | 11-12,21-22 | 4092 | - | - | - | 5 | - |
| Port-Channel11 | MLAG_leaf3_Port-Channel11 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_leaf3_Port-Channel11
   no shutdown
   switchport mode trunk
...
router bgp 65102
   ...
   vrf VRF12
      ...
      router-id 10.255.1.4
      neighbor 2001:db8:4:2::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::1 description leaf3_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
