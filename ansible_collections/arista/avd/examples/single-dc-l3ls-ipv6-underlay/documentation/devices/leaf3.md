...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.16.1.33/24 | 172.16.1.1 |
...
| Ethernet11 | MLAG_leaf4_Ethernet11 | *trunk | *- | *- | *MLAG | 11 |
| Ethernet12 | MLAG_leaf4_Ethernet12 | *trunk | *- | *- | *MLAG | 11 |
...
interface Ethernet11
   description MLAG_leaf4_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_leaf4_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_leaf4_Port-Channel11 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_leaf4_Port-Channel11
   no shutdown
   switchport mode trunk
