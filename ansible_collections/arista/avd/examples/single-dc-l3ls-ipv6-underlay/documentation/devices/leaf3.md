...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF2 | Vlan4094 | 2001:db8:3:2::2 | Port-Channel11 |
...
| Ethernet11 | MLAG_PEER_leaf4_Ethernet11 | *trunk | *- | *- | *LEAF_PEER_L3, MLAG | 11 |
| Ethernet12 | MLAG_PEER_leaf4_Ethernet12 | *trunk | *- | *- | *LEAF_PEER_L3, MLAG | 11 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_LINK_TO_SPINE1_Ethernet3 | - | 2001:db8:2:4::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_LINK_TO_SPINE2_Ethernet3 | - | 2001:db8:2:5::2/64 | default | 1500 | False | - | - | - | - |
...
interface Ethernet11
   description MLAG_PEER_leaf4_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_PEER_leaf4_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_PEER_leaf4_Po11 | trunk | - | - | LEAF_PEER_L3, MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_PEER_leaf4_Po11
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | EVPN_Overlay_Peering | default | 2001:db8:1:3::1/64 |
...
router bgp 65102
   ...
   neighbor 2001:db8:4:2::2 description leaf4
