...
!
daemon TerminAttr
   exec /usr/bin/TerminAttr -cvaddr=192.168.1.12:9910 -cvauth=token,/tmp/token -cvvrf=MGMT -disableaaa -smashexcludes=ale,flexCounter,hardware,kni,pulse,strata -ingestexclude=/Sysdb/cell/1/agent,/Sysdb/cell/2/agent -taillogs -cvsourceintf=Management1
   no shutdown
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_dc1-leaf1a_Ethernet8 | *trunk | *11-12,21-22,31-32,3401-3402 | *- | *- | 1 |
| Ethernet2 | L2_dc1-leaf1b_Ethernet8 | *trunk | *11-12,21-22,31-32,3401-3402 | *- | *- | 1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_DC1_L3_LEAF1_Port-Channel8 | trunk | 11-12,21-22,31-32,3401-3402 | - | - | - | - | - | - |
