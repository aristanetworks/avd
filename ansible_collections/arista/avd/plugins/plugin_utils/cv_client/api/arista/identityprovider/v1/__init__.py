...
class ProtocolBinding(betterproto.Enum):
    """ProtocolBinding indicates SAML protocol binding to be used."""

    PROTOCOL_BINDING_UNSPECIFIED = 0
    """
    PROTOCOL_BINDING_UNSPECIFIED indicates that a protocol binding is
    unspecified.
    """
    ...
    """
    PROTOCOL_BINDING_HTTP_REDIRECT indicates HTTP-Redirect SAML protocol
    binding.
    """


@dataclass(eq=False, repr=False)
class OAuthKey(betterproto.Message):
    """OAuthKey contains OAuth provider ID."""

    provider_id: Optional[str] = betterproto.message_field(
...
@dataclass(eq=False, repr=False)
class OAuthConfig(betterproto.Message):
    ...
    """
    endpoint is the URL that identifies an OAuth authorization server. This
    endpoint is used to interact with the provider. It must be a URI [RFC3986]
    with a scheme component that must be https, a host component, and
    optionally, port and path components, but no query or fragment components.
    """
    ...
    """
    client_secret is the secret that the OAuth authorization server issues to
    the registered client.
    """

    algorithms: "___fmp__.RepeatedString" = betterproto.message_field(5)
    """
    algorithms is the set of signing algorithms. This is an optional field. If
    specified, only this set of algorithms may be used to sign the JWT.
    Otherwise, this defaults to the set of algorithms that the provider
    supports.
    """

    link_to_shared_provider: Optional[bool] = betterproto.message_field(
        6, wraps=betterproto.TYPE_BOOL
    )
    """
    link_to_shared_provider indicates whether or not use the provider as a
    shared provider. This is an optional field and set to false by default.
    """

    jwks_uri: Optional[str] = betterproto.message_field(
    ...
    permitted_email_domains: "___fmp__.RepeatedString" = betterproto.message_field(8)
    """
    permitted_email_domains are domains of emails that users are allowed to
    use. This is an optional field. If not set, all domains are accepted by
    default.
    """

    roles_scope_name: Optional[str] = betterproto.message_field(
        9, wraps=betterproto.TYPE_STRING
    )
    """
    roles_scope_name is the name for a custom scope that includes a custom
    claim that holds CloudVision roles in ID Token. CloudVision appends this
    value to scope query parameter in the authorization request URL. This is an
    optional field. If not set, CloudVision determines that mapping roles from
...
class SamlConfig(betterproto.Message):
    ...
    idp_issuer: Optional[str] = betterproto.message_field(
        2, wraps=betterproto.TYPE_STRING
    )
    """
    idp_issuer identifies the SAML provider. There is no restriction on its
    format other than a string to carry the issuer's name.
    """

    idp_metadata_url: Optional[str] = betterproto.message_field(
        3, wraps=betterproto.TYPE_STRING
    )
    """
    ...
    authreq_binding: "ProtocolBinding" = betterproto.enum_field(4)
    """
    authreq_binding specifies the ProtocolBinding used to send SAML
    authentication request to the SAML provider.
    """

    email_attrname: Optional[str] = betterproto.message_field(
        5, wraps=betterproto.TYPE_STRING
    )
    """
    email_attrname specifies the Attribute name for email ID in Assertion of
    SAMLResponse from the SAML provider.
    """
    ...
    permitted_email_domains: "___fmp__.RepeatedString" = betterproto.message_field(7)
    """
    permitted_email_domains are domains of emails that users are allowed to
    use. This is an optional field. If not set, all domains are accepted by
    default.
    ...
    force_saml_authn: Optional[bool] = betterproto.message_field(
...
@dataclass(eq=False, repr=False)
class OAuthConfigRequest(betterproto.Message):
    key: "OAuthKey" = betterproto.message_field(1)
    """
    Key uniquely identifies a OAuthConfig instance to retrieve. This value must
    be populated.
    """
...
@dataclass(eq=False, repr=False)
class OAuthConfigResponse(betterproto.Message):
    value: "OAuthConfig" = betterproto.message_field(1)
    """
...
@dataclass(eq=False, repr=False)
class OAuthConfigStreamRequest(betterproto.Message):
    partial_eq_filter: List["OAuthConfig"] = betterproto.message_field(1)
    """
...
@dataclass(eq=False, repr=False)
class OAuthConfigStreamResponse(betterproto.Message):
    value: "OAuthConfig" = betterproto.message_field(1)
    """
    ...
    """
    Operation indicates how the OAuthConfig value in this response should be
...
@dataclass(eq=False, repr=False)
class OAuthConfigSetRequest(betterproto.Message):
    value: "OAuthConfig" = betterproto.message_field(1)
    """
    OAuthConfig carries the value to set into the datastore. See the
    documentation on the OAuthConfig struct for which fields are required.
    """


@dataclass(eq=False, repr=False)
class OAuthConfigSetResponse(betterproto.Message):
    value: "OAuthConfig" = betterproto.message_field(1)
    """
    Value carries all the values given in the OAuthConfigSetRequest as well as
...
@dataclass(eq=False, repr=False)
class OAuthConfigDeleteRequest(betterproto.Message):
    key: "OAuthKey" = betterproto.message_field(1)
    """
    Key indicates which OAuthConfig instance to remove. This field must always
    be set.
    """


@dataclass(eq=False, repr=False)
class OAuthConfigDeleteResponse(betterproto.Message):
    key: "OAuthKey" = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class OAuthConfigDeleteAllRequest(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class OAuthConfigDeleteAllResponse(betterproto.Message):
    ...
    key: "OAuthKey" = betterproto.message_field(3)
    """
...
@dataclass(eq=False, repr=False)
class SamlConfigRequest(betterproto.Message):
    key: "SamlKey" = betterproto.message_field(1)
    """
    Key uniquely identifies a SAMLConfig instance to retrieve. This value must
    be populated.
    """
...
@dataclass(eq=False, repr=False)
class SamlConfigResponse(betterproto.Message):
    value: "SamlConfig" = betterproto.message_field(1)
    """
    Value is the value requested. This structure will be fully-populated as it
    exists in the datastore. If optional fields were not given at creation,
    these fields will be empty or set to default values.
    ...
    time: datetime = betterproto.message_field(2)
    """
    Time carries the (UTC) timestamp of the last-modification of the SAMLConfig
    instance in this response.
    """


@dataclass(eq=False, repr=False)
class SamlConfigStreamRequest(betterproto.Message):
    partial_eq_filter: List["SamlConfig"] = betterproto.message_field(1)
    """
    PartialEqFilter provides a way to server-side filter a GetAll/Subscribe.
    This requires all provided fields to be equal to the response. While
    transparent to users, this field also allows services to optimize internal
...
@dataclass(eq=False, repr=False)
class SamlConfigStreamResponse(betterproto.Message):
    value: "SamlConfig" = betterproto.message_field(1)
    """
    Value is a value deemed relevant to the initiating request. This structure
    will always have its key-field populated. Which other fields are populated,
    ...
    type: "__subscriptions__.Operation" = betterproto.enum_field(3)
    """
    Operation indicates how the SAMLConfig value in this response should be
    considered. Under non-subscribe requests, this value should always be
    INITIAL. In a subscription, once all initial data is streamed and the
    client begins to receive modification updates, you should not see INITIAL
    again.
...
@dataclass(eq=False, repr=False)
class SamlConfigSetRequest(betterproto.Message):
    value: "SamlConfig" = betterproto.message_field(1)
    """
    SAMLConfig carries the value to set into the datastore. See the
    documentation on the SAMLConfig struct for which fields are required.
    """


@dataclass(eq=False, repr=False)
class SamlConfigSetResponse(betterproto.Message):
    value: "SamlConfig" = betterproto.message_field(1)
    """
    Value carries all the values given in the SAMLConfigSetRequest as well as
    any server-generated values.
    """
...
@dataclass(eq=False, repr=False)
class SamlConfigDeleteRequest(betterproto.Message):
    key: "SamlKey" = betterproto.message_field(1)
    """
    Key indicates which SAMLConfig instance to remove. This field must always
    be set.
    """


@dataclass(eq=False, repr=False)
class SamlConfigDeleteResponse(betterproto.Message):
    key: "SamlKey" = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class SamlConfigDeleteAllRequest(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class SamlConfigDeleteAllResponse(betterproto.Message):
    type: "___fmp__.DeleteError" = betterproto.enum_field(1)
    """This describes the class of delete error."""
    ...
    key: "SamlKey" = betterproto.message_field(3)
    """
...
class OAuthConfigServiceStub(betterproto.ServiceStub):
    async def get_one(
        self,
...
class SamlConfigServiceStub(betterproto.ServiceStub):
    async def get_one(
        self,
...
class OAuthConfigServiceBase(ServiceBase):
    ...
    async def get_all(
        ...
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
        yield OAuthConfigStreamResponse()
    ...
    async def delete_all(
        ...
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
        yield OAuthConfigDeleteAllResponse()
...
class SamlConfigServiceBase(ServiceBase):
    ...
    async def get_all(
        ...
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
        yield SamlConfigStreamResponse()
    ...
    async def delete_all(
        ...
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
        yield SamlConfigDeleteAllResponse()
