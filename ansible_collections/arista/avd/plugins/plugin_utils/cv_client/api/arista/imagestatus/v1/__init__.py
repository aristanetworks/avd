...
class ExtensionInstallStatus(betterproto.Enum):
    """
    ...
    """
    EXTENSION_INSTALL_STATUS_UNSPECIFIED indicates extensions install status is
    unspecified.
    """

    EXTENSION_INSTALL_STATUS_NOT_INSTALLED = 1
    """
    EXTENSION_INSTALL_STATUS_NOT_INSTALLED indicates extension is not installed
    on the device.
    """

    EXTENSION_INSTALL_STATUS_INSTALLED = 2
    """
    EXTENSION_INSTALL_STATUS_INSTALLED indicates extension is installed on the
    device.
    """

    EXTENSION_INSTALL_STATUS_FORCE_INSTALLED = 3
    """
    EXTENSION_INSTALL_STATUS_FORCE_INSTALLED indicates extension is force
    installed on device.
    """


class SoftwareComplianceCode(betterproto.Enum):
    """SoftwareComplianceCode indicates possible compliance status."""

    SOFTWARE_COMPLIANCE_CODE_UNSPECIFIED = 0
    """
    SOFTWARE_COMPLIANCE_CODE_UNSPECIFIED indicates compliance code is
    unspecified.
    """

    SOFTWARE_COMPLIANCE_CODE_IN_SYNC = 1
    """
    SOFTWARE_COMPLIANCE_CODE_IN_SYNC indicates designed and running
    images/extensions are identical.
    """

    SOFTWARE_COMPLIANCE_CODE_OUT_OF_SYNC = 2
    """
    SOFTWARE_COMPLIANCE_CODE_OUT_OF_SYNC indicates designed and running
    images/extensions are not identical.
    """
...
class ErrorCode(betterproto.Enum):
    ...
    """
    ERROR_CODE_SUPPORT_NOT_INTRODUCED represents case where the given EOS
    version does not support the SKU. Deprecated - use
    WARNING_CODE_SUPPORT_NOT_INTRODUCED
    """

    ERROR_CODE_SUPPORT_REMOVED = 2
    """
    ERROR_CODE_SUPPORT_REMOVED represents case where the given EOS version no
    longer supports the SKU. Deprecated - use WARNING_CODE_SUPPORT_REMOVED
    """

    ERROR_CODE_DEVICE_UNREACHABLE = 3
    """
    ERROR_CODE_DEVICE_UNREACHABLE represents the case where the device is
    unreachable during a compliance computation.
    """
    ...
    """
    ERROR_CODE_GET_RUNNING_IMAGE_INFO_FROM_ACTIVE_SUPERVISOR_FAILED represents
    case where we fail to get running image information from an active
    supervisor.
    """

    ERROR_CODE_GET_RUNNING_IMAGE_INFO_FROM_PEER_SUPERVISOR_FAILED = 7
    """
    ERROR_CODE_GET_RUNNING_IMAGE_INFO_FROM_PEER_SUPERVISOR_FAILED represents
    case when we fail to get information from peer supervisor.
    """

    ERROR_CODE_EOS_TA_ARCHITECTURE_INCOMPATIBLE = 8
    """
    ERROR_CODE_EOS_TA_ARCHITECTURE_INCOMPATIBLE represents the case where EOS
    architecture and TerminAttr architecture are incompatible.
    """

    ERROR_CODE_TA_CV_INCOMPATIBLE = 9
    """
    ERROR_CODE_TA_CV_INCOMPATIBLE represents the case where TerminAttr is
    incompatible with CloudVision; i.e., the TerminAttr version is below
    CloudVision's minimum supported version.
    """

    ERROR_CODE_EOS_CV_INCOMPATIBLE = 10
    """
    ERROR_CODE_EOS_CV_INCOMPATIBLE represents the case where the EOS version is
    incompatible with CloudVision; i.e., the EOS version is outside of
    CloudVision's supported range of versions.
    """


class WarningCode(betterproto.Enum):
    ...
    """
    WARNING_CODE_NOT_APPLICABLE represents cases where EOS <-> SKU/TA
    compatibility is not applicable for non physical switches like vEos.
    """

    WARNING_CODE_SKUINFO_UNAVAILABLE = 2
    """
    WARNING_CODE_SKUINFO_UNAVAILABLE represents case where information about
    certain skus is missing.
    """

    WARNING_CODE_DEVICE_SKU_UNAVAILABLE = 3
    """
    WARNING_CODE_DEVICE_SKU_UNAVAILABLE represents unavailability of skus for
    an EOS Device.
    """

    WARNING_CODE_SWI_UNKNOWN = 4
    """
    WARNING_CODE_SWI_UNKNOWN represents cases where EOS version is not found in
    release database.
    """

    WARNING_CODE_TA_EOS_INCOMPATIBLE = 5
    """
    WARNING_CODE_TA_EOS_INCOMPATIBLE represents cases where TA and EOS are not
    compatible. TA is lower than embedded TA in swi or given TA is unsupported
    by the EOS.
    """

    WARNING_CODE_TA_CV_INCOMPATIBLE = 6
    """
    WARNING_CODE_TA_CV_INCOMPATIBLE represents cases where TA is incompatible
    with CV. TA is lower than minimum supported TA on CV. Deprecated - use
    ERROR_CODE_TA_CV_INCOMPATIBLE.
    """

    WARNING_CODE_EOS_CV_INCOMPATIBLE = 7
    """
    WARNING_CODE_EOS_CV_INCOMPATIBLE represents cases where EOS is no longer or
    not yet supported by CV. Given EOS is outside range of CV's minimum and
    maximum EOS. Deprecated - use ERROR_CODE_EOS_CV_INCOMPATIBLE.
    """

    WARNING_CODE_EOS_ARCH_UNKNOWN = 8
    """
    WARNING_CODE_EOS_ARCH_UNKNOWN represents cases where the specified
    architecture is not valid for EOS.
    """

    WARNING_CODE_TA_EMBEDDEDEXT_INCOMPATIBLE = 9
    """
    WARNING_CODE_TA_EMBEDDEDEXT_INCOMPATIBLE represents cases where TA
    extension is lower in version than embedded TA in SWI.
    """

    WARNING_CODE_ARCH_INCOMPATIBLE = 10
    """
    WARNING_CODE_ARCH_INCOMPATIBLE represents cases where EOS arch and TA arch
    are different. Deprecated.
    """

    WARNING_CODE_EOS_END_OF_LIFE_DATE_PASSED = 11
    """
    WARNING_CODE_EOS_END_OF_LIFE_DATE_PASSED represents cases where the given
    EOS has passed its end of life date.
    """

    WARNING_CODE_SUPPORT_NOT_INTRODUCED = 12
    """
    WARNING_CODE_SUPPORT_NOT_INTRODUCED represents cases where the given EOS
    version does not support the SKUs.
    """

    WARNING_CODE_SUPPORT_REMOVED = 13
    """
    WARNING_CODE_SUPPORT_REMOVED represents cases where the given EOS version
    no longer supports the SKUs.
    """


@dataclass(eq=False, repr=False)
class SoftwareImage(betterproto.Message):
    """
    ...
    metadata: "ImageMetadata" = betterproto.message_field(3)
...
class ImageMetadata(betterproto.Message):
    ...
    release: Optional[str] = betterproto.message_field(2, wraps=betterproto.TYPE_STRING)
    """release is the release name of the EOS image."""

    flavor: Optional[str] = betterproto.message_field(3, wraps=betterproto.TYPE_STRING)
    """
    flavor is the flavor information of the EOS image. default flavor is
    DEFAULT. Other flavors can be DPE, 2GB, etc.
    """

    variant: Optional[str] = betterproto.message_field(4, wraps=betterproto.TYPE_STRING)
    """
    variant is the variant information of the EOS image. possible values: INT
    or US.
    """

    arch: Optional[str] = betterproto.message_field(5, wraps=betterproto.TYPE_STRING)
...
class Extension(betterproto.Message):
    ...
    reboot_required: Optional[bool] = betterproto.message_field(
        3, wraps=betterproto.TYPE_BOOL
    )
    """
    reboot_required indicates whether applying/deleting this extension would
    result in a reboot.
    """

    present: Optional[bool] = betterproto.message_field(4, wraps=betterproto.TYPE_BOOL)
    """
    present indicates whether the extension is present in the device or not.
    """

    installed: "ExtensionInstallStatus" = betterproto.enum_field(5)
    """
    installed indicates whether the extension is installed, not installed or
    force installed.
    """

    status_detail: Optional[str] = betterproto.message_field(
    ...
    is_embedded: Optional[bool] = betterproto.message_field(
        7, wraps=betterproto.TYPE_BOOL
    )
    """
    is_embedded indicates whether the extension is embedded in the EOS swi or
    not.
    """


@dataclass(eq=False, repr=False)
class Extensions(betterproto.Message):
    """Extensions provides an ordered list of running/designed extensions."""

    values: List["Extension"] = betterproto.message_field(1)
    """values represents extension information."""


@dataclass(eq=False, repr=False)
class ComplianceStatus(betterproto.Message):
    """
    ComplianceStatus indicates compliance status for software image, terminattr
    and extensions.
    """

    software_image_compliance_code: "SoftwareComplianceCode" = betterproto.enum_field(1)
    """software_image_compliance_code is the compliance code for images."""

    terminattr_compliance_code: "SoftwareComplianceCode" = betterproto.enum_field(2)
    """terminattr_compliance_code is the compliance code for TerminAttr."""

    extensions_compliance_code: "SoftwareComplianceCode" = betterproto.enum_field(3)
    """extensions_compliance_code is the compliance code for extensions."""


@dataclass(eq=False, repr=False)
class ComplianceStatusBySup(betterproto.Message):
    """
    ComplianceStatusBySup is a map that indicates the compliance code for each
    supervisor.
    """

    values: Dict[str, "ComplianceStatus"] = betterproto.map_field(
...
@dataclass(eq=False, repr=False)
class RebootRequired(betterproto.Message):
    """
    RebootRequired indicates the reboot information per software image,
    terminattr and extension for the switch as a whole.
    """

    software_image_reboot_required: Optional[bool] = betterproto.message_field(
        1, wraps=betterproto.TYPE_BOOL
    )
    """
    software_image_reboot_required indicates whether reboot is required for the
    software image being applied.
    """

    terminattr_reboot_required: Optional[bool] = betterproto.message_field(
        2, wraps=betterproto.TYPE_BOOL
    )
    """
    terminattr_reboot_required indicates whether reboot is required for the
    terminattr being applied/deleted.
    """

    extension_reboot_required: Optional[bool] = betterproto.message_field(
        3, wraps=betterproto.TYPE_BOOL
    )
    """
    extension_reboot_required indicates whether reboot is required for the
    extensions being applied/deleted.
    """


@dataclass(eq=False, repr=False)
class SoftwareImageDiff(betterproto.Message):
    """SoftwareImageDiff is the diff for the running/designed images."""

    code: "DiffOp" = betterproto.enum_field(1)
    """
    code indicates the operation performed to get from one side of the diff to
    the other.
    """

    a: "SoftwareImage" = betterproto.message_field(2)
    """a is the software image on the a side (left hand side)."""

    b: "SoftwareImage" = betterproto.message_field(3)
    """b is the software image on the b side (right hand side)."""


@dataclass(eq=False, repr=False)
class SoftwareImageDiffsBySup(betterproto.Message):
    """
    SoftwareImageDiffsBySup is software image diff information for each
    supervisor.
    """

    values: Dict[str, "SoftwareImageDiff"] = betterproto.map_field(
        1, betterproto.TYPE_STRING, betterproto.TYPE_MESSAGE
    )
...
@dataclass(eq=False, repr=False)
class ExtensionDiff(betterproto.Message):
    ...
    a: "Extension" = betterproto.message_field(2)
    """a is the extension on the a side (left hand side)."""

    b: "Extension" = betterproto.message_field(3)
    """b is the extension on the b side (right hand side)."""


@dataclass(eq=False, repr=False)
class TerminAttrDiffsBySup(betterproto.Message):
    """
    TerminAttrDiffsBySup is the terminattr diff information for each
    supervisor.
    """

    values: Dict[str, "ExtensionDiff"] = betterproto.map_field(
        1, betterproto.TYPE_STRING, betterproto.TYPE_MESSAGE
    )
...
@dataclass(eq=False, repr=False)
class ImageSummary(betterproto.Message):
    """ImageSummary represents device image summary."""

    sku: Optional[str] = betterproto.message_field(1, wraps=betterproto.TYPE_STRING)
    """sku indicates the top-level sku or model number."""

    running_image_update_time: datetime = betterproto.message_field(2)
    """
    running_image_update_time is the most recent timestamp at which one of
    running image side properties is updated.
    """

    designed_image_update_time: datetime = betterproto.message_field(3)
    """
    designed_image_update_time is the most recent timestamp at which one of
    designed image side properties is updated.
    """

    dual_sup: Optional[bool] = betterproto.message_field(4, wraps=betterproto.TYPE_BOOL)
    """dual_sup indicates if a device is a dual supervisor."""

    active_slot: Optional[int] = betterproto.message_field(
    ...
    standby_slot: Optional[int] = betterproto.message_field(
    ...
    software_image_diff: "SoftwareImageDiffsBySup" = betterproto.message_field(7)
    """software_image_diff indicates the image diff for each supervisor."""

    terminattr_diff: "TerminAttrDiffsBySup" = betterproto.message_field(8)
    """terminattr_diff indicates the terminattr diff for each supervisor."""

    extensions_diff: "ExtensionDiffsBySup" = betterproto.message_field(9)
    """extensions_diff indicates the extension diff for each supervisor."""

    compliance_status: "SoftwareComplianceCode" = betterproto.enum_field(10)
    """
    compliance_status is the aggregated compliance status (including both
    active/standby and image/TA/extension compliance).
    """

    compliance: "ComplianceStatusBySup" = betterproto.message_field(11)
    """compliance provides compliance information for each supervisor."""

    reboot_required: "RebootRequired" = betterproto.message_field(12)
    """
    reboot_required indicates whether a reboot is required if the designed
    image is pushed to the device.
    """

    digest: Optional[str] = betterproto.message_field(13, wraps=betterproto.TYPE_STRING)
    """
    digest is the digest of the image summary. It can use SHA-256 hash
    algorithm for example. It is computed by stringifying
    thesoftware_image_diff, terminattr_diff and extensions_diff and computing
    the hash.
    """
...
class Summary(betterproto.Message):
    ...
    summary: "ImageSummary" = betterproto.message_field(2)
    """summary is the image diff summary."""

    errors: "ImageErrors" = betterproto.message_field(3)
    """
    errors are the image errors encountered while validating the image. These
    are displayed on the change control review page (for changes made outside
    the workspace).
    """

    warnings: "ImageWarnings" = betterproto.message_field(4)
    """
    warnings are the image warnings encountered while validating the image.
    These are displayed on the change control review page (for changes made
    outside the workspace).
    """


@dataclass(eq=False, repr=False)
class ImageError(betterproto.Message):
    """ImageError wraps `ErrorCode` enum with a reason string."""

    sku: Optional[str] = betterproto.message_field(1, wraps=betterproto.TYPE_STRING)
    """sku represents the name of the sku."""

    error_code: "ErrorCode" = betterproto.enum_field(2)
...
@dataclass(eq=False, repr=False)
class ImageErrors(betterproto.Message):
    """
    ImageErrors is the list of errors reported by CVP when handling image
    validations.
    """

    values: List["ImageError"] = betterproto.message_field(1)
    """values is a list of image errors."""


@dataclass(eq=False, repr=False)
class ImageWarning(betterproto.Message):
    """ImageWarning wraps `WarningCode` enum with a reason string."""

    sku: Optional[str] = betterproto.message_field(1, wraps=betterproto.TYPE_STRING)
    """sku represents the name of the sku."""

    warning_code: "WarningCode" = betterproto.enum_field(2)
    """warning_code is the warning code."""

    warning_msg: Optional[str] = betterproto.message_field(
        3, wraps=betterproto.TYPE_STRING
    )
...
@dataclass(eq=False, repr=False)
class ImageWarnings(betterproto.Message):
    """
    ImageWarnings is the list of warnings reported by CVP when handling image
    validations.
    """

    values: List["ImageWarning"] = betterproto.message_field(1)
...
class SummaryStreamRequest(betterproto.Message):
    ...
    end: Returns the state of each Summary at end.     * Each Summary response
    is fully-specified (all fields set).   * start: Returns the state of each
    Summary at start, followed by updates until now.     * Each Summary
    response at start is fully-specified, but updates may be partial.   * start
    and end: Returns the state of each Summary at start, followed by updates
    until end.     * Each Summary response at start is fully-specified, but
    updates until end may       be partial. This field is not allowed in the
    Subscribe RPC.
    """
