...
def load_python_class(search_dict: dict, search_path: str, default_module: str, default_class_name: str, parent_class: str) -> type:
    """
    ...
    module_path = get(search_dict, ".".join(filter(None, [search_path, "python_module"])), default_module)
    class_name = get(search_dict, ".".join(filter(None, [search_path, "python_class_name"])), default_class_name)
