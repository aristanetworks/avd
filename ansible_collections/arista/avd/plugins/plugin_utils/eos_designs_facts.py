...
class EosDesignsFacts(AvdFacts):
    ...
    def ipvpn_gateway(self) -> dict | None:
        ...
        if get(self.overlay, "ipvpn_gateway"):
            return {
                "evpn_domain_id": get(self._switch_data_combined, "ipvpn_gateway.evpn_domain_id", default="1:1"),
                "ipvpn_domain_id": get(self._switch_data_combined, "ipvpn_gateway.ipvpn_domain_id", default="1:2"),
