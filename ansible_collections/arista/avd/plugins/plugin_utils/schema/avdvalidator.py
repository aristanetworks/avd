...
def _formats_validator(validator, formats: list[str], instance: str, schema: dict):
    if not validator.is_type(instance, "string"):
        # Silently ignore invalid type. Will be caught by type-validator
        return

    if not formats:
        # Silently ignore empty formats list
    ...
    for test_format in formats:
        # Example regex(blah) uses regex validator
