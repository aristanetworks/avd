...
class PtpMixin:
    ...
    @cached_property
    def mlag_ptp_enabled(self: SharedUtils) -> bool:
        default_mlag_ptp = get(self.hostvars, "mlag_ptp")
        return get(self.switch_data_combined, "mlag_ptp", default=default_mlag_ptp) is True
