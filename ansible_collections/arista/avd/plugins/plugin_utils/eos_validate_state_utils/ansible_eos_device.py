    ...
    def __init__(self, name: str, connection: ConnectionBase, tags: list | None = None, *, check_mode: bool = False) -> None:
        ...
        try:
            ...
            raise AristaAvdError(
                message="AVD could not determine the Ansible connection plugin used. Please ensure that the 'ansible_network_os' and 'ansible_connection' variables are set to 'eos' and 'httpapi' respectively for this host."
            ) from err
