  ...
  workspace:
    ...
    suboptions:
      ...
      max_sync_retries:
        ...
        default: 5
  change_control:
    description: CloudVision Change Control to create for the deployment or an existing Change Control to manage by ID.
    type: dict
    suboptions:
      id:
        description: |-
          Existing Change Control ID. It cannot be combined with a Workspace ID, configurations, tags, metadata,
          or a non-empty static config manifest.
        type: str
      name:
        description: Optional name to use for the Change Control. By default the name generated by CloudVision will be kept.
        type: str
      description:
      ...
      start_note:
        ...
        type: str
        default: Automatically started by AVD
      requested_state:
        description: |-
