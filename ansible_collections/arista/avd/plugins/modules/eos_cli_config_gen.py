...
options:
  ...
  directory_mode:
    ...
    default: "0o775"
    description:
      - Directory permissions mode (octal string) to be applied to all directories created by the module.
  file_mode:
    type: str
    default: "0o664"
    description:
      - File permissions mode (octal string) to be applied to all files generated by the module.
"""
