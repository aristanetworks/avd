...
notes:
  ...
  - The file naming convention is hard coded as "<inventory_hostname>-results.json" and cannot be change. This ensures that the report
  ...
  - Regardless of whether they are running in C(check_mode) or not, the reports are generated by the `eos_validate_state_reports` plugin.
"""
