...
def strip_empties_from_list(data, strip_values_tuple=(None, str(), [], {},)):
    """
    ...
    strip_values_tuple : tuple, optional
        Value to remove from data, by default (None, str(), [], {},)
...
def strip_empties_from_dict(data, strip_values_tuple=(None, str(), [], {},)):
    """
