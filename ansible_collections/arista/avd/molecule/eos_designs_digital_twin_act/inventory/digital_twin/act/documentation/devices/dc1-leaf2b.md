...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.16.1.104/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF2 | Vlan4094 | 10.255.1.68 | Port-Channel9 |
...
!
interface Ethernet9
   description MLAG_dc1-leaf2a_Ethernet9
   no shutdown
   channel-group 9 mode active
!
interface Ethernet10
   description MLAG_dc1-leaf2a_Ethernet10
   no shutdown
   channel-group 9 mode active
!
...
| Port-Channel9 | MLAG_dc1-leaf2a_Port-Channel9 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel9
   description MLAG_dc1-leaf2a_Port-Channel9
   no shutdown
   switchport mode trunk
