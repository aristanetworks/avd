...
To prevent the automatic convertion, this molecule scenario run with the environment
variable "AVD_DISABLE_CONVERT_DICTS=TRUE" which disables the convertion.
