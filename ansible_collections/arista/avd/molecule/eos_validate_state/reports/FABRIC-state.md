...
| 279 | dc1-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.0.5 | NOT RUN | - |
...
| 316 | dc1-spine2 | Hardware | Verifies if the power supplies status are within the accepted states list. | VerifyEnvironmentPower | NOT RUN | - |
...
| 390 | dc2-leaf1a | Routing Table | Remote Lo0 address | 10.255.128.11 | NOT RUN | - |
...
| 427 | dc2-leaf1b | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan11 - VRF10_VLAN11 | NOT RUN | - |
...
| 464 | dc2-leaf1b | Routing Table | Remote Lo0 address | 10.255.128.12 | NOT RUN | - |
...
| 501 | dc2-leaf2a | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet1 - P2P_LINK_TO_DC2-SPINE1_Ethernet3 | NOT RUN | - |
...
| 538 | dc2-leaf2a | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2a - 10.255.128.15/32 Destination: 10.255.128.11 | NOT RUN | - |
...
| 575 | dc2-leaf2b | Hardware | Verifies if the power supplies status are within the accepted states list. | VerifyEnvironmentPower | NOT RUN | - |
...
| 583 | dc2-leaf2b | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet8 - DC2-LEAF2C_Ethernet2 | NOT RUN | - |
| 584 | dc2-leaf2b | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback0 - EVPN_Overlay_Peering | NOT RUN | - |
| 585 | dc2-leaf2b | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback1 - VTEP_VXLAN_Tunnel_Source | NOT RUN | - |
| 586 | dc2-leaf2b | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback10 - VRF10_VTEP_DIAGNOSTICS | NOT RUN | - |
| 587 | dc2-leaf2b | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback11 - VRF11_VTEP_DIAGNOSTICS | NOT RUN | - |
| 588 | dc2-leaf2b | Interface State | Port-Channel Interface & Line Protocol == 'up' | Port-Channel3 - MLAG_PEER_dc2-leaf2a_Po3 | NOT RUN | - |
| 589 | dc2-leaf2b | Interface State | Port-Channel Interface & Line Protocol == 'up' | Port-Channel5 - dc2-leaf2-server1_PortChannel dc2-leaf2-server1 | NOT RUN | - |
| 590 | dc2-leaf2b | Interface State | Port-Channel Interface & Line Protocol == 'up' | Port-Channel8 - DC2-LEAF2C_Po1 | NOT RUN | - |
| 591 | dc2-leaf2b | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan11 - VRF10_VLAN11 | NOT RUN | - |
| 592 | dc2-leaf2b | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan12 - VRF10_VLAN12 | NOT RUN | - |
| 593 | dc2-leaf2b | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan21 - VRF11_VLAN21 | NOT RUN | - |
| 594 | dc2-leaf2b | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan22 - VRF11_VLAN22 | NOT RUN | - |
| 595 | dc2-leaf2b | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan3009 - MLAG_PEER_L3_iBGP: vrf VRF10 | NOT RUN | - |
| 596 | dc2-leaf2b | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan3010 - MLAG_PEER_L3_iBGP: vrf VRF11 | NOT RUN | - |
| 597 | dc2-leaf2b | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan4093 - MLAG_PEER_L3_PEERING | NOT RUN | - |
| 598 | dc2-leaf2b | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan4094 - MLAG_PEER | NOT RUN | - |
| 599 | dc2-leaf2b | Interface State | Vxlan Interface Status & Line Protocol == 'up' | Vxlan1 | NOT RUN | - |
| 600 | dc2-leaf2b | IP Reachability | ip reachability test p2p links | Source: dc2-leaf2b_Ethernet1 - Destination: dc2-spine1_Ethernet4 | NOT RUN | - |
| 601 | dc2-leaf2b | IP Reachability | ip reachability test p2p links | Source: dc2-leaf2b_Ethernet2 - Destination: dc2-spine2_Ethernet4 | NOT RUN | - |
| 602 | dc2-leaf2b | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet1 - remote: dc2-spine1_Ethernet4 | NOT RUN | - |
| 603 | dc2-leaf2b | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet2 - remote: dc2-spine2_Ethernet4 | NOT RUN | - |
| 604 | dc2-leaf2b | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet3 - remote: dc2-leaf2a_Ethernet3 | NOT RUN | - |
| 605 | dc2-leaf2b | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet4 - remote: dc2-leaf2a_Ethernet4 | NOT RUN | - |
| 606 | dc2-leaf2b | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet8 - remote: dc2-leaf2c_Ethernet2 | NOT RUN | - |
| 607 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.0.1 | NOT RUN | - |
| 608 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.0.2 | NOT RUN | - |
| 609 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.0.3 | NOT RUN | - |
| 610 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.0.4 | NOT RUN | - |
| 611 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.0.5 | NOT RUN | - |
| 612 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.128.11 | NOT RUN | - |
| 613 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.128.12 | NOT RUN | - |
| 614 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.128.13 | NOT RUN | - |
| 615 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.128.14 | NOT RUN | - |
| 616 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.128.15 | NOT RUN | - |
| 617 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.128.16 | NOT RUN | - |
| 618 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.128.17 | NOT RUN | - |
| 619 | dc2-leaf2b | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf2b - 10.255.128.16/32 Destination: 10.255.128.18 | NOT RUN | - |
| 620 | dc2-leaf2b | MLAG | This test verifies the health status of the MLAG configuration. | VerifyMlagStatus | NOT RUN | - |
| 621 | dc2-leaf2b | NTP | Synchronised with NTP server | NTP | NOT RUN | - |
| 622 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.0.1 | NOT RUN | - |
| 623 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.0.2 | NOT RUN | - |
| 624 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.0.3 | NOT RUN | - |
| 625 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.0.4 | NOT RUN | - |
| 626 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.0.5 | NOT RUN | - |
| 627 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.128.11 | NOT RUN | - |
| 628 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.128.12 | NOT RUN | - |
| 629 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.128.13 | NOT RUN | - |
| 630 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.128.14 | NOT RUN | - |
| 631 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.128.15 | NOT RUN | - |
| 632 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.128.16 | NOT RUN | - |
| 633 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.128.17 | NOT RUN | - |
| 634 | dc2-leaf2b | Routing Table | Remote Lo0 address | 10.255.128.18 | NOT RUN | - |
| 635 | dc2-leaf2b | Routing Table | Remote VTEP address | 10.255.1.3 | NOT RUN | - |
| 636 | dc2-leaf2b | Routing Table | Remote VTEP address | 10.255.1.5 | NOT RUN | - |
| 637 | dc2-leaf2b | Routing Table | Remote VTEP address | 10.255.129.13 | NOT RUN | - |
| 638 | dc2-leaf2b | Routing Table | Remote VTEP address | 10.255.129.15 | NOT RUN | - |
| 639 | dc2-leaf2b | Routing Table | Remote VTEP address | 10.255.129.17 | NOT RUN | - |
| 640 | dc2-leaf2b | Security | Verifies if eAPI HTTPS server SSL profile is configured and valid. | VerifyAPIHttpsSSL | NOT RUN | - |
| 641 | dc2-leaf2c | Hardware | Verifies if the device temperature is within the acceptable range. | VerifyTemperature | NOT RUN | - |
| 642 | dc2-leaf2c | Hardware | Verifies if the fans status are within the accepted states list. | VerifyEnvironmentCooling | NOT RUN | - |
| 643 | dc2-leaf2c | Hardware | Verifies if the power supplies status are within the accepted states list. | VerifyEnvironmentPower | NOT RUN | - |
| 644 | dc2-leaf2c | Hardware | Verifies the transceiver's manufacturer against a list of approved manufacturers. | VerifyTransceiversManufacturers | NOT RUN | - |
| 645 | dc2-leaf2c | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet1 - DC2-LEAF2A_Ethernet8 | NOT RUN | - |
| 646 | dc2-leaf2c | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet2 - DC2-LEAF2B_Ethernet8 | NOT RUN | - |
| 647 | dc2-leaf2c | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet5 - dc2-leaf2-server1_iLO | NOT RUN | - |
| 648 | dc2-leaf2c | Interface State | Port-Channel Interface & Line Protocol == 'up' | Port-Channel1 - DC2_L3_LEAF2_Po8 | NOT RUN | - |
| 649 | dc2-leaf2c | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet1 - remote: dc2-leaf2a_Ethernet8 | NOT RUN | - |
| 650 | dc2-leaf2c | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet2 - remote: dc2-leaf2b_Ethernet8 | NOT RUN | - |
| 651 | dc2-leaf2c | NTP | Synchronised with NTP server | NTP | NOT RUN | - |
| 652 | dc2-leaf2c | Security | Verifies if eAPI HTTPS server SSL profile is configured and valid. | VerifyAPIHttpsSSL | NOT RUN | - |
| 653 | dc2-leaf3a.arista.com | BGP | Verifies the configured routing protocol model. | Routing protocol model: multi-agent | NOT RUN | - |
| 654 | dc2-leaf3a.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.11 | NOT RUN | - |
| 655 | dc2-leaf3a.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.12 | NOT RUN | - |
| 656 | dc2-leaf3a.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.129.125 | NOT RUN | - |
| 657 | dc2-leaf3a.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.120 | NOT RUN | - |
| 658 | dc2-leaf3a.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.122 | NOT RUN | - |
| 659 | dc2-leaf3a.arista.com | Hardware | Verifies if the device temperature is within the acceptable range. | VerifyTemperature | NOT RUN | - |
| 660 | dc2-leaf3a.arista.com | Hardware | Verifies if the fans status are within the accepted states list. | VerifyEnvironmentCooling | NOT RUN | - |
| 661 | dc2-leaf3a.arista.com | Hardware | Verifies if the power supplies status are within the accepted states list. | VerifyEnvironmentPower | NOT RUN | - |
| 662 | dc2-leaf3a.arista.com | Hardware | Verifies the transceiver's manufacturer against a list of approved manufacturers. | VerifyTransceiversManufacturers | NOT RUN | - |
| 663 | dc2-leaf3a.arista.com | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet1 - P2P_LINK_TO_DC2-SPINE1_Ethernet5 | NOT RUN | - |
| 664 | dc2-leaf3a.arista.com | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet11 - dc2-leaf3-fw1_e1 | NOT RUN | - |
| 665 | dc2-leaf3a.arista.com | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet2 - P2P_LINK_TO_DC2-SPINE2_Ethernet5 | NOT RUN | - |
| 666 | dc2-leaf3a.arista.com | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet3 - MLAG_PEER_dc2-leaf3b.arista.com_Ethernet3 | NOT RUN | - |
| 667 | dc2-leaf3a.arista.com | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet4 - MLAG_PEER_dc2-leaf3b.arista.com_Ethernet4 | NOT RUN | - |
| 668 | dc2-leaf3a.arista.com | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback0 - EVPN_Overlay_Peering | NOT RUN | - |
| 669 | dc2-leaf3a.arista.com | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback1 - VTEP_VXLAN_Tunnel_Source | NOT RUN | - |
| 670 | dc2-leaf3a.arista.com | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback10 - VRF10_VTEP_DIAGNOSTICS | NOT RUN | - |
| 671 | dc2-leaf3a.arista.com | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback11 - VRF11_VTEP_DIAGNOSTICS | NOT RUN | - |
| 672 | dc2-leaf3a.arista.com | Interface State | Port-Channel Interface & Line Protocol == 'up' | Port-Channel11 - dc2-leaf3-fw1_PortChannel | NOT RUN | - |
| 673 | dc2-leaf3a.arista.com | Interface State | Port-Channel Interface & Line Protocol == 'up' | Port-Channel3 - MLAG_PEER_dc2-leaf3b.arista.com_Po3 | NOT RUN | - |
| 674 | dc2-leaf3a.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan11 - VRF10_VLAN11 | NOT RUN | - |
| 675 | dc2-leaf3a.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan12 - VRF10_VLAN12 | NOT RUN | - |
| 676 | dc2-leaf3a.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan21 - VRF11_VLAN21 | NOT RUN | - |
| 677 | dc2-leaf3a.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan22 - VRF11_VLAN22 | NOT RUN | - |
| 678 | dc2-leaf3a.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan3009 - MLAG_PEER_L3_iBGP: vrf VRF10 | NOT RUN | - |
| 679 | dc2-leaf3a.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan3010 - MLAG_PEER_L3_iBGP: vrf VRF11 | NOT RUN | - |
| 680 | dc2-leaf3a.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan4093 - MLAG_PEER_L3_PEERING | NOT RUN | - |
| 681 | dc2-leaf3a.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan4094 - MLAG_PEER | NOT RUN | - |
| 682 | dc2-leaf3a.arista.com | Interface State | Vxlan Interface Status & Line Protocol == 'up' | Vxlan1 | NOT RUN | - |
| 683 | dc2-leaf3a.arista.com | IP Reachability | ip reachability test p2p links | Source: dc2-leaf3a.arista.com_Ethernet1 - Destination: dc2-spine1_Ethernet5 | NOT RUN | - |
| 684 | dc2-leaf3a.arista.com | IP Reachability | ip reachability test p2p links | Source: dc2-leaf3a.arista.com_Ethernet2 - Destination: dc2-spine2_Ethernet5 | NOT RUN | - |
| 685 | dc2-leaf3a.arista.com | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet1 - remote: dc2-spine1_Ethernet5 | NOT RUN | - |
| 686 | dc2-leaf3a.arista.com | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet2 - remote: dc2-spine2_Ethernet5 | NOT RUN | - |
| 687 | dc2-leaf3a.arista.com | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet3 - remote: dc2-leaf3b.arista.com_Ethernet3 | NOT RUN | - |
| 688 | dc2-leaf3a.arista.com | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet4 - remote: dc2-leaf3b.arista.com_Ethernet4 | NOT RUN | - |
| 689 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.0.1 | NOT RUN | - |
| 690 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.0.2 | NOT RUN | - |
| 691 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.0.3 | NOT RUN | - |
| 692 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.0.4 | NOT RUN | - |
| 693 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.0.5 | NOT RUN | - |
| 694 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.128.11 | NOT RUN | - |
| 695 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.128.12 | NOT RUN | - |
| 696 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.128.13 | NOT RUN | - |
| 697 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.128.14 | NOT RUN | - |
| 698 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.128.15 | NOT RUN | - |
| 699 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.128.16 | NOT RUN | - |
| 700 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.128.17 | NOT RUN | - |
| 701 | dc2-leaf3a.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3a.arista.com - 10.255.128.17/32 Destination: 10.255.128.18 | NOT RUN | - |
| 702 | dc2-leaf3a.arista.com | MLAG | This test verifies the health status of the MLAG configuration. | VerifyMlagStatus | NOT RUN | - |
| 703 | dc2-leaf3a.arista.com | NTP | Synchronised with NTP server | NTP | NOT RUN | - |
| 704 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.0.1 | NOT RUN | - |
| 705 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.0.2 | NOT RUN | - |
| 706 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.0.3 | NOT RUN | - |
| 707 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.0.4 | NOT RUN | - |
| 708 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.0.5 | NOT RUN | - |
| 709 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.128.11 | NOT RUN | - |
| 710 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.128.12 | NOT RUN | - |
| 711 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.128.13 | NOT RUN | - |
| 712 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.128.14 | NOT RUN | - |
| 713 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.128.15 | NOT RUN | - |
| 714 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.128.16 | NOT RUN | - |
| 715 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.128.17 | NOT RUN | - |
| 716 | dc2-leaf3a.arista.com | Routing Table | Remote Lo0 address | 10.255.128.18 | NOT RUN | - |
| 717 | dc2-leaf3a.arista.com | Routing Table | Remote VTEP address | 10.255.1.3 | NOT RUN | - |
| 718 | dc2-leaf3a.arista.com | Routing Table | Remote VTEP address | 10.255.1.5 | NOT RUN | - |
| 719 | dc2-leaf3a.arista.com | Routing Table | Remote VTEP address | 10.255.129.13 | NOT RUN | - |
| 720 | dc2-leaf3a.arista.com | Routing Table | Remote VTEP address | 10.255.129.15 | NOT RUN | - |
| 721 | dc2-leaf3a.arista.com | Routing Table | Remote VTEP address | 10.255.129.17 | NOT RUN | - |
| 722 | dc2-leaf3a.arista.com | Security | Verifies if eAPI HTTPS server SSL profile is configured and valid. | VerifyAPIHttpsSSL | NOT RUN | - |
| 723 | dc2-leaf3b.arista.com | BGP | Verifies the configured routing protocol model. | Routing protocol model: multi-agent | NOT RUN | - |
| 724 | dc2-leaf3b.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.11 | NOT RUN | - |
| 725 | dc2-leaf3b.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.12 | NOT RUN | - |
| 726 | dc2-leaf3b.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.129.124 | NOT RUN | - |
| 727 | dc2-leaf3b.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.124 | NOT RUN | - |
| 728 | dc2-leaf3b.arista.com | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.126 | NOT RUN | - |
| 729 | dc2-leaf3b.arista.com | Hardware | Verifies if the device temperature is within the acceptable range. | VerifyTemperature | NOT RUN | - |
| 730 | dc2-leaf3b.arista.com | Hardware | Verifies if the fans status are within the accepted states list. | VerifyEnvironmentCooling | NOT RUN | - |
| 731 | dc2-leaf3b.arista.com | Hardware | Verifies if the power supplies status are within the accepted states list. | VerifyEnvironmentPower | NOT RUN | - |
| 732 | dc2-leaf3b.arista.com | Hardware | Verifies the transceiver's manufacturer against a list of approved manufacturers. | VerifyTransceiversManufacturers | NOT RUN | - |
| 733 | dc2-leaf3b.arista.com | Interface State | Ethernet Interface & Line Protocol == 'adminDown' | Ethernet11 - dc2-leaf3-fw1_e1 | NOT RUN | - |
| 734 | dc2-leaf3b.arista.com | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet1 - P2P_LINK_TO_DC2-SPINE1_Ethernet6 | NOT RUN | - |
| 735 | dc2-leaf3b.arista.com | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet2 - P2P_LINK_TO_DC2-SPINE2_Ethernet6 | NOT RUN | - |
| 736 | dc2-leaf3b.arista.com | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet3 - MLAG_PEER_dc2-leaf3a.arista.com_Ethernet3 | NOT RUN | - |
| 737 | dc2-leaf3b.arista.com | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet4 - MLAG_PEER_dc2-leaf3a.arista.com_Ethernet4 | NOT RUN | - |
| 738 | dc2-leaf3b.arista.com | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback0 - EVPN_Overlay_Peering | NOT RUN | - |
| 739 | dc2-leaf3b.arista.com | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback1 - VTEP_VXLAN_Tunnel_Source | NOT RUN | - |
| 740 | dc2-leaf3b.arista.com | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback10 - VRF10_VTEP_DIAGNOSTICS | NOT RUN | - |
| 741 | dc2-leaf3b.arista.com | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback11 - VRF11_VTEP_DIAGNOSTICS | NOT RUN | - |
| 742 | dc2-leaf3b.arista.com | Interface State | Port-Channel Interface & Line Protocol == 'up' | Port-Channel11 - dc2-leaf3-fw1_PortChannel | NOT RUN | - |
| 743 | dc2-leaf3b.arista.com | Interface State | Port-Channel Interface & Line Protocol == 'up' | Port-Channel3 - MLAG_PEER_dc2-leaf3a.arista.com_Po3 | NOT RUN | - |
| 744 | dc2-leaf3b.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan11 - VRF10_VLAN11 | NOT RUN | - |
| 745 | dc2-leaf3b.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan12 - VRF10_VLAN12 | NOT RUN | - |
| 746 | dc2-leaf3b.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan21 - VRF11_VLAN21 | NOT RUN | - |
| 747 | dc2-leaf3b.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan22 - VRF11_VLAN22 | NOT RUN | - |
| 748 | dc2-leaf3b.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan3009 - MLAG_PEER_L3_iBGP: vrf VRF10 | NOT RUN | - |
| 749 | dc2-leaf3b.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan3010 - MLAG_PEER_L3_iBGP: vrf VRF11 | NOT RUN | - |
| 750 | dc2-leaf3b.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan4093 - MLAG_PEER_L3_PEERING | NOT RUN | - |
| 751 | dc2-leaf3b.arista.com | Interface State | Vlan Interface & Line Protocol == 'up' | Vlan4094 - MLAG_PEER | NOT RUN | - |
| 752 | dc2-leaf3b.arista.com | Interface State | Vxlan Interface Status & Line Protocol == 'up' | Vxlan1 | NOT RUN | - |
| 753 | dc2-leaf3b.arista.com | IP Reachability | ip reachability test p2p links | Source: dc2-leaf3b.arista.com_Ethernet1 - Destination: dc2-spine1_Ethernet6 | NOT RUN | - |
| 754 | dc2-leaf3b.arista.com | IP Reachability | ip reachability test p2p links | Source: dc2-leaf3b.arista.com_Ethernet2 - Destination: dc2-spine2_Ethernet6 | NOT RUN | - |
| 755 | dc2-leaf3b.arista.com | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet1 - remote: dc2-spine1_Ethernet6 | NOT RUN | - |
| 756 | dc2-leaf3b.arista.com | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet2 - remote: dc2-spine2_Ethernet6 | NOT RUN | - |
| 757 | dc2-leaf3b.arista.com | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet3 - remote: dc2-leaf3a.arista.com_Ethernet3 | NOT RUN | - |
| 758 | dc2-leaf3b.arista.com | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet4 - remote: dc2-leaf3a.arista.com_Ethernet4 | NOT RUN | - |
| 759 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.0.1 | NOT RUN | - |
| 760 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.0.2 | NOT RUN | - |
| 761 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.0.3 | NOT RUN | - |
| 762 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.0.4 | NOT RUN | - |
| 763 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.0.5 | NOT RUN | - |
| 764 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.128.11 | NOT RUN | - |
| 765 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.128.12 | NOT RUN | - |
| 766 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.128.13 | NOT RUN | - |
| 767 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.128.14 | NOT RUN | - |
| 768 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.128.15 | NOT RUN | - |
| 769 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.128.16 | NOT RUN | - |
| 770 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.128.17 | NOT RUN | - |
| 771 | dc2-leaf3b.arista.com | Loopback0 Reachability | Loopback0 Reachability | Source: dc2-leaf3b.arista.com - 10.255.128.18/32 Destination: 10.255.128.18 | NOT RUN | - |
| 772 | dc2-leaf3b.arista.com | MLAG | This test verifies the health status of the MLAG configuration. | VerifyMlagStatus | NOT RUN | - |
| 773 | dc2-leaf3b.arista.com | NTP | Synchronised with NTP server | NTP | NOT RUN | - |
| 774 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.0.1 | NOT RUN | - |
| 775 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.0.2 | NOT RUN | - |
| 776 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.0.3 | NOT RUN | - |
| 777 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.0.4 | NOT RUN | - |
| 778 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.0.5 | NOT RUN | - |
| 779 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.128.11 | NOT RUN | - |
| 780 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.128.12 | NOT RUN | - |
| 781 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.128.13 | NOT RUN | - |
| 782 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.128.14 | NOT RUN | - |
| 783 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.128.15 | NOT RUN | - |
| 784 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.128.16 | NOT RUN | - |
| 785 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.128.17 | NOT RUN | - |
| 786 | dc2-leaf3b.arista.com | Routing Table | Remote Lo0 address | 10.255.128.18 | NOT RUN | - |
| 787 | dc2-leaf3b.arista.com | Routing Table | Remote VTEP address | 10.255.1.3 | NOT RUN | - |
| 788 | dc2-leaf3b.arista.com | Routing Table | Remote VTEP address | 10.255.1.5 | NOT RUN | - |
| 789 | dc2-leaf3b.arista.com | Routing Table | Remote VTEP address | 10.255.129.13 | NOT RUN | - |
| 790 | dc2-leaf3b.arista.com | Routing Table | Remote VTEP address | 10.255.129.15 | NOT RUN | - |
| 791 | dc2-leaf3b.arista.com | Routing Table | Remote VTEP address | 10.255.129.17 | NOT RUN | - |
| 792 | dc2-leaf3b.arista.com | Security | Verifies if eAPI HTTPS server SSL profile is configured and valid. | VerifyAPIHttpsSSL | NOT RUN | - |
| 793 | dc2-spine1 | BGP | Verifies the configured routing protocol model. | Routing protocol model: multi-agent | NOT RUN | - |
| 794 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.13 | NOT RUN | - |
| 795 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.14 | NOT RUN | - |
| 796 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.15 | NOT RUN | - |
| 797 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.16 | NOT RUN | - |
| 798 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.17 | NOT RUN | - |
| 799 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.18 | NOT RUN | - |
| 800 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.105 | NOT RUN | - |
| 801 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.109 | NOT RUN | - |
| 802 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.113 | NOT RUN | - |
| 803 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.117 | NOT RUN | - |
| 804 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.121 | NOT RUN | - |
| 805 | dc2-spine1 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.125 | NOT RUN | - |
| 806 | dc2-spine1 | Hardware | Verifies if the device temperature is within the acceptable range. | VerifyTemperature | NOT RUN | - |
| 807 | dc2-spine1 | Hardware | Verifies if the fans status are within the accepted states list. | VerifyEnvironmentCooling | NOT RUN | - |
| 808 | dc2-spine1 | Hardware | Verifies if the power supplies status are within the accepted states list. | VerifyEnvironmentPower | NOT RUN | - |
| 809 | dc2-spine1 | Hardware | Verifies the transceiver's manufacturer against a list of approved manufacturers. | VerifyTransceiversManufacturers | NOT RUN | - |
| 810 | dc2-spine1 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet1 - P2P_LINK_TO_DC2-LEAF1A_Ethernet1 | NOT RUN | - |
| 811 | dc2-spine1 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet2 - P2P_LINK_TO_DC2-LEAF1B_Ethernet1 | NOT RUN | - |
| 812 | dc2-spine1 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet3 - P2P_LINK_TO_DC2-LEAF2A_Ethernet1 | NOT RUN | - |
| 813 | dc2-spine1 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet4 - P2P_LINK_TO_DC2-LEAF2B_Ethernet1 | NOT RUN | - |
| 814 | dc2-spine1 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet5 - P2P_LINK_TO_DC2-LEAF3A.ARISTA.COM_Ethernet1 | NOT RUN | - |
| 815 | dc2-spine1 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet6 - P2P_LINK_TO_DC2-LEAF3B.ARISTA.COM_Ethernet1 | NOT RUN | - |
| 816 | dc2-spine1 | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback0 - EVPN_Overlay_Peering | NOT RUN | - |
| 817 | dc2-spine1 | IP Reachability | ip reachability test p2p links | Source: dc2-spine1_Ethernet1 - Destination: dc2-leaf1a_Ethernet1 | NOT RUN | - |
| 818 | dc2-spine1 | IP Reachability | ip reachability test p2p links | Source: dc2-spine1_Ethernet2 - Destination: dc2-leaf1b_Ethernet1 | NOT RUN | - |
| 819 | dc2-spine1 | IP Reachability | ip reachability test p2p links | Source: dc2-spine1_Ethernet3 - Destination: dc2-leaf2a_Ethernet1 | NOT RUN | - |
| 820 | dc2-spine1 | IP Reachability | ip reachability test p2p links | Source: dc2-spine1_Ethernet4 - Destination: dc2-leaf2b_Ethernet1 | NOT RUN | - |
| 821 | dc2-spine1 | IP Reachability | ip reachability test p2p links | Source: dc2-spine1_Ethernet5 - Destination: dc2-leaf3a.arista.com_Ethernet1 | NOT RUN | - |
| 822 | dc2-spine1 | IP Reachability | ip reachability test p2p links | Source: dc2-spine1_Ethernet6 - Destination: dc2-leaf3b.arista.com_Ethernet1 | NOT RUN | - |
| 823 | dc2-spine1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet1 - remote: dc2-leaf1a_Ethernet1 | NOT RUN | - |
| 824 | dc2-spine1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet2 - remote: dc2-leaf1b_Ethernet1 | NOT RUN | - |
| 825 | dc2-spine1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet3 - remote: dc2-leaf2a_Ethernet1 | NOT RUN | - |
| 826 | dc2-spine1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet4 - remote: dc2-leaf2b_Ethernet1 | NOT RUN | - |
| 827 | dc2-spine1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet5 - remote: dc2-leaf3a.arista.com_Ethernet1 | NOT RUN | - |
| 828 | dc2-spine1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet6 - remote: dc2-leaf3b.arista.com_Ethernet1 | NOT RUN | - |
| 829 | dc2-spine1 | NTP | Synchronised with NTP server | NTP | NOT RUN | - |
| 830 | dc2-spine1 | Security | Verifies if eAPI HTTPS server SSL profile is configured and valid. | VerifyAPIHttpsSSL | NOT RUN | - |
| 831 | dc2-spine2 | BGP | Verifies the configured routing protocol model. | Routing protocol model: multi-agent | NOT RUN | - |
| 832 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.13 | NOT RUN | - |
| 833 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.14 | NOT RUN | - |
| 834 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.15 | NOT RUN | - |
| 835 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.16 | NOT RUN | - |
| 836 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.17 | NOT RUN | - |
| 837 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP EVPN Peer: 10.255.128.18 | NOT RUN | - |
| 838 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.107 | NOT RUN | - |
| 839 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.111 | NOT RUN | - |
| 840 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.115 | NOT RUN | - |
| 841 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.119 | NOT RUN | - |
| 842 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.123 | NOT RUN | - |
| 843 | dc2-spine2 | BGP | Verifies the health of specific BGP peer(s). | BGP IPv4 Unicast Peer: 10.255.255.127 | NOT RUN | - |
| 844 | dc2-spine2 | Hardware | Verifies if the device temperature is within the acceptable range. | VerifyTemperature | NOT RUN | - |
| 845 | dc2-spine2 | Hardware | Verifies if the fans status are within the accepted states list. | VerifyEnvironmentCooling | NOT RUN | - |
| 846 | dc2-spine2 | Hardware | Verifies if the power supplies status are within the accepted states list. | VerifyEnvironmentPower | NOT RUN | - |
| 847 | dc2-spine2 | Hardware | Verifies the transceiver's manufacturer against a list of approved manufacturers. | VerifyTransceiversManufacturers | NOT RUN | - |
| 848 | dc2-spine2 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet1 - P2P_LINK_TO_DC2-LEAF1A_Ethernet2 | NOT RUN | - |
| 849 | dc2-spine2 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet2 - P2P_LINK_TO_DC2-LEAF1B_Ethernet2 | NOT RUN | - |
| 850 | dc2-spine2 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet3 - P2P_LINK_TO_DC2-LEAF2A_Ethernet2 | NOT RUN | - |
| 851 | dc2-spine2 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet4 - P2P_LINK_TO_DC2-LEAF2B_Ethernet2 | NOT RUN | - |
| 852 | dc2-spine2 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet5 - P2P_LINK_TO_DC2-LEAF3A.ARISTA.COM_Ethernet2 | NOT RUN | - |
| 853 | dc2-spine2 | Interface State | Ethernet Interface & Line Protocol == 'up' | Ethernet6 - P2P_LINK_TO_DC2-LEAF3B.ARISTA.COM_Ethernet2 | NOT RUN | - |
| 854 | dc2-spine2 | Interface State | Loopback Interface Status & Line Protocol == 'up' | Loopback0 - EVPN_Overlay_Peering | NOT RUN | - |
| 855 | dc2-spine2 | IP Reachability | ip reachability test p2p links | Source: dc2-spine2_Ethernet1 - Destination: dc2-leaf1a_Ethernet2 | NOT RUN | - |
| 856 | dc2-spine2 | IP Reachability | ip reachability test p2p links | Source: dc2-spine2_Ethernet2 - Destination: dc2-leaf1b_Ethernet2 | NOT RUN | - |
| 857 | dc2-spine2 | IP Reachability | ip reachability test p2p links | Source: dc2-spine2_Ethernet3 - Destination: dc2-leaf2a_Ethernet2 | NOT RUN | - |
| 858 | dc2-spine2 | IP Reachability | ip reachability test p2p links | Source: dc2-spine2_Ethernet4 - Destination: dc2-leaf2b_Ethernet2 | NOT RUN | - |
| 859 | dc2-spine2 | IP Reachability | ip reachability test p2p links | Source: dc2-spine2_Ethernet5 - Destination: dc2-leaf3a.arista.com_Ethernet2 | NOT RUN | - |
| 860 | dc2-spine2 | IP Reachability | ip reachability test p2p links | Source: dc2-spine2_Ethernet6 - Destination: dc2-leaf3b.arista.com_Ethernet2 | NOT RUN | - |
| 861 | dc2-spine2 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet1 - remote: dc2-leaf1a_Ethernet2 | NOT RUN | - |
| 862 | dc2-spine2 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet2 - remote: dc2-leaf1b_Ethernet2 | NOT RUN | - |
| 863 | dc2-spine2 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet3 - remote: dc2-leaf2a_Ethernet2 | NOT RUN | - |
| 864 | dc2-spine2 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet4 - remote: dc2-leaf2b_Ethernet2 | NOT RUN | - |
| 865 | dc2-spine2 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet5 - remote: dc2-leaf3a.arista.com_Ethernet2 | NOT RUN | - |
| 866 | dc2-spine2 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet6 - remote: dc2-leaf3b.arista.com_Ethernet2 | NOT RUN | - |
| 867 | dc2-spine2 | NTP | Synchronised with NTP server | NTP | NOT RUN | - |
| 868 | dc2-spine2 | Security | Verifies if eAPI HTTPS server SSL profile is configured and valid. | VerifyAPIHttpsSSL | NOT RUN | - |
