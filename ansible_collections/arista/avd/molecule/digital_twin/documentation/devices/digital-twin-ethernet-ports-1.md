...
| Ethernet10 | - | - | 192.168.3.164/31 | TENANT_A_VRF_A | - | False | - | - |
| Ethernet10.100 | - | - | 192.168.3.160/31 | TENANT_A_VRF_A | - | False | - | - |
| Ethernet10.101 | - | - | 192.168.3.162/31 | TENANT_A_VRF_A | - | False | - | - |
| Ethernet11 | P2P_digital.twin.ethernet.ports.2_Ethernet11 | - | 192.168.3.166/31 | default | 9214 | False | - | - |
| Ethernet11.100 | P2P_digital.twin.ethernet.ports.2_Ethernet11.100 | - | 192.168.3.168/31 | default | 9214 | False | - | - |
| Ethernet11.101 | P2P_digital.twin.ethernet.ports.2_Ethernet11.101 | - | 192.168.3.170/31 | default | 9214 | False | - | - |
...
| 192.168.3.167 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.3.169 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.3.171 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65001
   ...
   neighbor 192.168.3.167 remote-as 65001
   neighbor 192.168.3.167 description digital.twin.ethernet.ports.2
   neighbor 192.168.3.169 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.169 remote-as 65001
   neighbor 192.168.3.169 description digital.twin.ethernet.ports.2
   neighbor 192.168.3.171 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.171 remote-as 65001
   neighbor 192.168.3.171 description digital.twin.ethernet.ports.2
