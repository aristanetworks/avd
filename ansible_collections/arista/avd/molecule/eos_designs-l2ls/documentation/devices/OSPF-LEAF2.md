...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_OSPF-SPINE1_Ethernet2 | *trunk | *100,4092 | *- | *- | 1 |
| Ethernet2 | L2_OSPF-SPINE2_Ethernet2 | *trunk | *100,4092 | *- | *- | 1 |
...
| --------- | ----------- | ---- | ------------- |
| Ethernet1 | L2_OSPF-SPINE1_Ethernet2 | active | 1 |
| Ethernet2 | L2_OSPF-SPINE2_Ethernet2 | active | 1 |
...
| --------- | ----------- | --- | --- | -------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_OSPF_SPINES_Port-Channel2 | default | - | False | - | - | - | - |
