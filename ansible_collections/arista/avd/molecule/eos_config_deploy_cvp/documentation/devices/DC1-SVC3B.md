...
| --------- | ----------- | ---- | ------------- |
| Ethernet5 | MLAG_DC1-SVC3A_Ethernet5 | active | 5 |
| Ethernet6 | MLAG_DC1-SVC3A_Ethernet6 | active | 5 |
| Ethernet7 | L2_DC1-L2LEAF2A_Ethernet2 | active | 7 |
| Ethernet8 | L2_DC1-L2LEAF2B_Ethernet2 | active | 7 |
...
| --------- | ----------- | --- | --- | -------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_DC1-SVC3A_Port-Channel5 | default | - | False | - | - | - | - |
