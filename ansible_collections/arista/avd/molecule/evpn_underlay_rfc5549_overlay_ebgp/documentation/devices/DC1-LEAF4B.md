...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_DC1-LEAF4A_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_DC1-LEAF4A_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE6_Ethernet2 | routed | - | - | default | 1500 | false | - | - | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SPINE6_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ipv6 enable
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_DC1-LEAF4A_Po5 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_DC1-LEAF4A_Po5
   no shutdown
   switchport
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | EVPN_Overlay_Peering | default | 2001:1::f/128 |
...
| 10.255.251.18 | - | Tenant_A_APP_Zone | - | - | - | - | - | - |
| 10.255.251.18 | - | Tenant_A_DB_Zone | - | - | - | - | - | - |
| 10.255.251.18 | - | Tenant_A_OP_Zone | - | - | - | - | - | - |
| 10.255.251.18 | - | Tenant_A_WEB_Zone | - | - | - | - | - | - |
| 10.255.251.18 | - | Tenant_B_OP_Zone | - | - | - | - | - | - |
| 10.255.251.18 | - | Tenant_C_OP_Zone | - | - | - | - | - | - |
...
| Vlan4093 | MLAG_IPv6_UNDERLAY_PEER | 65107 | - |
...
router bgp 65107
   ...
   neighbor MLAG_IPv6_UNDERLAY_PEER remote-as 65107
   neighbor MLAG_IPv6_UNDERLAY_PEER next-hop-self
   neighbor MLAG_IPv6_UNDERLAY_PEER description DC1-LEAF4A
   ...
   neighbor interface Vlan4093 peer-group MLAG_IPv6_UNDERLAY_PEER remote-as 65107
