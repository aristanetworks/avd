...
| Sequence | Type | Match and/or Set |
| -------- | ---- | ---------------- |
| 10 | permit | set extcommunity soo 192.168.254.2:1 additive |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 192.168.254.2:1 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 192.168.254.2:1 |

### IP Extended Community Lists configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 192.168.254.2:1
```
