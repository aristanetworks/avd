...
| --------- | ----------- | ---- | ------------- |
| Ethernet5 | CUSTOM_MLAG_PEER_DC1-SVC3B_Ethernet5 | active | 5 |
| Ethernet6 | CUSTOM_MLAG_PEER_DC1-SVC3B_Ethernet6 | active | 5 |
| Ethernet7 | CUSTOM_DC1-L2LEAF2A_Ethernet1 | active | 7 |
| Ethernet8 | CUSTOM_DC1-L2LEAF2B_Ethernet1 | active | 7 |
| Ethernet10 | CUSTOM_server03_ESI_Eth1 | active | 10 |
| Ethernet14 | CUSTOM_server07_inherit_all_from_profile_port_channel_Eth1 | active | 14 |
| Ethernet15 | CUSTOM_server08_no_profile_port_channel_Eth1 | on | 15 |
| Ethernet17 | CUSTOM_server10_no_profile_port_channel_lacp_fallback_Eth1 | active | 17 |
| Ethernet18 | CUSTOM_server11_inherit_profile_port_channel_lacp_fallback_Eth1 | active | 18 |
| Ethernet19 | CUSTOM_server12_inherit_nested_profile_port_channel_lacp_fallback_Eth1 | active | 19 |
| Ethernet22 | CUSTOM_server15_port_channel_disabled_interfaces_Eth1 | active | 22 |
...
| --------- | ----------- | --- | --- | -------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | CUSTOM_MLAG_PEER_DC1-SVC3B_Po5 | default | - | False | - | - | - | - |
