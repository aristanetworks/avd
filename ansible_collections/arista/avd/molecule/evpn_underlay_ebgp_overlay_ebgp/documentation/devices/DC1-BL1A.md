...
!
interface Ethernet7
   description P2P_LINK_TO_DC1-BL1B_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_LINK_TO_DC1-BL1B_Ethernet8
   no shutdown
   mtu 1500
   no switchport
   ip address 100.100.101.101/24
!
...
| --- | ------------------- | ------------ |
| Tenant_A_WAN_Zone | 192.168.255.14:14 | connected  static |
