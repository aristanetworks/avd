...
| Tenant_A_DB_Zone | True | False |
| Tenant_A_OP_Zone | True | False |
| Tenant_A_WEB_Zone | True | False |
| Tenant_B_OP_Zone | True | False |
| Tenant_C_OP_Zone | True | False |
...
| Tenant_A_DB_Zone | enabled | disabled |
| Tenant_A_OP_Zone | enabled | disabled |
| Tenant_A_WEB_Zone | enabled | disabled |
| Tenant_B_OP_Zone | enabled | disabled |
| Tenant_C_OP_Zone | enabled | disabled |
