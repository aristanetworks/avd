...
| --------- | ----------- | ---- | ------------- |
| Ethernet1 | CUSTOM_DC1-LEAF2A_Ethernet7 | active | 1 |
| Ethernet2 | CUSTOM_DC1-LEAF2B_Ethernet7 | active | 1 |
| Ethernet3 | MLAG_DC1-L2LEAF1B_Ethernet3 | active | 3 |
| Ethernet4 | MLAG_DC1-L2LEAF1B_Ethernet4 | active | 3 |
...
| --------- | ----------- | --- | --- | -------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | CUSTOM_DC1-LEAF2A_Po7 | default | - | False | - | - | 1 | - |
| Port-Channel3 | MLAG_DC1-L2LEAF1B_Port-Channel3 | default | - | False | - | - | - | - |
