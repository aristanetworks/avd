...
| --------- | ----------- | --- | ---------- |
| Loopback0 | CUSTOM_EVPN_Overlay_Peering_LEAF2B | default | 192.168.255.11/32 |
| Loopback10 | CUSTOM_VTEP_VXLAN_Tunnel_Source_LEAF2B | default | 192.168.254.11/32 |
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | CUSTOM_EVPN_Overlay_Peering_LEAF2B | default | - |
| Loopback10 | CUSTOM_VTEP_VXLAN_Tunnel_Source_LEAF2B | default | - |
...
!
interface Loopback0
   description CUSTOM_EVPN_Overlay_Peering_LEAF2B
   no shutdown
   ip address 192.168.255.11/32
!
interface Loopback10
   description CUSTOM_VTEP_VXLAN_Tunnel_Source_LEAF2B
   no shutdown
