...
| 1.12.1.0/24 | True | ADV-MAP | True | RM-ATTRIBUTE | RM-MATCH | True |
...
router bgp 65101
   ...
   aggregate-address 1.12.1.0/24 as-set advertise-map ADV-MAP summary-only match-map RM-MATCH advertise-only
