...
router bgp 65100
   ...
   address-family evpn
      ...
      neighbor RCF_TEST rcf in Address-Family_EVPN_In()
      neighbor RCF_TEST rcf out Address-Family_EVPN_Out()
   !
   address-family ipv4
      ...
      neighbor TEST_RCF rcf in Address-Family_IPV4_In()
      neighbor TEST_RCF rcf out Address-Family_IPV4_Out()
   !
   ...
   address-family ipv6
      ...
      neighbor TEST_RCF rcf in Address-Family_IPV6_in()
      neighbor TEST_RCF rcf out Address-Family_IPV6_out()
   !
   vrf Tenant_A
