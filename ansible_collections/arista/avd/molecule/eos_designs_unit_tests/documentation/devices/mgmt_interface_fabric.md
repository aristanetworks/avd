...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| MY_INTERFACE_FABRIC | oob_management | oob | MGMT | -  | - |
...
| --------------- | ------- | -------- | ---------- | ----- |
| Switch System Mac | example@example.com | DC1_FABRIC mgmt_interface_fabric | All | Disabled |
