...
snmp-server location DC1_FABRIC MH-L2LEAF1A
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MH-LEAF2A_Ethernet2 | *trunk | *310 | *- | *- | 1 |
| Ethernet10 |  server02_Eth1 | access | - | - | - | - |
...
| --------- | ---------- | --------- |
| Ethernet10 | l2leaf-server02 | downstream |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MH-LEAF2A_Po2 | switched | trunk | 310 | - | - | - | - | - | - |

#### Link Tracking Groups

| Interface | Group Name | Direction |
| --------- | ---------- | --------- |
| Port-Channel1 | l2leaf-server02 | upstream |
