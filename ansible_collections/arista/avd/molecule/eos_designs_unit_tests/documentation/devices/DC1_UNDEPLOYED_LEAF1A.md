...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.200.121/24 | 192.168.200.5 |
...
| ------- | -------- | ---------- | ----- |
| example@example.com | EOS_DESIGNS_UNIT_TESTS DC1_UNDEPLOYED_LEAF1A | All | Disabled |
...
| --------- | --------------- | ------------ | --------- |
| DC1_UNDEPLOYED_LEAF1 | Vlan4092 | 10.255.252.25 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_DC1_UNDEPLOYED_LEAF1B_Ethernet5 | *trunk | *1-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_DC1_UNDEPLOYED_LEAF1B_Ethernet6 | *trunk | *1-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet16 | routed | - | 172.31.255.193/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet16 | routed | - | 172.31.255.195/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE3_Ethernet16 | routed | - | 172.31.255.197/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE4_Ethernet16 | routed | - | 172.31.255.199/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SPINE1_Ethernet16
   no shutdown
   mtu 1500
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SPINE2_Ethernet16
   no shutdown
   mtu 1500
   speed forced 100gfull
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_DC1-SPINE3_Ethernet16
   no shutdown
   mtu 1500
   speed forced 100gfull
   no switchport
   ip address 172.31.255.197/31
!
interface Ethernet4
   description P2P_LINK_TO_DC1-SPINE4_Ethernet16
   no shutdown
   mtu 1500
   speed forced 100gfull
   no switchport
   ip address 172.31.255.199/31
!
interface Ethernet5
   description MLAG_PEER_DC1_UNDEPLOYED_LEAF1B_Ethernet5
   no shutdown
   speed 100g
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_PEER_DC1_UNDEPLOYED_LEAF1B_Ethernet6
   no shutdown
   speed 100g
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_DC1_UNDEPLOYED_LEAF1B_Po5 | switched | trunk | 1-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_DC1_UNDEPLOYED_LEAF1B_Po5
   no shutdown
   switchport
...
| Loopback100 | Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | Tenant_A_OP_Zone | 10.255.1.21/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan2 |  Tenant_C_OP_Zone  |  10.255.251.24/31  |  -  |  -  |  -  |  -  |  -  |
...
| Vlan3019 |  Tenant_B_OP_Zone  |  10.255.251.24/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3020 |  Tenant_B_WAN_Zone  |  10.255.251.24/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3030 |  Tenant_C_WAN_Zone  |  10.255.251.24/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4090 |  default  |  10.255.251.24/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4092 |  default  |  10.255.252.24/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 10.255.251.25 | Inherited from peer group MLAG-PEERS | default | - | Inherited from peer group MLAG-PEERS | Inherited from peer group MLAG-PEERS | - | - | - |
| 172.31.255.192 | 65001 | default | - | Inherited from peer group UNDERLAY-PEERS | Inherited from peer group UNDERLAY-PEERS | - | - | - |
| 172.31.255.194 | 65001 | default | - | Inherited from peer group UNDERLAY-PEERS | Inherited from peer group UNDERLAY-PEERS | - | - | - |
| 172.31.255.196 | 65001 | default | - | Inherited from peer group UNDERLAY-PEERS | Inherited from peer group UNDERLAY-PEERS | - | - | - |
| 172.31.255.198 | 65001 | default | - | Inherited from peer group UNDERLAY-PEERS | Inherited from peer group UNDERLAY-PEERS | - | - | - |
...
| 10.255.251.25 | Inherited from peer group MLAG-PEERS | Tenant_A_APP_Zone | - | Inherited from peer group MLAG-PEERS | Inherited from peer group MLAG-PEERS | - | - | - |
...
| 10.255.251.25 | Inherited from peer group MLAG-PEERS | Tenant_C_WAN_Zone | - | Inherited from peer group MLAG-PEERS | Inherited from peer group MLAG-PEERS | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_APP_Zone | 192.168.255.21:12 | 12:12 | - | - | learned | 130-131 |
| Tenant_A_DB_Zone | 192.168.255.21:13 | 13:13 | - | - | learned | 140-141 |
| Tenant_A_NFS | 192.168.255.21:20161 | 20161:20161 | - | - | learned | 161 |
| Tenant_A_OP_Zone | 192.168.255.21:9 | 9:9 | - | - | learned | 110-112 |
| Tenant_A_VMOTION | 192.168.255.21:20160 | 20160:20160 | - | - | learned | 160 |
| Tenant_A_WAN_Zone | 192.168.255.21:14 | 14:14 | - | - | learned | 150 |
| Tenant_A_WEB_Zone | 192.168.255.21:11 | 11:11 | - | - | learned | 120-121 |
| Tenant_B_OP_Zone | 192.168.255.21:20 | 20:20 | - | - | learned | 210-211 |
| Tenant_B_WAN_Zone | 192.168.255.21:21 | 21:21 | - | - | learned | 250 |
| Tenant_C_OP_Zone | 192.168.255.21:30 | 30:30 | - | - | learned | 310-311 |
| Tenant_C_WAN_Zone | 192.168.255.21:31 | 31:31 | - | - | learned | 350 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_APP_Zone | 192.168.255.21:12 | connected |
| Tenant_A_DB_Zone | 192.168.255.21:13 | connected |
| Tenant_A_OP_Zone | 192.168.255.21:9 | connected |
| Tenant_A_WAN_Zone | 192.168.255.21:14 | connected |
| Tenant_A_WEB_Zone | 192.168.255.21:11 | connected |
| Tenant_B_OP_Zone | 192.168.255.21:20 | connected |
| Tenant_B_WAN_Zone | 192.168.255.21:21 | connected |
| Tenant_C_OP_Zone | 192.168.255.21:30 | connected |
| Tenant_C_WAN_Zone | 192.168.255.21:31 | connected |
...
router bgp 65110
   ...
   neighbor MLAG-PEERS remote-as 65110
   neighbor MLAG-PEERS next-hop-self
   neighbor MLAG-PEERS description DC1_UNDEPLOYED_LEAF1B
   ...
   neighbor 172.31.255.192 peer group UNDERLAY-PEERS
   neighbor 172.31.255.192 remote-as 65001
   neighbor 172.31.255.192 description DC1-SPINE1_Ethernet16
   neighbor 172.31.255.194 peer group UNDERLAY-PEERS
   neighbor 172.31.255.194 remote-as 65001
   neighbor 172.31.255.194 description DC1-SPINE2_Ethernet16
   neighbor 172.31.255.196 peer group UNDERLAY-PEERS
   neighbor 172.31.255.196 remote-as 65001
   neighbor 172.31.255.196 description DC1-SPINE3_Ethernet16
   neighbor 172.31.255.198 peer group UNDERLAY-PEERS
   neighbor 172.31.255.198 remote-as 65001
   neighbor 172.31.255.198 description DC1-SPINE4_Ethernet16
...
| -------------- | --------------------- |
| Tenant_A_OP_Zone | 10.255.1.21 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A_OP_Zone address 10.255.1.21
```
