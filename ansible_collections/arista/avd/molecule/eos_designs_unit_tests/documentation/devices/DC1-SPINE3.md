...
| Ethernet10 | P2P_LINK_TO_DC1-BL3A_Ethernet3 | routed | - | 172.31.255.196/31 | default | 1500 | false | - | - |
| Ethernet11 | P2P_LINK_TO_DC1-BL3B_Ethernet3 | routed | - | 172.31.255.212/31 | default | 1500 | false | - | - |
...
interface Ethernet10
   description P2P_LINK_TO_DC1-BL3A_Ethernet3
   no shutdown
   speed forced 100gfull
   mtu 1500
   no switchport
...
interface Ethernet11
   description P2P_LINK_TO_DC1-BL3B_Ethernet3
   no shutdown
   speed forced 100gfull
   mtu 1500
   no switchport
...
| 172.31.255.197 | 65108 | default | Inherited from peer group UNDERLAY-PEERS | Inherited from peer group UNDERLAY-PEERS |
| 172.31.255.213 | 65109 | default | Inherited from peer group UNDERLAY-PEERS | Inherited from peer group UNDERLAY-PEERS |
...
router bgp 65001
   ...
   neighbor 172.31.255.197 remote-as 65108
   neighbor 172.31.255.197 description DC1-BL3A_Ethernet3
   neighbor 172.31.255.213 peer group UNDERLAY-PEERS
   neighbor 172.31.255.213 remote-as 65109
   neighbor 172.31.255.213 description DC1-BL3B_Ethernet3
