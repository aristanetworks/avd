...
| ------- | -------- | ---------- | ----- |
| example@example.com | EOS_DESIGNS_UNIT_TESTS UNDERLAY-MULTICAST-L3LEAF1B | All | Disabled |
...
snmp-server location EOS_DESIGNS_UNIT_TESTS UNDERLAY-MULTICAST-L3LEAF1B
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF1A_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF1A_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_UNDERLAY-MULTICAST-SPINE1_Ethernet2 | routed | - | 172.31.255.3/31 | default | 1500 | false | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF1A_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
router bgp 65101
   ...
   neighbor MLAG-PEERS description UNDERLAY-MULTICAST-L3LEAF1A
