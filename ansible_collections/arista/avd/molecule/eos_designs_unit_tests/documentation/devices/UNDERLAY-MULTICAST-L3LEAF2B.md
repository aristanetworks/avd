...
| ------- | -------- | ---------- | ----- |
| example@example.com | EOS_DESIGNS_UNIT_TESTS UNDERLAY-MULTICAST-L3LEAF2B | All | Disabled |
...
snmp-server location EOS_DESIGNS_UNIT_TESTS UNDERLAY-MULTICAST-L3LEAF2B
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF2A_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF2A_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_UNDERLAY-MULTICAST-SPINE1_Ethernet4 | routed | - | 172.31.255.7/31 | default | 1500 | false | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF2A_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 10.255.252.4 | Inherited from peer group MLAG-PEERS | default | - | Inherited from peer group MLAG-PEERS | Inherited from peer group MLAG-PEERS | - | - | - |
...
router bgp 65102
   ...
   neighbor MLAG-PEERS description UNDERLAY-MULTICAST-L3LEAF2A
   ...
   neighbor 10.255.252.4 peer group MLAG-PEERS
