...
| ------- | -------- | ---------- | ----- |
| example@example.com | EOS_DESIGNS_UNIT_TESTS UNDERLAY-MULTICAST-L3LEAF2A | All | Disabled |
...
snmp-server location EOS_DESIGNS_UNIT_TESTS UNDERLAY-MULTICAST-L3LEAF2A
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF2B_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF2B_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_UNDERLAY-MULTICAST-SPINE1_Ethernet3 | routed | - | 172.31.255.5/31 | default | 1500 | false | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF2B_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_UNDERLAY-MULTICAST-L3LEAF2B_Po3
   no shutdown
   switchport
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 10.255.252.5 | Inherited from peer group MLAG-PEERS | default | - | Inherited from peer group MLAG-PEERS | Inherited from peer group MLAG-PEERS | - | - | - |
...
router bgp 65102
   ...
   neighbor MLAG-PEERS description UNDERLAY-MULTICAST-L3LEAF2B
   ...
   neighbor 10.255.252.5 peer group MLAG-PEERS
