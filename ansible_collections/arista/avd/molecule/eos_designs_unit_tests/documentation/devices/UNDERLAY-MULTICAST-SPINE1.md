...
| ------- | -------- | ---------- | ----- |
| example@example.com | EOS_DESIGNS_UNIT_TESTS UNDERLAY-MULTICAST-SPINE1 | All | Disabled |
...
snmp-server location EOS_DESIGNS_UNIT_TESTS UNDERLAY-MULTICAST-SPINE1
```
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_UNDERLAY-MULTICAST-L3LEAF1A_Ethernet1 | routed | - | 172.31.255.0/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_UNDERLAY-MULTICAST-L3LEAF1B_Ethernet1 | routed | - | 172.31.255.2/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_UNDERLAY-MULTICAST-L3LEAF2A_Ethernet1 | routed | - | 172.31.255.4/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_UNDERLAY-MULTICAST-L3LEAF2B_Ethernet1 | routed | - | 172.31.255.6/31 | default | 1500 | false | - | - |
...
| 172.31.255.5 | 65102 | default | - | Inherited from peer group UNDERLAY-PEERS | Inherited from peer group UNDERLAY-PEERS | - | - | - |
| 172.31.255.7 | 65102 | default | - | Inherited from peer group UNDERLAY-PEERS | Inherited from peer group UNDERLAY-PEERS | - | - | - |
...
router bgp 65001
   ...
   neighbor 172.31.255.3 description UNDERLAY-MULTICAST-L3LEAF1B_Ethernet1
   neighbor 172.31.255.5 peer group UNDERLAY-PEERS
   neighbor 172.31.255.5 remote-as 65102
   neighbor 172.31.255.5 description UNDERLAY-MULTICAST-L3LEAF2A_Ethernet1
   neighbor 172.31.255.7 peer group UNDERLAY-PEERS
   neighbor 172.31.255.7 remote-as 65102
   neighbor 172.31.255.7 description UNDERLAY-MULTICAST-L3LEAF2B_Ethernet1
   ...
   neighbor 192.168.255.4 description UNDERLAY-MULTICAST-L3LEAF1B
   neighbor 192.168.255.5 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.5 remote-as 65102
   neighbor 192.168.255.5 description UNDERLAY-MULTICAST-L3LEAF2A
   neighbor 192.168.255.6 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.6 remote-as 65102
   neighbor 192.168.255.6 description UNDERLAY-MULTICAST-L3LEAF2B
