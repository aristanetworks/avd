...
| Ethernet20 | server11_Single_Active_Port_Channel_Manual_DF_Preempt_Eth1 | *trunk | *310 | *- | *- | 20 |
| Ethernet21 |  server12_Single_Active_Ethernet_Manual_DF_Preempt_Eth1 | trunk | 310 | - | - | - |
| Ethernet22 | server13_Single_Active_Port_Channel_Manual_DF_Preempt_modulus_Eth1 | *trunk | *310 | *- | *- | 22 |
| Ethernet23 |  server14_Single_Active_Ethernet_Manual_DF_Preempt_modulus_Eth1 | trunk | 310 | - | - | - |
...
| Ethernet21 | preference | 500 | True | - | - | False |
...
interface Ethernet20
   description server11_Single_Active_Port_Channel_Manual_DF_Preempt_Eth1
   no shutdown
   channel-group 20 mode active
!
interface Ethernet21
   description server12_Single_Active_Ethernet_Manual_DF_Preempt_Eth1
   no shutdown
   switchport trunk allowed vlan 310
   switchport mode trunk
   switchport
   evpn ethernet-segment
      ...
      redundancy single-active
      designated-forwarder election algorithm preference 500 dont-preempt
      route-target import 5d:0b:68:d3:6f:f9
!
interface Ethernet22
   description server13_Single_Active_Port_Channel_Manual_DF_Preempt_modulus_Eth1
   no shutdown
   channel-group 22 mode active
!
interface Ethernet23
   description server14_Single_Active_Ethernet_Manual_DF_Preempt_modulus_Eth1
   no shutdown
   switchport trunk allowed vlan 310
   switchport mode trunk
   switchport
...
| Port-Channel20 | preference | 100 | True | - | - | False |
