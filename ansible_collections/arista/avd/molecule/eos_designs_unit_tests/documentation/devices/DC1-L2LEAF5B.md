...
| ------- | -------- | ---------- | ----- |
| example@example.com | EOS_DESIGNS_UNIT_TESTS rackE DC1-L2LEAF5B | All | Disabled |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC1-LEAF2A_Ethernet15/1 | *trunk | *110-112,120-121,130-131,160-161 | *- | *- | 1 |
| Ethernet2 | DC1-LEAF2B_Ethernet15/1 | *trunk | *110-112,120-121,130-131,160-161 | *- | *- | 1 |
