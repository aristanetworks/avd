...
| ------- | -------- | ---------- | ----- |
| example@example.com | EOS_DESIGNS_UNIT_TESTS UPLINK-MLAG-STRUCTURED-CONFIG-SPINE1 | All | Disabled |
...
snmp-server location EOS_DESIGNS_UNIT_TESTS UPLINK-MLAG-STRUCTURED-CONFIG-SPINE1
```
