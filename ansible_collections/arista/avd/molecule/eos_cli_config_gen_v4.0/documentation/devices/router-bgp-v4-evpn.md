...
router bgp 65101
   ...
   vrf TENANT_A_PROJECT01
      ...
      address-family ipv4
         ...
         neighbor {'ip_address': '10.2.3.4', 'activate': True, 'route_map_out': 'RM-10.2.3.4-SET-NEXT-HOP-OUT'} route-map RM-10.2.3.4-SET-NEXT-HOP-OUT out
         neighbor 10.2.3.5 activate
         neighbor {'ip_address': '10.2.3.5', 'activate': True, 'route_map_in': 'RM-10.2.3.5-SET-NEXT-HOP-IN'} route-map RM-10.2.3.5-SET-NEXT-HOP-IN in
         network 10.0.0.0/8
