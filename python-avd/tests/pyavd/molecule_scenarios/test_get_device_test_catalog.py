...
TEST_SETTINGS_MAP: dict[str, Any] = {
    ...
    "default_run_filtered_report": {"default": None},
    "default_run_sorted_report": {"default": None},
}

RunName = Literal["default_run", "allow_bgp_vrfs_run", "filtered_run", "default_run_filtered_report", "default_run_sorted_report"]
