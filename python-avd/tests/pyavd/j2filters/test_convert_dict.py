...
class TestConvertDicts:
    @pytest.mark.parametrize("test_dict, primary_key, secondary_key, converted_value",
            [(NESTED_DICT, "", "", [{"action": "permit 1000:1000", "name": "TEST1"}, {"action": "permit 2000:3000", "name": "TEST2"}]), #test_convert_dicts_with_nested_dict_default
            (NESTED_DICT, "id", "", [{"action": "permit 1000:1000", "id": "TEST1"}, {"action": "permit 2000:3000", "id": "TEST2"}]), # test_convert_dicts_with_nested_dict_primary_key
            (NESTED_DICT, "", "types", [{"name": "TEST1", "types": {"action": "permit 1000:1000"}}, {"name": "TEST2", "types": {"action": "permit 2000:3000"}}]), # test_convert_dicts_with_nested_dict_secondary_key
            (NESTED_DICT, "id", "types", [{"id": "TEST1", "types": {"action": "permit 1000:1000"}}, {"id": "TEST2", "types": {"action": "permit 2000:3000"}}]), # test_convert_dicts_with_listofdict_default
            ...
            (LIST_OF_DICT, "", "id", [{"name": "type", "id": "permit"}, {"name": "extcommunities", "id": "65000:65000"}]), # test_convert_dicts_with_list_of_dict_secondary_key
            (LIST_OF_DICT, "test", "id", [{"test": "type", "id": "permit"}, {"test": "extcommunities", "id": "65000:65000"}])]) # test_convert_dicts_with_list_of_dict_primary_key_and_secondary_key
