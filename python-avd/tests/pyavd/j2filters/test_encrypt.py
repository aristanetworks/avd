...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("arista", "ntp", None, {"salt": 42}, pytest.raises(ValueError, match=r"Salt must be in the range 0-15, got 42"), id="NTP with bad salt"),
        ...
        pytest.param(
            ...
            None,
            {"salt": 42},
            pytest.raises(ValueError, match=r"Salt must be in the range 0-15, got 42"),
