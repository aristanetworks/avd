...
IDENTIFY_DUPLICATED_DEVICES_FULL_INVENTORY_EXPECTED_RETURN = {
    "duplicated_serial_number": {
        "serial06": [
            CVDevice(avd_device=AvdDevice(hostname="switch06", serial_number="serial06", system_mac_address="aa:bb:cc:dd:ee:06"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch07", serial_number="serial06", system_mac_address="aa:bb:cc:dd:ee:07"), exists_on_cv=None),
        ],
        "serial08": [
            CVDevice(avd_device=AvdDevice(hostname="switch08", serial_number="serial08", system_mac_address="aa:bb:cc:dd:ee:08"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch09", serial_number="serial08", system_mac_address="aa:bb:cc:dd:ee:09"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch10", serial_number="serial08", system_mac_address="aa:bb:cc:dd:ee:10"), exists_on_cv=None),
        ],
        "serial11": [
            CVDevice(avd_device=AvdDevice(hostname="switch11", serial_number="serial11", system_mac_address=None), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch12", serial_number="serial11", system_mac_address=None), exists_on_cv=None),
        ],
        "serial13": [
            CVDevice(avd_device=AvdDevice(hostname="switch13", serial_number="serial13", system_mac_address=None), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch14", serial_number="serial13", system_mac_address=None), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch15", serial_number="serial13", system_mac_address=None), exists_on_cv=None),
        ],
        "serial16": [
            CVDevice(avd_device=AvdDevice(hostname="switch16", serial_number="serial16", system_mac_address="aa:bb:cc:dd:ee:16"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch17", serial_number="serial16", system_mac_address=None), exists_on_cv=None),
        ],
        "serial18": [
            CVDevice(avd_device=AvdDevice(hostname="switch18", serial_number="serial18", system_mac_address="aa:bb:cc:dd:ee:18"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch19", serial_number="serial18", system_mac_address="aa:bb:cc:dd:ee:19"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch20", serial_number="serial18", system_mac_address=None), exists_on_cv=None),
        ],
        "serial21": [
            CVDevice(avd_device=AvdDevice(hostname="switch21", serial_number="serial21", system_mac_address="aa:bb:cc:dd:ee:21"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch22", serial_number="serial21", system_mac_address=None), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch23", serial_number="serial21", system_mac_address=None), exists_on_cv=None),
        ],
        "serial24": [
            CVDevice(avd_device=AvdDevice(hostname="switch24", serial_number="serial24", system_mac_address="aa:bb:cc:dd:ee:24"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch25", serial_number="serial24", system_mac_address="aa:bb:cc:dd:ee:24"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch26", serial_number="serial24", system_mac_address="aa:bb:cc:dd:ee:26"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch27", serial_number="serial24", system_mac_address="aa:bb:cc:dd:ee:26"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch28", serial_number="serial24", system_mac_address="aa:bb:cc:dd:ee:28"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch29", serial_number="serial24", system_mac_address="aa:bb:cc:dd:ee:29"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch30", serial_number="serial24", system_mac_address=None), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch31", serial_number="serial24", system_mac_address=None), exists_on_cv=None),
        ],
    },
    "duplicated_system_mac_address_unset_or_mixed_serial_number": {
        "aa:bb:cc:dd:ee:37": [
            CVDevice(avd_device=AvdDevice(hostname="switch37", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:37"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch38", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:37"), exists_on_cv=None),
        ],
        "aa:bb:cc:dd:ee:39": [
            CVDevice(avd_device=AvdDevice(hostname="switch39", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:39"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch40", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:39"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch41", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:39"), exists_on_cv=None),
        ],
        "aa:bb:cc:dd:ee:42": [
            CVDevice(avd_device=AvdDevice(hostname="switch42", serial_number="serial42", system_mac_address="aa:bb:cc:dd:ee:42"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch43", serial_number="serial43", system_mac_address="aa:bb:cc:dd:ee:42"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch44", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:42"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch45", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:42"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch46", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:42"), exists_on_cv=None),
        ],
        "aa:bb:cc:dd:ee:47": [
            CVDevice(avd_device=AvdDevice(hostname="switch47", serial_number="serial47", system_mac_address="aa:bb:cc:dd:ee:47"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch48", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:47"), exists_on_cv=None),
        ],
        "aa:bb:cc:dd:ee:49": [
            CVDevice(avd_device=AvdDevice(hostname="switch49", serial_number="serial49", system_mac_address="aa:bb:cc:dd:ee:49"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch50", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:49"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch51", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:49"), exists_on_cv=None),
        ],
        "aa:bb:cc:dd:ee:52": [
            CVDevice(avd_device=AvdDevice(hostname="switch52", serial_number="serial52", system_mac_address="aa:bb:cc:dd:ee:52"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch53", serial_number="serial53", system_mac_address="aa:bb:cc:dd:ee:52"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch54", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:52"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch55", serial_number=None, system_mac_address="aa:bb:cc:dd:ee:52"), exists_on_cv=None),
        ],
    },
    "duplicated_system_mac_address_set_serial_number": {
        ...
        "aa:bb:cc:dd:ee:32": [
            CVDevice(avd_device=AvdDevice(hostname="switch32", serial_number="serial32", system_mac_address="aa:bb:cc:dd:ee:32"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch33", serial_number="serial33", system_mac_address="aa:bb:cc:dd:ee:32"), exists_on_cv=None),
        ],
        "aa:bb:cc:dd:ee:34": [
            CVDevice(avd_device=AvdDevice(hostname="switch34", serial_number="serial34", system_mac_address="aa:bb:cc:dd:ee:34"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch35", serial_number="serial35", system_mac_address="aa:bb:cc:dd:ee:34"), exists_on_cv=None),
            CVDevice(avd_device=AvdDevice(hostname="switch36", serial_number="serial36", system_mac_address="aa:bb:cc:dd:ee:34"), exists_on_cv=None),
        ],
    },
}
