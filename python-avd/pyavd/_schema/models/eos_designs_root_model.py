...
class EosDesignsRootModel(AvdModel):
    @classmethod
    def _from_dict(cls, data: Mapping, data_source: InputPath | None = None, *, load_custom_structured_config: bool = True) -> Self:
        """
        ...
        return super()._from_dict(ChainMap(root_data, data), data_source=data_source or InputPath())
