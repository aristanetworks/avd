...
async def verify_devices_on_cv(
    *,
    ...
    LOGGER.info("verify_devices_on_cv: %s devices", len(internal_devices))
...
async def verify_devices_in_cloudvision_inventory(
    *,
    ...
    Returns filtered list of InternalDevice objects found in CloudVision.
    """
...
async def verify_devices_in_topology_studio(existing_devices: list[InternalDevice], workspace_id: str, cv_client: CVClient) -> None:
    """
...
def missing_devices_handler(*, missing_devices: list[InternalDevice], skip_missing_devices: bool, context: str) -> Exception:
    """
