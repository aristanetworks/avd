...
def get_device_config(structured_config: dict, templar: Templar | None = None) -> str:
    """
    ...
    Args:
        ...
        templar: Optional instance of pyavd.templater.Templar.

    Returns:
        Device configuration in EOS CLI format.
    """
    templar = templar or Templar()
