...
def template(template_file: str, template_vars: dict[str, Any] | ChainMap[str, Any], templar: AVDTemplar | None) -> Any:
    """
    ...
    Args:
        ...
        templar : AVDTemplar | None
            Instance of AVDTemplar wrapper containing Ansible Templar, DataLoader, and searchpath
    ...
    if templar.ansible_above_2_19:
        ...
        j2template = trust_as_template(templar.loader.get_text_file_contents(template_file_path))  # pyright: ignore [reportAttributeAccessIssue]
        tmp_templar = templar.templar.copy_with_new_env(available_variables=template_vars)
