...
class LogMessage(Enum):
    ...
    PATH_GROUP_STATIC_PEER_NO_ROUTER_IP = "static peer {static_peer} skipped - No router ip configured"
    PATH_GROUP_STATIC_PEER_NO_IPV4_ADDRESSES = "static peer {static_peer} skipped - No ipv4 addresses configured"
