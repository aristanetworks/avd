...
class AvdIpAddressingProtocol(UtilsMixin, AvdFactsProtocol, Protocol):
    ...
    def vtep_ip_mlag(self) -> str:
        ...
        if self.shared_utils.node_config.vtep_loopback and self.shared_utils.node_config.vtep_loopback.lower() == "loopback0" and self.shared_utils.router_id:
    ...
    def vtep_ipv6(self) -> str | None:
        ...
        if self.shared_utils.node_config.vtep_loopback and self.shared_utils.node_config.vtep_loopback.lower() == "loopback0" and self.shared_utils.ipv6_router_id:
