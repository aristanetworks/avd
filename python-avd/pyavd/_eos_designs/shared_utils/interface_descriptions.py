...
class InterfaceDescriptionsMixin(Protocol):
    ...
    def interface_descriptions(self: SharedUtilsProtocol) -> AvdInterfaceDescriptions:
        ...
        """
        module_path = self.consolidated.node_type_keys_item.interface_descriptions.python_module
        ...
        cls: type[AvdInterfaceDescriptions] = load_python_class(
            module_path,
            self.consolidated.node_type_keys_item.interface_descriptions.python_class_name,
