...
class RoutingMixin(Protocol):
    ...
    def underlay_routing_protocol(self: SharedUtilsProtocol) -> str:
        default_underlay_routing_protocol = self.inputs._node_type_keys_item.default_underlay_routing_protocol
    ...
    def overlay_routing_protocol(self: SharedUtilsProtocol) -> str:
        default_overlay_routing_protocol = self.inputs._node_type_keys_item.default_overlay_routing_protocol
    ...
    def overlay_address_families(self: SharedUtilsProtocol) -> list[str]:
        if self.overlay_routing_protocol in ["ebgp", "ibgp"]:
            default_overlay_address_families = self.inputs._node_type_keys_item.default_overlay_address_families
