...
class OverlayMixin(Protocol):
    ...
    def evpn_role(self: SharedUtilsProtocol) -> str | None:
        if self.underlay_router:
            default_evpn_role = self.inputs._node_type_keys_item.default_evpn_role
    ...
    def mpls_overlay_role(self: SharedUtilsProtocol) -> str | None:
        if self.underlay_router:
            default_mpls_overlay_role = self.inputs._node_type_keys_item.default_mpls_overlay_role
    ...
    def evpn_encapsulation(self: SharedUtilsProtocol) -> str:
        ...
        return default(self.inputs.fabric_evpn_encapsulation, self.inputs._node_type_keys_item.default_evpn_encapsulation)
