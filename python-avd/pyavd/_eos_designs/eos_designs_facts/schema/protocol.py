...
class EosDesignsFactsProtocol(Protocol):
    ...
    """
    Hostnames of devices configured with this node as an EVPN Gateway remote peer using this node's
    regular overlay peering address.
    ...
    if TYPE_CHECKING:
        ...
        def __init__(
            ...
            *,
            ...
            inband_ztp: bool | UndefinedType | None = Undefined,
            inband_ztp_vlan: int | UndefinedType | None = Undefined,
            inband_ztp_lacp_fallback_delay: int | UndefinedType | None = Undefined,
            ...
            mlag_port_channel_id: int | UndefinedType | None = Undefined,
            mlag_interfaces: MlagInterfaces | UndefinedType = Undefined,
            mlag_ip: str | UndefinedType | None = Undefined,
