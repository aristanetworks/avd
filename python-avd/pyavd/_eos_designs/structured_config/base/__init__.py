...
class AvdStructuredConfigBaseProtocol(NtpMixin, SnmpServerMixin, RouterGeneralMixin, PlatformMixin, UtilsMixin, StructuredConfigGeneratorProtocol, Protocol):
    ...
    def spanning_tree(self) -> None:
        ...
        stp_po_range = self.shared_utils.node_config.spanning_tree_port_id_allocation_port_channel_range
        if stp_po_range:
            self.structured_config.spanning_tree.port_id_allocation_port_channel_range._update(minimum=stp_po_range.minimum, maximum=stp_po_range.maximum)
