...
class AvdStructuredConfigMlag(StructuredConfigGenerator):
    ...
    def port_channel_interfaces(self) -> None:
        ...
        port_channel_interface.sflow.enable = self.structured_config_utils.get_interface_sflow(port_channel_interface.name, self.inputs.fabric_sflow.mlag_interfaces)
