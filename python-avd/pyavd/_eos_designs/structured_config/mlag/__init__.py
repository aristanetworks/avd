...
class AvdStructuredConfigMlag(StructuredConfigGenerator):
    ...
    def vlan_interfaces(self) -> None:
        ...
        main_vlan_interface = EosCliConfigGen.VlanInterfacesItem(
            ...
            shutdown=False,
            no_autostate=True,
            mtu=self.shared_utils.p2p_uplinks_mtu if self.shared_utils.interface_mtu_supported(main_vlan_interface_name) else None,
        )
        ...
        l3_vlan_interface = EosCliConfigGen.VlanInterfacesItem(
            ...
            shutdown=False,
            mtu=self.shared_utils.p2p_uplinks_mtu if self.shared_utils.interface_mtu_supported(l3_vlan_interface_name) else None,
        )
