...
class RouterBgpMixin(Protocol):
    ...
    def router_bgp(self: AvdStructuredConfigUnderlayProtocol) -> None:
        ...
        peer_group = EosCliConfigGen.RouterBgp.PeerGroupsItem(
            ...
            type=af_type,
            password=self.shared_utils.get_bgp_password(
                self.inputs.bgp_peer_groups.ipv4_underlay_peers.name, self.inputs.bgp_peer_groups.ipv4_underlay_peers.password
            ),
