        ...
        for link in self._underlay_links:
            ...
            if link.type == "underlay_p2p":
                ethernet_interface._update(
                    mtu=self.shared_utils.p2p_uplinks_mtu if self.shared_utils.interface_mtu_supported(link.interface) else None,
            ...
            if link.type == "underlay_p2p" and link.subinterfaces:
                for subinterface in link.subinterfaces:
                    ...
                    ethernet_subinterface = EosCliConfigGen.EthernetInterfacesItem(
                        ...
                        mtu=self.shared_utils.p2p_uplinks_mtu if self.shared_utils.interface_mtu_supported(subinterface.interface) else None,
