...
def get_structured_config(
    *,
    ...
    structured_config_utils = StructuredConfigUtils(structured_config=structured_config, inputs=inputs, shared_utils=shared_utils, custom_structured_configs=custom_structured_configs)
